...
.method public final checkValueValid(ILjava/lang/String;)Z
    ...
    invoke-virtual {p0}, Ld1/r1;->g()[Lcom/android/camera/data/data/d;
...
.method public bridge synthetic f(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Ld1/r1;->j(Lcom/android/camera/data/data/e0;)V
...
.method public final g()[Lcom/android/camera/data/data/d;
    ...
    iget-object v0, p0, Ld1/r1;->e:[Lcom/android/camera/data/data/d;
    ...
    iget-object v2, p0, Lcom/android/camera/data/data/c;->mCapabilities:Lca/c;

    invoke-static {v2}, Lca/d;->q(Lca/c;)Landroid/util/Range;
    ...
    invoke-static {v2}, Lca/d;->r(Lca/c;)F
    ...
    iput-object v0, p0, Ld1/r1;->e:[Lcom/android/camera/data/data/d;
...
.method public final getComponentValue(I)Ljava/lang/String;
    ...
    iget-object v0, p0, Ld1/r1;->d:Ljava/lang/String;
...
.method public final getComponentValueJudgeSelect(ILjava/lang/String;)Landroid/util/Pair;
    ...
    invoke-virtual {p0, v0}, Ld1/r1;->h(Lca/c;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v1}, La0/x;->a(Ljava/util/List;I)Ljava/lang/Object;
    ...
    new-instance v9, Landroid/icu/text/DecimalFormatSymbols;

    sget-object v10, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    invoke-direct {v9, v10}, Landroid/icu/text/DecimalFormatSymbols;-><init>(Ljava/util/Locale;)V

    const/16 v10, 0x2e

    invoke-virtual {v9, v10}, Landroid/icu/text/DecimalFormatSymbols;->setDecimalSeparator(C)V

    invoke-virtual {p1, v9}, Landroid/icu/text/DecimalFormat;->setDecimalFormatSymbols(Landroid/icu/text/DecimalFormatSymbols;)V
...
.method public final getContentDescriptionString()I
    ...
    sget p0, Lvg/f;->parameter_exposure_title:I
...
.method public final getValueDisplayString(I)I
    ...
    invoke-virtual {p0, p1}, Ld1/r1;->getComponentValue(I)Ljava/lang/String;
...
.method public final h(Lca/c;)Ljava/util/ArrayList;
    .locals 6
    ...
    invoke-static {p1}, Lca/d;->q(Lca/c;)Landroid/util/Range;

    move-result-object v2

    iput-object v2, p0, Ld1/r1;->b:Landroid/util/Range;
    ...
    iget-object v3, p0, Ld1/r1;->b:Landroid/util/Range;
    ...
    invoke-static {p1}, Lca/d;->r(Lca/c;)F

    move-result p1

    iput p1, p0, Ld1/r1;->c:F
...
.method public i(IILca/c;)Ljava/util/ArrayList;
    .locals 0

    iput p1, p0, Lcom/android/camera/data/data/c;->mCurrentMode:I

    iput-object p3, p0, Lcom/android/camera/data/data/c;->mCapabilities:Lca/c;
    ...
    :goto_1
    iput-object p2, p0, Ld1/r1;->d:Ljava/lang/String;

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    invoke-virtual {p0, p1}, Ld1/r1;->isSupportMode(I)Z

    move-result p1

    if-eqz p1, :cond_2

    iget-object p1, p0, Lcom/android/camera/data/data/c;->mCapabilities:Lca/c;

    invoke-virtual {p0, p1}, Ld1/r1;->h(Lca/c;)Ljava/util/ArrayList;
...
.method public final isSupportMode(I)Z
    ...
    invoke-static {p1}, Ld1/r1;->l(I)Z

    move-result p0

    if-nez p0, :cond_1

    invoke-static {p1}, Ld1/r1;->k(I)Z
...
.method public j(Lcom/android/camera/data/data/e0;)V
    .locals 2
    ...
    invoke-virtual {p0, v0, p1, v1}, Ld1/r1;->i(IILca/c;)Ljava/util/ArrayList;
