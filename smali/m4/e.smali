...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ld1/s0;ILg5/q;)V
    .locals 1
    ...
    iput-object p4, p0, Lm4/e;->d:Lg5/q;

    iput-object p2, p0, Lm4/e;->c:Lcom/android/camera/data/data/c;

    invoke-virtual {p2}, Ld1/s0;->getItems()Ljava/util/List;
    ...
    new-instance p3, Landroidx/core/location/f;

    const/4 p4, 0x4

    invoke-direct {p3, p0, p4}, Landroidx/core/location/f;-><init>(Ljava/lang/Object;I)V
...
.method public final draw(Lcom/android/camera/ui/b$a$a;ILandroid/graphics/Canvas;ZIFI)V
    ...
    iget-object p1, p0, Lm4/e;->e:Landroid/util/Range;

    iget-object p5, p0, Lm4/e;->f:Ljava/util/ArrayList;
    ...
    :cond_1
    invoke-virtual {p0, p2}, Lm4/e;->isStopPoint(I)Z

    move-result p6

    if-eqz p6, :cond_4

    invoke-virtual {p0}, Lm4/e;->getCount()I
    ...
    iget-object p1, p0, Lm4/e;->a:Landroid/content/Context;
...
.method public final drawBefore(Lcom/android/camera/ui/b$a$a;Landroid/graphics/Canvas;)V
    ...
    iget-object p2, p0, Lm4/e;->f:Ljava/util/ArrayList;
    ...
    invoke-static {v0}, Ld1/s0;->g(F)Landroid/util/Range;
    ...
    iput-object p1, p0, Lm4/e;->e:Landroid/util/Range;
...
.method public final isStopPoint(I)Z
    ...
    sget-object v0, Ld1/s0;->f:Ljava/util/ArrayList;
...
.method public final bridge synthetic mapPositionToValue(F)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lm4/e;->mapPositionToValue(F)Ljava/lang/String;
...
.method public final onCustomWheelScroll(Z)V
    ...
    iget-object v0, p0, Lm4/e;->c:Lcom/android/camera/data/data/c;
    ...
    iget-object v0, p0, Lm4/e;->d:Lg5/q;

    if-eqz v0, :cond_0

    const/4 v1, 0x3

    invoke-interface {v0, p1, v1}, Lg5/q;->onManuallyDataChanged(Ljava/lang/String;I)V
...
.method public final onPositionSelect(Landroid/view/View;FII)V
    ...
    iget-object p2, p0, Lm4/e;->d:Lg5/q;

    if-eqz p2, :cond_0

    const/4 p3, 0x3

    invoke-interface {p2, p1, p3}, Lg5/q;->onManuallyDataChanged(Ljava/lang/String;I)V

    :cond_0
    iget-object p2, p0, Lcom/android/camera/ui/b$a;->mCurrentValue:Ljava/lang/String;

    invoke-virtual {p0, p2}, Lm4/e;->mapValueToPosition(Ljava/lang/String;)F
