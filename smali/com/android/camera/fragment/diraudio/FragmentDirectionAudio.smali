...
.method public static Dh(Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;IZ)V
    .locals 4
    ...
    :cond_1
    iget-object p2, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/d;

    invoke-virtual {p2}, Ld1/d;->h()I

    move-result p2

    iget-object v1, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/d;

    invoke-virtual {v1, p1}, Ld1/d;->m(I)V

    invoke-interface {v0}, Lw7/c0;->Qe()V
    ...
    invoke-static {v1, v2}, La0/u6;->c(IZ)V
    ...
    invoke-static {v1, v0}, La0/u6;->c(IZ)V
    ...
    invoke-virtual {v1}, Ld1/d;->getItems()Ljava/util/List;
    ...
    invoke-virtual {p2}, Ld1/d;->getItems()Ljava/util/List;
...
.method public final initView(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/d;
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/d;
    ...
    :cond_1
    invoke-virtual {v0}, Ld1/d;->initItems()Ljava/util/List;

    :goto_0
    iget-object v0, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/d;

    invoke-virtual {v0}, Ld1/d;->h()I
    ...
    iget-object v3, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/d;

    invoke-virtual {v3}, Ld1/d;->getItems()Ljava/util/List;
    ...
    invoke-direct {v4, p0, v5}, Landroidx/core/view/u;-><init>(Ljava/lang/Object;I)V

    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/camera/fragment/diraudio/DirectionAudioItemAdapter;-><init>(Landroid/content/Context;ILjava/util/List;Landroidx/core/view/u;)V
...
.method public final mapItemsToStringList()Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/diraudio/FragmentDirectionAudio;->m:Ld1/d;

    invoke-virtual {p0}, Ld1/d;->getItems()Ljava/util/List;
