...
# direct methods
.method public constructor <init>(Landroid/content/Context;ILg5/q;)V
    .locals 7
    ...
    iput-object p3, p0, Lcom/android/camera/fragment/manually/adapter/b;->mZoomValueListener:Lg5/q;

    invoke-static {p2}, Lcom/android/camera/data/data/k;->G(I)F
    ...
    invoke-static {p3, p2}, La0/e0;->h(ILjava/util/Optional;)Ljava/util/Optional;

    move-result-object p2

    sget-object p3, Laa/l;->c:Landroid/util/Range;
...
.method public final a(ILandroid/graphics/Canvas;ZIFZZ)V
    ...
    invoke-static {v4, v3, v5, v3}, La0/w;->a(FFFF)F
...
.method public final onChangeValue(Ljava/lang/String;I)V
    ...
    iget-object p2, p0, Lcom/android/camera/fragment/manually/adapter/b;->mZoomValueListener:Lg5/q;

    if-eqz p2, :cond_0

    const/4 v0, 0x3

    invoke-interface {p2, p1, v0}, Lg5/q;->onManuallyDataChanged(Ljava/lang/String;I)V
...
.method public final onPositionSelect(Landroid/view/View;FII)V
    ...
    :goto_0
    iget-object v0, p0, Lcom/android/camera/fragment/manually/adapter/b;->mZoomValueListener:Lg5/q;
    ...
    invoke-interface {v0, p2, v1, p4}, Lg5/q;->onZoomItemSlideOn(IZI)V
