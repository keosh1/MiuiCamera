...
.method public final b([Lca/y;Lz6/d;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {p0 .. p0}, Le7/z;->c()Ljava/util/Optional;
    ...
    :cond_0
    invoke-virtual {v2}, Lcom/android/camera/module/BaseModule;->getModuleCallback()Lcom/android/camera/module/v0;
    ...
    iget-object v3, v3, Lca/x;->e0:Landroid/graphics/Point;
    ...
    invoke-static {v3}, Lca/d;->c(Lca/c;)Landroid/graphics/Rect;
    ...
    iget-object v7, v7, Lca/y;->c:Ljava/util/List;

    invoke-virtual {v2}, Lcom/android/camera/features/mode/cosmeticmirror/CosmeticMirrorModule;->getZoomManager()Laa/a;
    ...
    invoke-direct {v3, v1, v4, v2, v5}, Lf3/i;-><init>([Lca/y;Lz6/d;Lcom/android/camera/features/mode/cosmeticmirror/CosmeticMirrorModule;Landroid/graphics/Rect;)V
