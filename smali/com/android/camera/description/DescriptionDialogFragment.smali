...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-static {p3}, Lak/o;->h(Landroid/content/Context;)Z
    ...
    invoke-direct {p3, p0, v0}, Lt1/f;-><init>(Ljava/lang/Object;I)V
    ...
    :pswitch_0
    new-instance v6, Lcom/android/camera/description/FragmentCinematicDescription;

    invoke-direct {v6}, Lcom/android/camera/description/FragmentCinematicDescription;-><init>()V

    goto :goto_1

    :pswitch_1
    new-instance v6, Lcom/android/camera/description/FragmentFriendDescription;

    invoke-direct {v6}, Lcom/android/camera/description/FragmentFriendDescription;-><init>()V

    goto :goto_1

    :pswitch_2
    new-instance v6, Lcom/android/camera/description/FragmentStreetDescription;

    invoke-direct {v6}, Lcom/android/camera/description/FragmentStreetDescription;-><init>()V

    goto :goto_1

    :cond_3
    new-instance v6, Lcom/android/camera/description/FragmentDualVideoDescription;

    invoke-direct {v6}, Lcom/android/camera/description/FragmentDualVideoDescription;-><init>()V

    goto :goto_1

    :cond_4
    new-instance v6, Lcom/android/camera/description/FragmentAmbilightDescription;

    invoke-direct {v6}, Lcom/android/camera/description/FragmentAmbilightDescription;-><init>()V

    goto :goto_1

    :cond_5
    new-instance v6, Lcom/android/camera/description/FragmentBeautyLensDescription;

    invoke-direct {v6}, Lcom/android/camera/description/FragmentBeautyLensDescription;-><init>()V

    goto :goto_1

    :cond_6
    new-instance v6, Lcom/android/camera/description/FragmentFastMotionDescription;

    invoke-direct {v6}, Lcom/android/camera/description/FragmentFastMotionDescription;-><init>()V

    goto :goto_1

    :cond_7
    new-instance v6, Lcom/android/camera/description/FragmentParameterDescription;

    invoke-direct {v6}, Lcom/android/camera/description/FragmentParameterDescription;-><init>()V
    ...
    invoke-static {v5}, Llq/h;->g(I)Lt1/h;
    ...
    iget v5, v6, Lt1/h;->a:I

    invoke-virtual {p0, v5}, Landroidx/fragment/app/Fragment;->getString(I)Ljava/lang/String;

    move-result-object v5

    iget-object v6, p0, Lcom/android/camera/description/DescriptionDialogFragment;->d:Lcom/android/camera/description/ScrollableFilterSortView2;
    ...
    sget v9, Ljs/e;->layout_filter_tab_view2:I

    invoke-virtual {v8, v9, v7}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v7

    check-cast v7, Lmiuix/miuixbasewidget/widget/FilterSortView2$TabView;

    iget-boolean v8, v6, Lmiuix/miuixbasewidget/widget/FilterSortView2;->c:Z

    invoke-virtual {v7, v8}, Lmiuix/miuixbasewidget/widget/FilterSortView2$TabView;->setEnabled(Z)V

    iget-boolean v8, v6, Lmiuix/miuixbasewidget/widget/FilterSortView2;->e:Z

    invoke-virtual {v7, v8}, Landroid/view/View;->setSelected(Z)V

    const/4 v8, -0x1

    invoke-virtual {v6, v7, v8}, Lmiuix/miuixbasewidget/widget/FilterSortView2;->b(Lmiuix/miuixbasewidget/widget/FilterSortView2$TabView;I)V
    ...
    iget-object v6, v6, Lmiuix/miuixbasewidget/widget/FilterSortView2;->a:Ljava/util/ArrayList;

    invoke-virtual {v6, v8}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v7, v5, v4}, Lmiuix/miuixbasewidget/widget/FilterSortView2$TabView;->c(Ljava/lang/CharSequence;Z)V
    ...
    invoke-virtual {v4, v7}, Lmiuix/miuixbasewidget/widget/FilterSortView2;->setFilteredTab(Lmiuix/miuixbasewidget/widget/FilterSortView2$TabView;)V
    ...
    invoke-direct {v4, p0, p2, v3}, Lt1/g;-><init>(Lcom/android/camera/description/DescriptionDialogFragment;Landroidx/viewpager2/widget/ViewPager2;I)V

    invoke-virtual {v7, v4}, Lmiuix/miuixbasewidget/widget/FilterSortView2$TabView;->setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-direct {p3, p0, v4}, Landroidx/room/h;-><init>(Ljava/lang/Object;I)V
