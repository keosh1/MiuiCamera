...
.method public constructor <init>(Lsa/g;ILw2/c;Landroid/app/Application;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/android/camera/effect/renders/x;->c:Lw2/f;

    if-eqz p3, :cond_0

    iget-boolean p1, p3, Lw2/f;->h:Z

    if-nez p1, :cond_0

    invoke-virtual {p3, p4}, Lw2/f;->a(Landroid/content/Context;)V
...
.method public final destroy()V
    ...
    iget-object v1, p0, Lcom/android/camera/effect/renders/x;->c:Lw2/f;

    if-eqz v1, :cond_0

    iget-boolean v2, v1, Lw2/f;->h:Z

    if-eqz v2, :cond_0

    iput-boolean v0, v1, Lw2/f;->h:Z

    iget v2, v1, Lw2/f;->d:I

    const-string v3, "GPUImageFilter"

    invoke-static {v2, v3}, Lcom/xiaomi/gl/MIGL;->glDeleteProgram(ILjava/lang/String;)V

    iput v0, v1, Lw2/f;->d:I

    check-cast v1, Lw2/c;

    iget v2, v1, Lw2/c;->p:I
...
.method public final draw(Lq2/b;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera/effect/renders/x;->c:Lw2/f;
    ...
    iget v1, p1, Lq2/g;->c:I

    iget-object p1, p1, Lq2/g;->b:Landroid/graphics/Rect;

    sget-object v3, Lbg/b;->a:Landroid/content/Context;
    ...
    invoke-virtual {v0, v1, p1, p0, v3}, Lw2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
    ...
    iget-object v1, p1, Lq2/c;->c:Lsa/b;
    ...
    :cond_5
    iget-object v5, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lsa/g;

    invoke-virtual {v1, v5}, Lsa/b;->f(Lsa/g;)Z
    ...
    :cond_6
    invoke-virtual {p0, v1, v4}, Lcom/android/camera/effect/renders/s;->bindTexture(Lsa/b;I)Z
    ...
    invoke-virtual {v0, p1, v1, p0, v3}, Lw2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
...
.method public final setViewportSize(II)V
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/x;->c:Lw2/f;
