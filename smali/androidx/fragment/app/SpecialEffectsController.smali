...
.method private final processStart(Ljava/util/List;)V
    ...
    invoke-static {v0, v2}, Lmp/o;->D(Ljava/util/Collection;Ljava/lang/Iterable;)V

    goto :goto_1

    :cond_1
    invoke-static {v0}, Lmp/s;->W(Ljava/lang/Iterable;)Ljava/util/Set;

    move-result-object p1

    invoke-static {p1}, Lmp/s;->U(Ljava/lang/Iterable;)Ljava/util/List;
...
.method public commitEffects$fragment_release(Ljava/util/List;)V
    ...
    invoke-static {v1, v3}, Lmp/o;->D(Ljava/util/Collection;Ljava/lang/Iterable;)V

    goto :goto_0

    :cond_0
    invoke-static {v1}, Lmp/s;->W(Ljava/lang/Iterable;)Ljava/util/Set;
...
.method public final executePendingOperations()V
    ...
    invoke-static {v2}, Lmp/s;->V(Ljava/util/Collection;)Ljava/util/ArrayList;
    ...
    invoke-static {v4, v8}, Lmp/o;->D(Ljava/util/Collection;Ljava/lang/Iterable;)V
...
.method public final forceCompleteAllOperations()V
    ...
    invoke-static {v3}, Lmp/s;->V(Ljava/util/Collection;)Ljava/util/ArrayList;
...
.method public final processProgress(Landroidx/activity/BackEventCompat;)V
    ...
    invoke-static {v1, v2}, Lmp/o;->D(Ljava/util/Collection;Ljava/lang/Iterable;)V
