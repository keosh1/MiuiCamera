...
.method private static final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v2, v5}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    new-instance v10, Lnp/b;

    invoke-direct {v10}, Lnp/b;-><init>()V
    ...
    invoke-virtual {v10, v11, v12}, Lnp/b;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_0

    :cond_2
    invoke-virtual {v10}, Lnp/b;->b()V

    iput-boolean v12, v10, Lnp/b;->l:Z
    :try_end_1
    ...
    invoke-static {v2, v1}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readForeignKeyFieldMappings(Landroid/database/Cursor;)Ljava/util/List;
    ...
    invoke-virtual {v4, v5}, Lnp/a;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v4}, Lmp/s;->U(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {v4, p0}, Lnp/a;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;
...
.method private static final readForeignKeys(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    new-instance v6, Lnp/f;

    invoke-direct {v6}, Lnp/f;-><init>()V
    ...
    invoke-virtual {v6, v7}, Lnp/f;->add(Ljava/lang/Object;)Z

    goto/16 :goto_0

    :cond_5
    invoke-static {v6}, Lal/a;->f(Lnp/f;)Lnp/f;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static final readIndex(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;Z)Landroidx/room/util/TableInfo$Index;
    ...
    invoke-static {v1}, Lmp/s;->U(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0, v5}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readIndices(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {p1, v6}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    return-object v6

    :cond_3
    :try_start_1
    invoke-virtual {v5, v7}, Lnp/f;->add(Ljava/lang/Object;)Z

    goto :goto_0

    :cond_4
    invoke-static {v5}, Lal/a;->f(Lnp/f;)Lnp/f;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-static {p1, p0}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
