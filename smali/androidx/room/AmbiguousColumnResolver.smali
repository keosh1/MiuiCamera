...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILxp/l;)V
    .locals 2
    ...
    invoke-static {p2}, Lmp/s;->U(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p0

    invoke-interface {p4, p0}, Lxp/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILxp/l;)V
    ...
    invoke-static {p2}, Llq/h;->i(Ljava/util/List;)I
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILxp/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILxp/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lxp/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, Lxp/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    invoke-static {v2, v7}, Lmp/o;->E(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v2}, Lal/a;->f(Lnp/f;)Lnp/f;
    ...
    invoke-virtual {v2, v9}, Lnp/f;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v11}, Lnp/a;->add(Ljava/lang/Object;)Z
    ...
    :cond_6
    invoke-static {v4}, Llq/h;->e(Lnp/a;)Lnp/a;
    ...
    invoke-direct {v10, v4, v8, v11}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lxp/q;)V
    ...
    new-instance v13, Lnp/a;

    invoke-direct {v13}, Lnp/a;-><init>()V

    invoke-virtual {v4}, Lnp/a;->iterator()Ljava/util/Iterator;
    ...
    check-cast v15, Lnp/a$a;

    invoke-virtual {v15}, Lnp/a$a;->hasNext()Z

    move-result v16

    if-eqz v16, :cond_9

    invoke-virtual {v15}, Lnp/a$a;->next()Ljava/lang/Object;
    ...
    invoke-virtual {v13, v5}, Lnp/a;->add(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v13}, Llq/h;->e(Lnp/a;)Lnp/a;

    invoke-virtual {v13}, Lnp/a;->isEmpty()Z
    ...
    invoke-static {v0, v11, v1}, Landroidx/activity/n;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v11 .. v17}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILxp/l;ILjava/lang/Object;)V
    ...
    invoke-static/range {v6 .. v12}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILxp/l;ILjava/lang/Object;)V
