...
# instance fields
.field final synthetic $$this$flow:Ljq/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljq/f<",
            "TR;>;"
...
# direct methods
.method public constructor <init>(ZLandroidx/room/RoomDatabase;Ljq/f;[Ljava/lang/String;Ljava/util/concurrent/Callable;Lpp/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    iput-object p3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:Ljq/f;
    ...
    invoke-direct {p0, p1, p6}, Lrp/i;-><init>(ILpp/d;)V
...
.method public final create(Ljava/lang/Object;Lpp/d;)Lpp/d;
    ...
    iget-object v3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:Ljq/f;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;-><init>(ZLandroidx/room/RoomDatabase;Ljq/f;[Ljava/lang/String;Ljava/util/concurrent/Callable;Lpp/d;)V
...
.method public final invoke(Lgq/a0;Lpp/d;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->create(Ljava/lang/Object;Lpp/d;)Lpp/d;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->invoke(Lgq/a0;Lpp/d;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v1, v3, v4}, Liq/i;->a(ILiq/a;I)Liq/b;
    ...
    invoke-direct {v7, v1, v8}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;-><init>([Ljava/lang/String;Liq/f;)V

    sget-object v1, Llp/k;->a:Llp/k;

    invoke-interface {v8, v1}, Liq/t;->e(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v4, v5}, Lpp/f;->get(Lpp/f$c;)Lpp/f$b;
    ...
    invoke-virtual {v4}, Landroidx/room/TransactionElement;->getTransactionDispatcher$room_ktx_release()Lpp/e;
    ...
    invoke-static {v4}, Landroidx/room/CoroutinesRoomKt;->getTransactionDispatcher(Landroidx/room/RoomDatabase;)Lgq/x;
    ...
    invoke-static {v4}, Landroidx/room/CoroutinesRoomKt;->getQueryDispatcher(Landroidx/room/RoomDatabase;)Lgq/x;
    ...
    invoke-static {v5, v3, v6}, Liq/i;->a(ILiq/a;I)Liq/b;
    ...
    invoke-direct/range {v5 .. v11}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;-><init>(Landroidx/room/RoomDatabase;Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;Liq/f;Ljava/util/concurrent/Callable;Liq/f;Lpp/d;)V

    const/4 v5, 0x2

    invoke-static {p1, v4, v12, v5}, Lgq/e;->a(Lgq/a0;Lpp/f;Lxp/p;I)Lgq/s1;

    iget-object p1, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:Ljq/f;

    iput v2, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->label:I

    invoke-static {p1, v3, v2, p0}, Lqo/y0;->h(Ljq/f;Liq/f;ZLpp/d;)Ljava/lang/Object;
