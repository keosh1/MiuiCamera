...
.method public final registerLayoutStateChangeCallback(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lgq/f1;
    ...
    instance-of v2, v0, Lgq/m0;

    if-eqz v2, :cond_1

    move-object v2, v0

    check-cast v2, Lgq/m0;

    :cond_1
    new-instance v2, Lgq/y0;

    invoke-direct {v2, v0}, Lgq/y0;-><init>(Ljava/util/concurrent/Executor;)V

    invoke-static {v2}, Lgq/b0;->a(Lpp/f;)Llq/d;

    move-result-object v0

    new-instance v2, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver$registerLayoutStateChangeCallback$1;

    invoke-direct {v2, p0, p1, v1}, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver$registerLayoutStateChangeCallback$1;-><init>(Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;Landroid/app/Activity;Lpp/d;)V

    const/4 p1, 0x3

    invoke-static {v0, v1, v2, p1}, Lgq/e;->a(Lgq/a0;Lpp/f;Lxp/p;I)Lgq/s1;

    move-result-object p1

    iput-object p1, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lgq/f1;
...
.method public final unregisterLayoutStateChangeCallback()V
    ...
    iget-object p0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lgq/f1;
