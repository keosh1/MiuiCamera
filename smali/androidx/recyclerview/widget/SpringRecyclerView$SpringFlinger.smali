...
.method public notifyHorizontalEdgeReached(I)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lps/d;
    ...
    iget-object v1, v0, Lps/d;->b:Lps/b;

    const/4 v2, 0x0

    iget p0, v1, Lps/d$a;->h:I

    if-nez p0, :cond_1

    iget-object p0, v1, Lps/b;->r:Lps/b$b;

    if-eqz p0, :cond_0

    invoke-virtual {v1}, Lps/b;->h()V

    :cond_0
    iget-wide p0, v1, Lps/d$a;->d:D
    ...
    invoke-virtual/range {v1 .. v6}, Lps/b;->j(IIIII)V
...
.method public notifyVerticalEdgeReached(I)V
    ...
    iget-object v1, v0, Lps/d;->c:Lps/b;
...
.method public overFling(IIII)V
    ...
    invoke-virtual/range {v6 .. v15}, Lps/d;->b(IIIIIIIII)V
...
.method public springBack(II)V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RemixRecyclerView$ViewFlinger;->mOverScroller:Lps/d;
    ...
    iget-object v0, v1, Lps/d;->b:Lps/b;

    const/4 v2, 0x0

    invoke-virtual {v0, v2, p1, p1}, Lps/b;->i(III)Z

    move-result p1

    iget-object v0, v1, Lps/d;->c:Lps/b;

    invoke-virtual {v0, v2, p2, p2}, Lps/b;->i(III)Z
