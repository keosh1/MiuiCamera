...
# virtual methods
.method public dispatch(Lpp/f;Ljava/lang/Runnable;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/lifecycle/DispatchQueue;->dispatchAndEnqueue(Lpp/f;Ljava/lang/Runnable;)V
...
.method public isDispatchNeeded(Lpp/f;)Z
    ...
    invoke-virtual {v0, p1}, Lgq/x;->isDispatchNeeded(Lpp/f;)Z
