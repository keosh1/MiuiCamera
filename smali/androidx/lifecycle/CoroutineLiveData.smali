...
# direct methods
.method public constructor <init>(Lpp/f;JLxp/p;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v0}, Lgq/t1;-><init>(Lgq/f1;)V
    ...
    invoke-virtual {v0, p1}, Lpp/a;->plus(Lpp/f;)Lpp/f;
    ...
    invoke-static {p1}, Lgq/b0;->a(Lpp/f;)Llq/d;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/lifecycle/BlockRunner;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lxp/p;JLgq/a0;Lxp/a;)V
...
.method public synthetic constructor <init>(Lpp/f;JLxp/p;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 2
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/lifecycle/CoroutineLiveData;-><init>(Lpp/f;JLxp/p;)V
...
# virtual methods
.method public final clearSource$lifecycle_livedata_release(Lpp/d;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroidx/lifecycle/CoroutineLiveData$clearSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lpp/d;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/lifecycle/EmittedSource;->disposeNow(Lpp/d;)Ljava/lang/Object;
...
.method public final emitSource$lifecycle_livedata_release(Landroidx/lifecycle/LiveData;Lpp/d;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/lifecycle/CoroutineLiveData$emitSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lpp/d;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/lifecycle/CoroutineLiveData;->clearSource$lifecycle_livedata_release(Lpp/d;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, v0}, Landroidx/lifecycle/CoroutineLiveDataKt;->addDisposableSource(Landroidx/lifecycle/MediatorLiveData;Landroidx/lifecycle/LiveData;Lpp/d;)Ljava/lang/Object;
