...
# instance fields
.field private final _currentStateFlow:Ljq/i;
...
.method private constructor <init>(Landroidx/lifecycle/LifecycleOwner;Z)V
    ...
    :cond_0
    invoke-direct {p1, p2}, Ljq/n;-><init>(Ljava/lang/Object;)V

    .line 8
    iput-object p1, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:Ljq/i;
...
.method private final calculateTargetState(Landroidx/lifecycle/LifecycleObserver;)Landroidx/lifecycle/Lifecycle$State;
    ...
    invoke-static {v0, v1}, La0/v;->e(Ljava/util/ArrayList;I)Ljava/lang/Object;
...
.method private final sync()V
    ...
    iget-object v0, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:Ljq/i;

    invoke-virtual {p0}, Landroidx/lifecycle/LifecycleRegistry;->getCurrentState()Landroidx/lifecycle/Lifecycle$State;

    move-result-object p0

    invoke-interface {v0, p0}, Ljq/i;->setValue(Ljava/lang/Object;)V
...
.method public getCurrentStateFlow()Ljq/m;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object p0, p0, Landroidx/lifecycle/LifecycleRegistry;->_currentStateFlow:Ljq/i;

    new-instance v0, Ljq/j;

    invoke-direct {v0, p0}, Ljq/j;-><init>(Ljq/m;)V
