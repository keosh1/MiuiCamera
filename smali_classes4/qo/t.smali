...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lqo/t$a;

    new-instance v2, Lqo/s;

    invoke-direct {v2}, Lqo/s;-><init>()V

    invoke-direct {v1, v2}, Lqo/t$a;-><init>(Lqo/s;)V

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    sput-object v0, Lqo/t;->a:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public static b(Landroid/content/Context;Ljava/net/URL;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0, p1}, Lqo/t;->e(Landroid/content/Context;Ljava/net/URL;)Lqo/t$b;
...
.method public static c(Ljava/lang/String;Ljava/util/TreeMap;)Lqo/p;
    .locals 8
    ...
    new-instance v4, Lqo/t$b;

    invoke-virtual {v3}, Ljava/net/URLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object v5

    invoke-direct {v4, v5}, Lqo/t$b;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-direct {v4, v3}, Lqo/t$b;-><init>(Ljava/io/InputStream;)V
    ...
    iput-object v0, v1, Lqo/p;->c:Ljava/lang/String;
    ...
    :cond_7
    :try_start_7
    iget-object v6, v1, Lqo/p;->b:Ljava/util/HashMap;
    ...
    invoke-static {p1}, Lwt/c;->b(Ljava/io/Closeable;)V

    throw p0
.end method

.method public static d(Landroid/content/Context;)Lqo/r;
    .locals 3

    if-nez p0, :cond_0

    sget-object p0, Lqo/y6;->a:Landroid/content/Context;
...
.method public static e(Landroid/content/Context;Ljava/net/URL;)Lqo/t$b;
    .locals 5
    ...
    invoke-static {v0}, Li6/a;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    new-instance p1, Lqo/t$b;

    invoke-virtual {p0}, Ljava/net/URLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object p0

    invoke-direct {p1, p0}, Lqo/t$b;-><init>(Ljava/io/InputStream;)V
    :try_end_0
...
.method public static f()Lqo/u;
    .locals 6

    sget-object v0, Lqo/t;->a:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lqo/t$a;
    ...
    invoke-static {v2}, Lqo/s6;->g(Landroid/content/Context;)Z
    ...
    invoke-virtual {v1}, Lqo/t$a;->run()V
...
.method public static g(Ljava/lang/String;Ljava/util/HashMap;Ljava/io/File;)V
    ...
    new-instance v2, Lqo/t$b;

    invoke-virtual {p0}, Ljava/net/URLConnection;->getInputStream()Ljava/io/InputStream;

    move-result-object p0

    invoke-direct {v2, p0}, Lqo/t$b;-><init>(Ljava/io/InputStream;)V
