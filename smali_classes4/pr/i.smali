...
.method public static b(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    invoke-static {v0, p0, p1}, Lpr/i;->c(Landroid/view/WindowManager;Landroid/content/Context;Landroid/graphics/Point;)V
...
.method public static c(Landroid/view/WindowManager;Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    invoke-static {p0}, Landroidx/core/view/n;->d(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;

    move-result-object p0

    invoke-static {p0}, Landroidx/core/view/m;->b(Landroid/view/WindowMetrics;)Landroid/graphics/Rect;
...
.method public static d(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    :cond_3
    invoke-static {v0}, Landroidx/core/view/n;->d(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;
    ...
    :cond_4
    invoke-static {p0}, Lpr/e;->i(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-static {p0}, Lpr/i;->a(Landroid/content/Context;)Landroid/view/Display;
