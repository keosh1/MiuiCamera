...
.method public constructor <init>(Lum/b;)V
    ...
    sget-object p1, Lnm/a;->a:Ljava/lang/String;

    const-string p1, "adult"

    iput-object p1, p0, Lum/a;->c:Ljava/lang/String;

    const-string p1, ""

    iput-object p1, p0, Lum/a;->d:Ljava/lang/String;

    sget-object p1, Lum/a$a;->a:Lum/a$a;

    invoke-static {p1}, La0/j5;->u(Lxp/a;)Llp/h;

    move-result-object p1

    iput-object p1, p0, Lum/a;->e:Llp/h;
...
.method public final a(Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    sget-object v2, Lnm/a;->a:Ljava/lang/String;
    ...
    iget-object v8, v0, Lum/a;->a:Lum/b;

    if-eqz v3, :cond_3

    sget-object v9, Lwm/b;->h:Lwm/b;

    invoke-virtual {v3}, Lcom/faceunity/core/entity/FUBundleData;->getPath()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v9, v10}, Lwm/b;->c(Ljava/lang/String;)I

    move-result v9

    iput v9, v0, Lum/a;->b:I
    ...
    :goto_0
    iput-object v9, v0, Lum/a;->c:Ljava/lang/String;

    iget v9, v0, Lum/a;->b:I

    invoke-static {v9}, Lum/b;->i(I)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v0, Lum/a;->d:Ljava/lang/String;

    invoke-virtual {v8, v2}, Lum/b;->l(Ljava/lang/String;)Lpm/f;
    ...
    :cond_1
    invoke-virtual {v8, v2, v4}, Lum/b;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v11, v10, Lpm/e;->a:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lpm/f;->d:Lpm/h;

    iput-object v10, v0, Lpm/h;->b:Lpm/e;

    :cond_3
    :goto_1
    iget-object v0, v8, Lum/b;->g:Ljava/util/HashMap;
    ...
    sget-object v10, Lnm/a;->a:Ljava/lang/String;
    ...
    invoke-virtual {v8, v9, v4}, Lum/b;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v12

    invoke-virtual {v8, v9}, Lum/b;->d(Ljava/lang/String;)Ljava/util/ArrayList;

    move-result-object v9

    iget-object v13, v3, Lpm/f;->d:Lpm/h;

    const/4 v14, 0x0

    iput-object v14, v13, Lpm/h;->b:Lpm/e;

    iput-object v14, v13, Lpm/h;->a:Lpm/a;

    invoke-virtual {v9}, Ljava/util/ArrayList;->size()I

    move-result v13

    iget-object v3, v3, Lpm/f;->d:Lpm/h;
    ...
    iget-object v13, v13, Lpm/a;->a:Ljava/lang/String;
    ...
    iget-object v14, v9, Lpm/a;->a:Ljava/lang/String;
    ...
    invoke-direct/range {v13 .. v18}, Lpm/a;-><init>(Ljava/lang/String;Ljava/lang/String;III)V

    iput-object v7, v3, Lpm/h;->a:Lpm/a;
    ...
    iget-object v6, v6, Lpm/e;->a:Ljava/util/ArrayList;
    ...
    iput-object v7, v3, Lpm/h;->b:Lpm/e;
    ...
    iget-object v9, v7, Lpm/e;->a:Ljava/util/ArrayList;
...
.method public final c(Lcom/faceunity/core/avatar/model/Scene;Ljava/lang/String;Lpm/e;)V
    .locals 25
    ...
    sget-object v4, Lnm/a;->a:Ljava/lang/String;
    ...
    iget-object v9, v3, Lpm/e;->a:Ljava/util/ArrayList;

    if-eqz v5, :cond_a

    invoke-static/range {p1 .. p1}, Lum/a;->b(Lcom/faceunity/core/avatar/model/Scene;)Lcom/faceunity/core/avatar/model/Avatar;
    ...
    iget-object v5, v8, Lum/b;->e:Ljava/util/HashMap;
    ...
    :cond_2
    invoke-virtual {v8, v4}, Lum/b;->l(Ljava/lang/String;)Lpm/f;
    ...
    sget-object v6, Lwm/b;->h:Lwm/b;

    invoke-virtual {v6, v12}, Lwm/b;->c(Ljava/lang/String;)I

    move-result v6

    iput v6, v0, Lum/a;->b:I
    ...
    invoke-static {v6}, Lum/b;->i(I)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v0, Lum/a;->d:Ljava/lang/String;
    ...
    iget-object v9, v0, Lum/a;->d:Ljava/lang/String;
    ...
    iget-object v5, v5, Lpm/d;->c:Lorg/json/JSONObject;
    ...
    :cond_5
    iget-object v5, v0, Lum/a;->d:Ljava/lang/String;

    invoke-virtual {v8, v5}, Lum/b;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_6
    iget-object v1, v0, Lum/a;->d:Ljava/lang/String;

    invoke-virtual {v8, v1}, Lum/b;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, v0, Lum/a;->e:Llp/h;
    ...
    iget-object v0, v10, Lpm/f;->d:Lpm/h;

    iput-object v3, v0, Lpm/h;->b:Lpm/e;
    ...
    sget-object v11, Lnm/a;->j:Lnm/a$c;

    invoke-virtual {v11, v2}, Lnm/a$c;->contains(Ljava/lang/Object;)Z

    move-result v11

    if-eqz v11, :cond_d

    sget-object v11, Lnm/a;->i:Ljava/lang/String;

    invoke-virtual {v8, v11}, Lum/b;->l(Ljava/lang/String;)Lpm/f;

    move-result-object v11

    if-eqz v11, :cond_d

    iget-object v11, v11, Lpm/f;->d:Lpm/h;

    iput-object v7, v11, Lpm/h;->b:Lpm/e;

    :cond_d
    invoke-virtual {v5, v2}, Ljava/util/HashSet;->add(Ljava/lang/Object;)Z

    iget-object v11, v4, Lpm/f;->c:Lpm/g;

    iget-object v12, v11, Lpm/g;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {v8, v13}, Lum/b;->l(Ljava/lang/String;)Lpm/f;
    ...
    :cond_e
    iget-object v15, v15, Lpm/f;->d:Lpm/h;

    iget-object v7, v15, Lpm/h;->b:Lpm/e;

    if-eqz v7, :cond_10

    iget-object v7, v7, Lpm/e;->a:Ljava/util/ArrayList;
    ...
    iget-object v7, v0, Lum/a;->c:Ljava/lang/String;

    invoke-virtual {v8, v13, v7}, Lum/b;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    check-cast v13, Lpm/e;

    iget-object v13, v13, Lpm/e;->a:Ljava/util/ArrayList;
    ...
    iput-object v7, v15, Lpm/h;->b:Lpm/e;
    ...
    iget-object v11, v11, Lpm/g;->f:Ljava/util/ArrayList;
    ...
    invoke-virtual {v8, v12}, Lum/b;->l(Ljava/lang/String;)Lpm/f;
    ...
    :cond_13
    iget-object v13, v13, Lpm/f;->d:Lpm/h;

    iget-object v15, v13, Lpm/h;->b:Lpm/e;

    if-eqz v15, :cond_14

    iget-object v15, v15, Lpm/e;->a:Ljava/util/ArrayList;
    ...
    iget-object v15, v0, Lum/a;->c:Ljava/lang/String;

    invoke-virtual {v8, v12, v15}, Lum/b;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iput-object v6, v13, Lpm/h;->b:Lpm/e;
    ...
    invoke-virtual {v8, v9}, Lum/b;->l(Ljava/lang/String;)Lpm/f;
    ...
    iget-object v12, v0, Lum/a;->c:Ljava/lang/String;

    invoke-virtual {v8, v11, v12}, Lum/b;->k(Ljava/lang/String;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    check-cast v12, Lpm/e;

    iget-object v13, v12, Lpm/e;->a:Ljava/util/ArrayList;
    ...
    iget-object v7, v9, Lpm/f;->d:Lpm/h;

    iput-object v12, v7, Lpm/h;->b:Lpm/e;
    ...
    :cond_1e
    iget-object v0, v4, Lpm/f;->d:Lpm/h;

    iput-object v3, v0, Lpm/h;->b:Lpm/e;

    invoke-static {v5}, Lmp/s;->U(Ljava/lang/Iterable;)Ljava/util/List;
