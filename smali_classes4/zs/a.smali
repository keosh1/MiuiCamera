...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lzs/a;->b:Landroid/content/Context;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lzs/a;->d:Z

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v3

    sget v4, Lvs/c;->miuix_appcompat_arrow_popup_window_list_max_height:I

    invoke-virtual {v3, v4}, Landroid/content/res/Resources;->getDimensionPixelOffset(I)I

    move-result v3

    iput v3, p0, Lzs/a;->c:I

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object p1

    sget v3, Lvs/f;->miuix_appcompat_arrow_popup_view:I
    ...
    iput-object p1, p0, Lzs/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;
    ...
    invoke-virtual {p1, p0}, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->setArrowPopupWindow(Lzs/a;)V
    ...
    invoke-direct {v4, p1}, Lys/a;-><init>(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)V
    ...
    invoke-direct {v5, p1}, Lys/b;-><init>(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)V
    ...
    iput v3, p1, Lzs/c;->f:I

    invoke-virtual {p1, v2}, Landroid/widget/PopupWindow;->setFocusable(Z)V

    iget-object v3, p1, Lzs/a;->b:Landroid/content/Context;

    invoke-static {v3}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v3

    sget v4, Lvs/f;->miuix_appcompat_guide_popup_content_view:I
    ...
    iput-object v0, p1, Lzs/c;->e:Landroid/widget/LinearLayout;

    invoke-virtual {p1, v0}, Lzs/a;->setContentView(Landroid/view/View;)V

    iget-object v0, p1, Lzs/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;

    iput-boolean v1, v0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->m0:Z

    iget-object v0, p1, Lzs/c;->e:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v1, p1}, Lzs/b;-><init>(Lzs/c;)V
...
.method public final b(I)V
    ...
    iget-object v1, p0, Lzs/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;
    ...
    :cond_1
    invoke-virtual {p0}, Lzs/a;->getContentView()Landroid/view/View;
...
.method public final setHeight(I)V
    ...
    invoke-virtual {p0, p1}, Lzs/a;->b(I)V
...
.method public final showAsDropDown(Landroid/view/View;II)V
    ...
    .line 1
    invoke-virtual {p0, p2, p1, p3}, Lzs/a;->c(ILandroid/view/View;I)V
...
.method public final update(IIIIZ)V
    ...
    invoke-virtual {p0, p4}, Lzs/a;->b(I)V
