...
.method public constructor <init>(Lxo/c;)V
    ...
    iput v0, p0, Lxo/e;->c:I

    iput v0, p0, Lxo/e;->d:I

    iput-object p1, p0, Lxo/e;->a:Lxo/c;
...
.method public final a()I
    ...
    iget v0, p0, Lxo/e;->d:I

    const/4 v1, -0x1

    if-ne v0, v1, :cond_1

    iget-object v2, p0, Lxo/e;->a:Lxo/c;

    if-eqz v2, :cond_1

    iget-object p0, p0, Lxo/e;->b:Landroid/opengl/EGLSurface;
    ...
    iget-object v2, v2, Lxo/c;->a:Landroid/opengl/EGLDisplay;
...
.method public c()Z
    ...
    iget-object v0, p0, Lxo/e;->b:Landroid/opengl/EGLSurface;

    iget-object v1, p0, Lxo/e;->a:Lxo/c;
    ...
    iget-object p0, p0, Lxo/e;->a:Lxo/c;

    iget-object v1, p0, Lxo/c;->a:Landroid/opengl/EGLDisplay;

    iget-object p0, p0, Lxo/c;->b:Landroid/opengl/EGLContext;
...
.method public d()Z
    ...
    iget-object v0, p0, Lxo/e;->a:Lxo/c;

    if-eqz v0, :cond_2

    iget-object v1, p0, Lxo/e;->b:Landroid/opengl/EGLSurface;
    ...
    iget-object v3, v0, Lxo/c;->a:Landroid/opengl/EGLDisplay;
    ...
    iget-object v3, v0, Lxo/c;->b:Landroid/opengl/EGLContext;
    ...
    iget-object v4, v0, Lxo/c;->b:Landroid/opengl/EGLContext;
    ...
    :cond_1
    iget-object v0, v0, Lxo/c;->a:Landroid/opengl/EGLDisplay;
    ...
    iput-object v1, p0, Lxo/e;->a:Lxo/c;

    iput-object v1, p0, Lxo/e;->b:Landroid/opengl/EGLSurface;

    const/4 v1, -0x1

    iput v1, p0, Lxo/e;->c:I

    iput v1, p0, Lxo/e;->d:I
