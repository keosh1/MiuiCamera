...
.method public constructor <init>(Lvl/e;)V
    ...
    iput-object p1, p0, Lvl/e$a;->b:Lvl/e;

    invoke-direct {p0}, Lvl/e$d;-><init>()V
...
.method public final OnConvertProgress(I)V
    ...
    iget-object v0, p0, Lvl/e$a;->b:Lvl/e;

    if-eqz p1, :cond_0

    iget-object p0, p0, Lvl/e$d;->a:Lq8/c;

    invoke-interface {p1, p0}, Lw7/y1;->y0(Lq8/c;)V

    goto :goto_0

    :cond_0
    invoke-virtual {v0, v2}, Lvl/e;->k(Z)V
