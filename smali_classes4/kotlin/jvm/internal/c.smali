...
.field private transient reflected:Lcq/b;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->getReflected()Lcq/b;

    move-result-object p0

    invoke-interface {p0, p1}, Lcq/b;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {p0, p1}, Lcq/b;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Lcq/b;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lcq/b;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->computeReflected()Lcq/b;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lcq/b;

    :cond_0
    return-object v0
.end method

.method public abstract computeReflected()Lcq/b;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {p0}, Lcq/a;->getAnnotations()Ljava/util/List;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, Lcq/b;->getParameters()Ljava/util/List;
...
.method public getReflected()Lcq/b;
    .locals 1

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->compute()Lcq/b;
...
.method public getReturnType()Lcq/j;
    .locals 0
    ...
    invoke-interface {p0}, Lcq/b;->getReturnType()Lcq/j;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, Lcq/b;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Lcq/k;
    .locals 0
    ...
    invoke-interface {p0}, Lcq/b;->getVisibility()Lcq/k;
...
.method public isAbstract()Z
    ...
    invoke-interface {p0}, Lcq/b;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {p0}, Lcq/b;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {p0}, Lcq/b;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {p0}, Lcq/b;->isSuspend()Z
