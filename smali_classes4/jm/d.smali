...
# direct methods
.method public static a(Lmm/a;)V
    .locals 10
    ...
    invoke-virtual {v2, v3}, Lwm/b;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v6, v3}, Lac/k;->v(Ljava/lang/String;ILjava/lang/String;)V

    goto :goto_0

    :cond_0
    invoke-static {v4}, Lak/g;->l(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v7, v3}, Lac/k;->v(Ljava/lang/String;ILjava/lang/String;)V
    ...
    sget-object v5, Lkm/a;->a:Ljava/lang/String;
    ...
    sget-object v8, Lkm/a;->b:Ljava/lang/String;
    ...
    iget-object v0, p0, Lwl/h$a;->a:Lwl/h;

    iget-object v1, v0, Lwl/h;->Y:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0}, Lwl/h;->t()V

    goto :goto_2

    :cond_4
    iget-object v1, v0, Lwl/h;->W:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v2}, Lwm/b;->h()I

    move-result v2

    invoke-direct {v1, v2}, Lcm/l;-><init>(I)V

    iput-object v1, v0, Lwl/h;->r:Lcm/l;

    iget-object v1, v1, Lcm/l;->a:Lcm/k;

    iput-object v1, v0, Lwl/h;->f0:Lcm/k;
    ...
    iget-object v0, v0, Lwl/h;->q:Lcom/faceunity/core/faceunity/FUAIKit;
    ...
    invoke-virtual {v2, v0}, Ld9/f;->u(Ljava/lang/Runnable;)V
    ...
    invoke-static {v4, v6, p0}, Lac/k;->v(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-static {v4, v6, v0}, Lac/k;->v(Ljava/lang/String;ILjava/lang/String;)V

    iget-object p0, p0, Lwl/h$a;->a:Lwl/h;

    const/4 v0, 0x0

    iput-object v0, p0, Lwl/h;->t0:Lmm/a;
...
.method public static b(Ljava/lang/String;Lmm/a;)V
    .locals 13
    ...
    iput-object v4, v0, Lmn/c;->a:[B

    iput-object v5, v0, Lmn/c;->b:[B
    ...
    invoke-direct/range {v6 .. v11}, Ljm/a;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lmm/a;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    invoke-static {v12, v3}, La6/a;->y(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct/range {v3 .. v9}, Ljm/b;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lmm/a;Ljava/util/concurrent/atomic/AtomicInteger;)V

    invoke-static {v12, p0}, La6/a;->y(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
