...
.method public constructor <init>(Lmiuix/appcompat/widget/Spinner;Landroid/content/Context;)V
    ...
    invoke-direct {p0, p2, p1}, Lzs/f;-><init>(Landroid/content/Context;Landroid/view/View;)V
    ...
    iget-object p2, p0, Lzs/f;->d:Lws/a;

    sget v0, Lvq/a$f;->miuix_appcompat_drop_down_menu_padding_single_item:I
    ...
    sget v1, Lvq/a$f;->miuix_appcompat_drop_down_item_min_height:I
    ...
    iput p1, p2, Lws/a;->d:I

    const p1, 0x800053

    invoke-super {p0, p1}, Lzs/f;->c(I)V
    ...
    iput-object p1, p0, Lzs/f;->x:Landroid/widget/AdapterView$OnItemClickListener;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lzs/f;->c0:Z
...
.method public final i(Landroid/widget/ListAdapter;Landroid/content/Context;)[[I
    ...
    iget-object p0, p0, Lzs/f;->f:Landroid/widget/ListView;
    ...
    iget-object p2, p0, Lzs/f;->b:Landroid/view/View;
    ...
    iget-object p0, p0, Lzs/f;->b:Landroid/view/View;
...
.method public final j(Landroid/view/View;)Z
    ...
    invoke-super {p0, p1}, Lzs/f;->j(Landroid/view/View;)Z
...
.method public final setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Lzs/f;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public final show(II)V
    ...
    sget v5, Lvq/a$h;->action_bar_overlay_layout:I
    ...
    invoke-virtual {p0, v1}, Lzs/f;->n(Landroid/view/View;)V
    ...
    invoke-virtual {v1}, Lws/a;->toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lzs/f;->l(Landroid/view/View;)V

    :cond_4
    iget-object v5, v1, Lws/a;->q:Landroid/graphics/Rect;

    invoke-virtual {v5}, Landroid/graphics/Rect;->centerX()I

    move-result v5

    iget-object v6, v1, Lws/a;->p:Landroid/graphics/Rect;
    ...
    invoke-super {p0, v5}, Lzs/f;->c(I)V
    ...
    :goto_3
    iget-object v5, p0, Lzs/f;->e:La/a;

    invoke-virtual {v5, v1}, La/a;->f(Lws/a;)I

    move-result v6

    invoke-virtual {v5, v1}, La/a;->g(Lws/a;)I

    move-result v5

    iget v7, v1, Lws/a;->g:I

    invoke-virtual {p0, v7}, Landroid/widget/PopupWindow;->setWidth(I)V

    iget v1, v1, Lws/a;->h:I
    ...
    invoke-virtual {p0, v4, v3, v6, v5}, Lzs/f;->showAtLocation(Landroid/view/View;III)V
    ...
    :goto_4
    iget-object v1, p0, Lzs/f;->f:Landroid/widget/ListView;
