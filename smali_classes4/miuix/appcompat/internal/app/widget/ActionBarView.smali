...
.field public final q1:Lhr/a;

.field public r0:Landroid/view/View;

.field public final r1:Lhr/a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v11, Lvq/a$f;->miuix_appcompat_action_bar_title_horizontal_padding:I
    ...
    sget v11, Lvq/a$f;->miuix_appcompat_action_bar_title_tab_horizontal_padding:I
    ...
    sget v11, Lvq/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v11, Lvq/a$f;->miuix_appcompat_action_bar_title_bottom_padding:I
    ...
    sget v11, Lvq/a$f;->miuix_appcompat_action_bar_subtitle_bottom_padding:I
    ...
    sget v11, Lvq/a$f;->miuix_appcompat_action_bar_secondary_tab_vertical_padding:I
    ...
    sget v11, Lvq/a$f;->miuix_appcompat_action_bar_up_view_margin_start:I
    ...
    sget v5, Lvq/a$h;->action_bar_collapse_container:I
    ...
    sget v7, Lvq/a$h;->action_bar_movable_container:I
    ...
    sget-object v1, Lvq/a$m;->ActionBar:[I
    ...
    sget v1, Lvq/a$m;->ActionBar_android_navigationMode:I
    ...
    sget v1, Lvq/a$m;->ActionBar_android_title:I
    ...
    sget v1, Lvq/a$m;->ActionBar_android_subtitle:I
    ...
    sget v1, Lvq/a$m;->ActionBar_titleCenter:I
    ...
    sget v1, Lvq/a$m;->ActionBar_android_logo:I
    ...
    sget v1, Lvq/a$m;->ActionBar_android_icon:I
    ...
    sget v4, Lvq/a$m;->ActionBar_navigatorSwitchLayout:I

    sget v5, Lvq/a$j;->miuix_appcompat_action_bar_navigator_switch:I
    ...
    sget v4, Lvq/a$m;->ActionBar_android_homeLayout:I

    sget v5, Lvq/a$j;->miuix_appcompat_action_bar_home:I
    ...
    sget v4, Lvq/a$m;->ActionBar_android_titleTextStyle:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    sget v4, Lvq/a$m;->ActionBar_android_subtitleTextStyle:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    sget v4, Lvq/a$m;->ActionBar_android_progressBarPadding:I
    ...
    sget v4, Lvq/a$m;->ActionBar_android_itemPadding:I

    invoke-virtual {p2, v4, v2}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    sget v4, Lvq/a$m;->ActionBar_android_displayOptions:I
    ...
    sget v4, Lvq/a$m;->ActionBar_android_customNavigationLayout:I
    ...
    :cond_2
    sget v0, Lvq/a$m;->ActionBar_android_minHeight:I
    ...
    sget v0, Lvq/a$m;->ActionBar_android_maxHeight:I
    ...
    sget v1, Lvq/a$f;->miuix_appcompat_action_bar_large_font_max_height:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    sget v1, Lvq/a$c;->actionBarTitleAdaptLargeFont:I

    invoke-static {p1, v1, v3}, Lfs/d;->c(Landroid/content/Context;IZ)Z

    move-result v1

    invoke-static {p1}, Lpr/e;->c(Landroid/content/Context;)I
    ...
    sget v0, Lvq/a$m;->ActionBar_showOptionIcons:I
    ...
    invoke-direct {p2, p1, v1, v0}, Lhr/a;-><init>(Landroid/content/Context;ILjava/lang/CharSequence;)V

    iput-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->q1:Lhr/a;
    ...
    iput-object p2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->r1:Lhr/a;

    new-instance p1, Lcom/google/android/exoplayer2/analytics/c;

    const/16 p2, 0x10

    invoke-direct {p1, p0, p2}, Lcom/google/android/exoplayer2/analytics/c;-><init>(Ljava/lang/Object;I)V
...
.method private setTitleImpl(Ljava/lang/CharSequence;)V
    ...
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->q1:Lhr/a;

    if-eqz v4, :cond_3

    iput-object p1, v4, Lhr/a;->b:Ljava/lang/CharSequence;

    :cond_3
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->r1:Lhr/a;
    ...
    :cond_9
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;

    if-eqz p1, :cond_a

    iget-object p1, p1, Ldr/a;->b:Landroid/widget/LinearLayout;
    ...
    :cond_a
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;

    if-eqz p1, :cond_b

    if-nez v3, :cond_b

    iget-object p1, p1, Ldr/b;->b:Landroid/widget/LinearLayout;
...
.method private setTitleVisibility(Z)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;
    ...
    :goto_0
    iget-boolean v5, v0, Ldr/a;->e:Z

    if-nez v5, :cond_1

    if-nez v4, :cond_1

    iget-object v0, v0, Ldr/a;->b:Landroid/widget/LinearLayout;
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;
    ...
    :goto_2
    invoke-virtual {v0, p1}, Ldr/b;->c(I)V
...
.method public final A(Z)V
    ...
    invoke-direct {v1, v0}, Ldr/b;-><init>(Landroid/content/Context;)V

    new-instance v2, Landroid/widget/LinearLayout;

    invoke-direct {v2, v0}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v2, v1, Ldr/b;->b:Landroid/widget/LinearLayout;

    const/4 v3, 0x2

    invoke-virtual {v2, v3}, Landroid/view/View;->setImportantForAccessibility(I)V

    iget-object v2, v1, Ldr/b;->b:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v5, v1, v6}, Landroidx/room/g;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v2, v5}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    new-instance v2, Lfr/c;

    sget v5, Lvq/a$c;->expandTitleTheme:I

    invoke-direct {v2, v0, v5}, Lfr/c;-><init>(Landroid/content/Context;I)V

    iput-object v2, v1, Ldr/b;->c:Lfr/c;

    sget v5, Lvq/a$h;->action_bar_title_expand:I

    invoke-virtual {v2, v5}, Landroid/view/View;->setId(I)V

    iget-object v2, v1, Ldr/b;->c:Lfr/c;
    ...
    invoke-static {v2}, Lal/a;->e(Landroid/widget/TextView;)V

    :cond_0
    iget-object v2, v1, Ldr/b;->b:Landroid/widget/LinearLayout;

    iget-object v6, v1, Ldr/b;->c:Lfr/c;
    ...
    sget v6, Lvq/a$c;->expandSubtitleTheme:I

    invoke-direct {v2, v0, v6}, Lfr/c;-><init>(Landroid/content/Context;I)V

    iput-object v2, v1, Ldr/b;->d:Lfr/c;

    sget v6, Lvq/a$h;->action_bar_subtitle_expand:I

    invoke-virtual {v2, v6}, Landroid/view/View;->setId(I)V

    iget-object v2, v1, Ldr/b;->d:Lfr/c;
    ...
    iget-object v7, v1, Ldr/b;->d:Lfr/c;
    ...
    sget v7, Lvq/a$f;->action_bar_subtitle_top_margin:I
    ...
    sget v7, Lvq/a$f;->action_bar_subtitle_bottom_margin:I
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;

    iget-boolean v0, v1, Ldr/b;->e:Z

    iget-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->i1:Z

    if-eq v0, v2, :cond_2

    iput-boolean v2, v1, Ldr/b;->e:Z

    iget-object v0, v1, Ldr/b;->b:Landroid/widget/LinearLayout;
    ...
    iget-boolean v1, v0, Ldr/b;->h:Z

    if-eqz v1, :cond_3

    iget-object v1, v0, Ldr/b;->c:Lfr/c;

    invoke-virtual {v1, v5}, Lfr/c;->b(Z)V

    iput-boolean v5, v0, Ldr/b;->h:Z
    ...
    iget-object v2, v0, Ldr/b;->c:Lfr/c;
    ...
    :cond_4
    iget-object v0, v0, Ldr/b;->d:Lfr/c;
    ...
    sget v2, Lvq/a$h;->action_bar_expand_container:I
    ...
    :goto_2
    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;

    invoke-virtual {v2, v0}, Ldr/b;->b(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;

    iget-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/a;->w:Z

    iget-object v7, v0, Ldr/b;->c:Lfr/c;
    ...
    new-instance v8, Lcom/xiaomi/microfilm/vlog/vv/n;

    const/16 v9, 0xa

    invoke-direct {v8, v0, v9}, Lcom/xiaomi/microfilm/vlog/vv/n;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v7, v8}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    iget-object v0, v0, Ldr/b;->c:Lfr/c;
    ...
    :goto_3
    iget-object v7, v0, Ldr/b;->d:Lfr/c;
    ...
    iget-object v2, v0, Ldr/b;->d:Lfr/c;

    iget-object v0, v0, Ldr/b;->i:Ldr/b$a;
    ...
    invoke-virtual {v0, v1}, Ldr/b;->a(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;

    iget-object p0, p0, Ldr/b;->b:Landroid/widget/LinearLayout;
...
.method public final H()V
    ...
    sget v2, Lvq/a$c;->actionBarIndeterminateProgressStyle:I
    ...
    sget v1, Lvq/a$h;->progress_circular:I
...
.method public final I()V
    ...
    sget v7, Lvq/a$f;->miuix_appcompat_action_bar_title_view_padding_horizontal:I
    ...
    invoke-direct {v8, v7, v6, v2}, Lr3/a;-><init>(Ljava/lang/Object;II)V

    invoke-virtual {v7, v8}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    sget v6, Lvq/a$h;->up:I
    ...
    sget v8, Lvq/a$k;->actionbar_button_up_description:I
    ...
    new-instance v6, Ler/a;

    invoke-direct {v6}, Ler/a;-><init>()V
    ...
    invoke-virtual {v6, v3}, Landroid/view/View;->setDuplicateParentStateEnabled(Z)V

    new-instance v8, Landroidx/core/content/res/a;

    const/16 v9, 0x13

    invoke-direct {v8, v9, v6, v1}, Landroidx/core/content/res/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    :goto_1
    iget-object v8, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->F0:Landroid/widget/FrameLayout;
    ...
    invoke-static {v2, v1, p0}, Lmiuix/appcompat/internal/app/widget/ActionBarView;->S(ILandroid/view/View;Landroid/view/ViewGroup;)V
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;
    ...
    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;
    ...
    invoke-direct {v1, p0, v3}, Lua/a;-><init>(Ljava/lang/Object;I)V
...
.method public final L()Z
    ...
    sget v0, Lvq/a$c;->actionBarTightTitle:I

    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->o0:Landroid/content/Context;

    invoke-static {p0, v0, v1}, Lfs/d;->c(Landroid/content/Context;IZ)Z
...
.method public final Q()V
    ...
    sget v3, Lvq/a$c;->actionBarPaddingStart:I

    invoke-static {v3, v2}, Lfs/d;->e(ILandroid/content/Context;)I
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;

    iget-object v2, v2, Ldr/a;->b:Landroid/widget/LinearLayout;
...
.method public final Y()V
    ...
    iget-object v0, v0, Ldr/a;->c:Lfr/b;
    ...
    invoke-virtual {v0, v1}, Ldr/a;->c(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;

    iget-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->j0:Ljava/lang/CharSequence;

    invoke-virtual {v0, v1}, Ldr/a;->b(Ljava/lang/CharSequence;)V
...
.method public final Z()V
    ...
    iget-object v2, v2, Ldr/b;->c:Lfr/c;
    ...
    invoke-virtual {v0, v1}, Ldr/b;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p0}, Ldr/b;->a(Ljava/lang/CharSequence;)V
...
.method public final a0()Z
    ...
    sget v1, Lvq/a$h;->action_bar_expand_container:I
    ...
    invoke-virtual {v0, v2}, Ldr/b;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v2, v4}, Ldr/b;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v1}, Ldr/b;->c(I)V

    :cond_2
    iget-object p0, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;

    iget-object p0, p0, Ldr/b;->d:Lfr/c;
...
.method public final d0()V
    ...
    :goto_1
    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;

    if-eqz v4, :cond_3

    iget-object v4, v4, Ldr/a;->c:Lfr/b;
...
.method public getCollapseTitle()Ldr/a;
    .locals 1
...
.method public getExpandTitle()Ldr/b;
    .locals 1
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    sget-object v0, Lvq/a$m;->ActionBar:[I
    ...
    sget v2, Lvq/a$f;->miuix_appcompat_action_bar_large_font_max_height:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    sget v2, Lvq/a$c;->actionBarTitleAdaptLargeFont:I

    const/4 v4, 0x1

    invoke-static {v0, v2, v4}, Lfs/d;->c(Landroid/content/Context;IZ)Z

    move-result v2

    invoke-static {v0}, Lpr/e;->c(Landroid/content/Context;)I
    ...
    iget-object v1, p1, Ldr/b;->c:Lfr/c;

    iget v2, p1, Ldr/b;->f:I

    invoke-virtual {v1, v2}, Landroid/widget/TextView;->setTextAppearance(I)V

    iget-object v1, p1, Ldr/b;->d:Lfr/c;

    iget v2, p1, Ldr/b;->g:I
    ...
    iget-object p1, p1, Ldr/b;->c:Lfr/c;

    invoke-static {p1}, Lal/a;->e(Landroid/widget/TextView;)V
    ...
    sget v1, Lvq/a$f;->miuix_appcompat_action_bar_title_tab_horizontal_padding:I
    ...
    sget v1, Lvq/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v1, Lvq/a$f;->miuix_appcompat_action_bar_title_bottom_padding:I
    ...
    sget v1, Lvq/a$f;->miuix_appcompat_action_bar_subtitle_bottom_padding:I
    ...
    sget v0, Lvq/a$f;->miuix_appcompat_action_bar_up_view_margin_start:I
    ...
    sget v0, Lvq/a$f;->miuix_appcompat_action_bar_title_horizontal_padding:I
    ...
    sget v3, Lvq/a$f;->miuix_appcompat_action_bar_title_top_padding:I
    ...
    sget v0, Lvq/a$f;->miuix_appcompat_action_bar_secondary_tab_vertical_padding:I
    ...
    sget v0, Lvq/a$c;->actionBarPaddingStart:I

    invoke-static {v0, p1}, Lfs/d;->e(ILandroid/content/Context;)I
    ...
    sget v1, Lvq/a$c;->actionBarPaddingEnd:I

    invoke-static {v1, v0}, Lfs/d;->e(ILandroid/content/Context;)I
    ...
    :cond_7
    new-instance p1, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/a;

    const/16 v0, 0x12

    invoke-direct {p1, p0, v0}, Lcom/miui/extravideoxmalgo/XiaomiAlgoVideoInterpolatorImp/a;-><init>(Ljava/lang/Object;I)V
...
.method public final onLayout(ZIIII)V
    ...
    :goto_8
    iget-object v0, v6, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;
    ...
    iget-object v3, v0, Ldr/a;->c:Lfr/b;

    invoke-virtual {v3}, Landroid/widget/TextView;->getPaint()Landroid/text/TextPaint;

    move-result-object v3

    iget v4, v0, Ldr/a;->h:F
    ...
    iput v3, v0, Ldr/a;->h:F

    const/4 v3, 0x1

    iput-boolean v3, v0, Ldr/a;->g:Z
    ...
    iput-boolean v7, v0, Ldr/a;->g:Z

    :cond_13
    :goto_9
    iget-boolean v3, v0, Ldr/a;->g:Z
    ...
    iput v2, v0, Ldr/a;->i:F

    const/4 v2, 0x0

    iput-boolean v2, v0, Ldr/a;->g:Z

    :cond_14
    iget-object v2, v0, Ldr/a;->c:Lfr/b;
    ...
    :goto_c
    sget v0, Lvq/a$c;->actionBarTitleEnableEllipsis:I

    iget-object v2, v6, Lmiuix/appcompat/internal/app/widget/ActionBarView;->o0:Landroid/content/Context;

    const/4 v3, 0x0

    invoke-static {v2, v0, v3}, Lfs/d;->c(Landroid/content/Context;IZ)Z
    ...
    invoke-static {v5, v0, v1, v3}, La0/z;->a(IIII)I
    ...
    invoke-static/range {v0 .. v5}, Lfs/f;->c(Landroid/view/ViewGroup;Landroid/view/View;IIII)V
...
.method public final onMeasure(II)V
    ...
    sget v2, Lvq/a$h;->miuix_appcompat_navigator_switch_presenter:I
    ...
    iget-object v11, v2, Lcr/b;->a:Landroid/view/View;

    iget v2, v2, Lcr/b;->b:I
    ...
    iget-object v11, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;
    ...
    iget-object v5, v11, Ldr/a;->c:Lfr/b;
    ...
    iget-object v5, v11, Ldr/a;->d:Lfr/c;
    ...
    iget-object v9, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->R0:Lnr/b;

    if-eqz v9, :cond_32

    iget-boolean v10, v9, Lnr/b;->a:Z

    if-eqz v10, :cond_32

    invoke-virtual {v9}, Lnr/b;->a()I
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/android/exoplayer2/analytics/c;-><init>(Ljava/lang/Object;I)V
...
.method public final s()V
    ...
    invoke-virtual {v0, v2}, Ldr/b;->c(I)V
    ...
    iget-object v2, v2, Ldr/b;->b:Landroid/widget/LinearLayout;
...
.method public setDisplayOptions(I)V
    ...
    :cond_e
    iget-object v9, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;

    if-eqz v9, :cond_f

    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->x0:Landroid/widget/FrameLayout;

    iget-object v9, v9, Ldr/a;->b:Landroid/widget/LinearLayout;

    invoke-virtual {v11, v9}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_f
    iget-object v9, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;

    if-eqz v9, :cond_10

    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->y0:Landroid/widget/FrameLayout;

    iget-object v9, v9, Ldr/b;->b:Landroid/widget/LinearLayout;

    invoke-virtual {v11, v9}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    :cond_10
    iput-object v5, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;

    iput-object v5, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;
    ...
    :goto_9
    iget-object v10, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;

    if-eqz v10, :cond_14

    iget-object v10, v10, Ldr/a;->b:Landroid/widget/LinearLayout;
    ...
    :goto_a
    iget-object v11, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->D0:Ldr/b;

    if-eqz v11, :cond_15

    iget-object v11, v11, Ldr/b;->b:Landroid/widget/LinearLayout;
    ...
    sget v1, Lvq/a$h;->miuix_appcompat_navigator_switch_presenter:I

    new-instance v2, Lcr/b;

    invoke-direct {v2, v0}, Lcr/b;-><init>(Landroid/view/View;)V
    ...
    sget v0, Lvq/a$k;->abc_action_bar_up_description:I
    ...
    sget v0, Lvq/a$k;->abc_action_bar_home_description:I
...
.method public setExtraPaddingPolicy(Lnr/b;)V
    .locals 0

    iput-object p1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->R0:Lnr/b;
...
.method public setSplitActionBar(Z)V
    ...
    sget v1, Lvq/a$d;->abc_action_bar_expanded_action_views_exclusive:I
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Ldr/a;->b(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, p1}, Ldr/b;->a(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p1, p0, v0}, Lff/a;-><init>(Ljava/lang/Object;I)V
...
.method public setTitleClickable(Z)V
    ...
    iget-object p0, p0, Ldr/b;->c:Lfr/c;
...
.method public final t()V
    ...
    sget v0, Lvq/a$h;->action_bar_collapse_tab_container:I
...
.method public final u()V
    ...
    sget v0, Lvq/a$h;->action_bar_movable_tab_container:I
...
.method public final v()V
    ...
    invoke-static {v5, v6}, Lpr/e;->b(Landroid/content/Context;F)I
    ...
    invoke-static {v4, v5}, Lfs/f;->d(ILmiuix/appcompat/internal/view/menu/action/b;)V
    ...
    invoke-static {v5, v6}, Lfs/f;->d(ILmiuix/appcompat/internal/view/menu/action/b;)V
    ...
    sget v1, Lvq/a$h;->expanded_menu:I
...
.method public final w()V
    ...
    iget-object v3, v0, Ldr/a;->b:Landroid/widget/LinearLayout;
    ...
    sget v7, Lvq/a$h;->action_bar_expand_container:I
    ...
    sget v3, Lvq/a$c;->actionBarTightTitle:I

    iget-object v4, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->o0:Landroid/content/Context;

    invoke-static {v4, v3, v6}, Lfs/d;->c(Landroid/content/Context;IZ)Z
...
.method public final z(Z)V
    ...
    invoke-direct {v1, v0}, Ldr/a;-><init>(Landroid/content/Context;)V
    ...
    sget v3, Lvq/a$f;->miuix_appcompat_subtitle_text_size:I
    ...
    iput v3, v1, Ldr/a;->f:F

    new-instance v3, Landroid/widget/LinearLayout;

    invoke-direct {v3, v0}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v3, v1, Ldr/a;->b:Landroid/widget/LinearLayout;
    ...
    sget v5, Lvq/a$c;->collapseTitleTheme:I

    invoke-direct {v3, v0, v5}, Lfr/b;-><init>(Landroid/content/Context;I)V

    iput-object v3, v1, Ldr/a;->c:Lfr/b;

    const/4 v5, 0x0

    invoke-virtual {v3, v5}, Landroid/view/View;->setVerticalScrollBarEnabled(Z)V

    iget-object v3, v1, Ldr/a;->c:Lfr/b;
    ...
    sget v3, Lvq/a$c;->actionBarTitleAdaptLargeFont:I

    const/4 v6, 0x1

    invoke-static {v0, v3, v6}, Lfs/d;->c(Landroid/content/Context;IZ)Z
    ...
    :goto_1
    iput-boolean v3, v1, Ldr/a;->k:Z

    if-eqz v3, :cond_2

    sget v3, Lvq/a$c;->collapseTitleLargeFontMaxLine:I

    invoke-static {v3, v0, v4}, Lfs/d;->h(ILandroid/content/Context;I)I

    move-result v3

    iput v3, v1, Ldr/a;->l:I
    ...
    iget v7, v1, Ldr/a;->l:I

    invoke-virtual {v3, v7}, Landroid/widget/TextView;->setMaxLines(I)V

    :cond_2
    sget v3, Lvq/a$c;->collapseSubtitleTheme:I

    new-instance v7, Lfr/c;

    invoke-direct {v7, v0, v3}, Lfr/c;-><init>(Landroid/content/Context;I)V

    iput-object v7, v1, Ldr/a;->d:Lfr/c;

    invoke-virtual {v7, v5}, Landroid/view/View;->setVerticalScrollBarEnabled(Z)V

    iget-object v0, v1, Ldr/a;->d:Lfr/c;

    invoke-virtual {v0, v5}, Landroid/view/View;->setHorizontalScrollBarEnabled(Z)V

    iget-object v0, v1, Ldr/a;->b:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v3, v1, v7}, Lfk/a;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v3}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    iget-object v0, v1, Ldr/a;->c:Lfr/b;

    sget v3, Lvq/a$h;->action_bar_title:I
    ...
    sget v3, Lvq/a$h;->action_bar_subtitle:I
    ...
    iget-object v7, v1, Ldr/a;->d:Lfr/c;
    ...
    iput-object v1, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->C0:Ldr/a;

    iget-boolean v0, v1, Ldr/a;->e:Z

    iget-boolean v2, p0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->h1:Z

    if-eq v0, v2, :cond_4

    iput-boolean v2, v1, Ldr/a;->e:Z
    ...
    iget-boolean v1, v0, Ldr/a;->j:Z

    if-eqz v1, :cond_5

    iget-object v1, v0, Ldr/a;->c:Lfr/b;

    invoke-virtual {v1, v5}, Lfr/c;->b(Z)V

    iput-boolean v5, v0, Ldr/a;->j:Z
    ...
    invoke-direct {v7, v0, v3}, Lhl/e;-><init>(Ljava/lang/Object;I)V
    ...
    :goto_3
    iget-object v2, v0, Ldr/a;->d:Lfr/c;
    ...
    iget-object v1, v0, Ldr/a;->d:Lfr/c;

    iget-object v0, v0, Ldr/a;->m:Ldr/a$a;
