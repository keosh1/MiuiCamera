...
.method public static constructor <clinit>()V
    ...
    sget v0, Lvq/a$j;->miuix_appcompat_popup_menu_item_layout:I
...
.method public final b()V
    ...
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lzs/f;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lzs/f;->setHorizontalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lzs/f;

    invoke-virtual {v0, v1}, Lzs/f;->setVerticalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lzs/f;

    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/g;->g:Landroid/view/View;

    invoke-virtual {v0, p0}, Lzs/f;->p(Landroid/view/View;)V
...
.method public e(Z)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lzs/f;
...
.method public final f()Z
    ...
    invoke-direct {v0, v1, v2}, Lzs/f;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lzs/f;

    const/16 v1, 0x51

    invoke-virtual {v0, v1}, Lzs/f;->c(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lzs/f;

    iput-object p0, v0, Lzs/f;->u:Landroid/widget/PopupWindow$OnDismissListener;

    iput-object p0, v0, Lzs/f;->x:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lzs/f;

    invoke-virtual {v2, v0}, Lzs/f;->setAdapter(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lzs/f;

    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Lzs/f;->setHorizontalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lzs/f;

    invoke-virtual {v0, v2}, Lzs/f;->setVerticalOffset(I)V
    ...
    invoke-virtual {v0, v2}, Lzs/f;->j(Landroid/view/View;)Z
    ...
    invoke-virtual {v0, v2}, Lzs/f;->showAsDropDown(Landroid/view/View;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/g;->d:Lzs/f;

    iget-object v0, v0, Lzs/f;->f:Landroid/widget/ListView;
