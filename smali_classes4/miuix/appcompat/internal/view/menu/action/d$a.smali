...
.method public constructor <init>(Lmiuix/appcompat/internal/view/menu/action/d;Landroid/content/Context;Lmiuix/appcompat/internal/view/menu/d;Landroid/view/View;Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;)V
    ...
    sget p3, Lvq/a$c;->overflowMenuMaxHeight:I

    invoke-static {p3, p2}, Lfs/d;->i(ILandroid/content/Context;)Landroid/util/TypedValue;
...
.method public final e(Z)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:Lkr/f;

    new-instance v0, Lgr/b;

    invoke-direct {v0, p0}, Lgr/b;-><init>(Lmiuix/appcompat/internal/view/menu/b;)V

    iput-object v0, p1, Lzs/f;->u:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {p1}, Lzs/f;->dismiss()V
