...
.method public constructor <init>(Lmiuix/appcompat/app/AppCompatActivity;Lmiuix/appcompat/app/AppCompatActivity$a;Lmiuix/appcompat/app/AppCompatActivity$b;)V
    ...
    iput-object p3, p0, Lmiuix/appcompat/app/j;->b0:Lxq/g;
...
# virtual methods
.method public final Ca()Lmiuix/appcompat/internal/app/widget/ActionBarImpl;
    .locals 2
...
.method public final m(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v2}, Lmiuix/appcompat/app/t;->e9()Z
...
.method public final o()V
    ...
    invoke-direct {v4, p0, p0}, Lmiuix/appcompat/app/j$a;-><init>(Lmiuix/appcompat/app/j;Ljt/a;)V

    iput-object v4, p0, Lmiuix/appcompat/app/j;->l0:Lmiuix/appcompat/app/j$a;

    :cond_5
    sget v4, Lvq/a$m;->Window_windowLayoutMode:I
    ...
    :cond_6
    sget v4, Lvq/a$m;->Window_windowActionBar:I
    ...
    :cond_7
    sget v4, Lvq/a$m;->Window_windowActionBarOverlay:I
    ...
    :cond_8
    sget v4, Lvq/a$m;->Window_isMiuixFloatingTheme:I
    ...
    sget v4, Lvq/a$m;->Window_windowFloating:I
    ...
    sget v4, Lvq/a$m;->Window_windowTranslucentStatus:I
    ...
    invoke-static {v1}, Lyq/b;->a(Lmiuix/appcompat/app/AppCompatActivity;)I
    ...
    new-instance v4, Lyq/e;

    invoke-direct {v4, v1}, Lyq/e;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V

    goto :goto_2

    :cond_9
    new-instance v4, Lyq/c;

    invoke-direct {v4, v1}, Lyq/c;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    invoke-direct {v4, v1}, Lyq/d;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    :goto_2
    iput-object v4, p0, Lmiuix/appcompat/app/j;->g0:Lyq/a;
    ...
    sget v7, Lvq/a$c;->windowActionBar:I

    invoke-static {v4, v7, v5}, Lfs/d;->c(Landroid/content/Context;IZ)Z

    move-result v8

    if-eqz v8, :cond_d

    sget v8, Lvq/a$c;->windowActionBarMovable:I

    invoke-static {v4, v8, v5}, Lfs/d;->c(Landroid/content/Context;IZ)Z

    move-result v8

    if-eqz v8, :cond_c

    sget v8, Lvq/a$j;->miuix_appcompat_screen_action_bar_movable:I

    goto :goto_3

    :cond_c
    sget v8, Lvq/a$j;->miuix_appcompat_screen_action_bar:I

    goto :goto_3

    :cond_d
    sget v8, Lvq/a$j;->miuix_appcompat_screen_simple:I

    :goto_3
    sget v9, Lvq/a$c;->startingWindowOverlay:I

    invoke-static {v9, v4}, Lfs/d;->b(ILandroid/content/Context;)I
    ...
    invoke-static {v4, v7, v0}, Lfs/d;->c(Landroid/content/Context;IZ)Z
    ...
    sget v7, Lvq/a$c;->windowTranslucentStatus:I

    invoke-static {v7, v4, v5}, Lfs/d;->h(ILandroid/content/Context;I)I

    move-result v4

    invoke-static {v2, v4}, Lqr/a;->a(Landroid/view/Window;I)Z
    ...
    iget-object v7, p0, Lmiuix/appcompat/app/j;->g0:Lyq/a;
    ...
    iget-object v8, p0, Lmiuix/appcompat/app/j;->g0:Lyq/a;

    invoke-virtual {v8, v7}, Lyq/a;->l(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/j;->g0:Lyq/a;

    iget-boolean v8, p0, Lmiuix/appcompat/app/j;->e0:Z

    invoke-virtual {v7, v4, v8}, Lyq/a;->j(Landroid/view/View;Z)Landroid/view/ViewGroup;
    ...
    sget v7, Lvq/a$h;->action_bar_overlay_layout:I
    ...
    iget-object v8, p0, Lmiuix/appcompat/app/c;->t:Lnr/b;

    invoke-virtual {v7, v8}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Lnr/b;)V
    ...
    invoke-virtual {v2, v4, v6}, Lyq/a;->f(Landroid/view/ViewGroup;Z)V
    ...
    invoke-virtual {v2, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->a(Lnr/a;)V
    ...
    sget v4, Lvq/a$h;->action_bar_container:I
    ...
    sget v6, Lvq/a$d;->abc_split_action_bar_is_narrow:I
    ...
    :cond_19
    sget v4, Lvq/a$m;->Window_windowSplitActionBar:I
    ...
    :cond_1a
    sget v0, Lvq/a$m;->Window_endActionMenuEnabled:I
    ...
    sget v0, Lvq/a$m;->Window_hyperActionMenuEnabled:I
...
.method public final p(Landroid/content/res/Configuration;)V
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/AppCompatActivity;->a:Lpr/h;
    ...
    iget-object v1, p0, Lmiuix/appcompat/app/c;->t:Lnr/b;

    invoke-virtual {v0, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(Lnr/b;)V
    ...
    invoke-static {p0, p1}, Lmiuix/appcompat/app/AppCompatActivity;->hi(Lmiuix/appcompat/app/AppCompatActivity;Landroid/content/res/Configuration;)V
...
.method public final q(ILandroid/view/MenuItem;)Z
    ...
    invoke-static {v0, p1, p2}, Lmiuix/appcompat/app/AppCompatActivity;->ni(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/MenuItem;)Z
...
.method public final s()V
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AppCompatActivity;->mi(Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final u(Z)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/c;->t:Lnr/b;
...
.method public final w(Z)V
    ...
    invoke-static {v0}, Landroidx/core/text/util/d;->b(Landroid/view/Window;)V

    goto :goto_4

    :cond_5
    invoke-static {v0}, La0/v6;->e(Landroid/view/Window;)V
