...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 8
    sget v0, Lat/p;->stretchablePickerPreferenceStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Lmiuix/preference/StretchablePickerPreference;->n:Lrs/a;
    ...
    .line 5
    sget-object v0, Lat/x;->StretchablePickerPreference:[I
    ...
    .line 6
    sget p2, Lat/x;->StretchablePickerPreference_show_lunar:I
...
.method public final i(JZ)V
    ...
    iget-object p3, p0, Lmiuix/preference/StretchablePickerPreference;->n:Lrs/a;

    const/4 v1, 0x1

    invoke-virtual {p3, v1}, Lrs/a;->x(I)I

    move-result v1

    const/4 v2, 0x5

    invoke-virtual {p3, v2}, Lrs/a;->x(I)I

    move-result v2

    const/16 v3, 0x9

    invoke-virtual {p3, v3}, Lrs/a;->x(I)I
    ...
    invoke-static {v0, v1, p1, p2}, Lrs/c;->a(Landroid/content/Context;IJ)Ljava/lang/String;

    move-result-object p1

    const-string p2, " "

    invoke-static {p3, p2, p1}, La0/u3;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, p3, p1, p2}, Lrs/c;->a(Landroid/content/Context;IJ)Ljava/lang/String;
...
.method public final onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    sget v2, Lat/t;->datetime_picker:I
    ...
    new-instance v4, Lat/a0;

    invoke-direct {v4, p0, v3, v2}, Lat/a0;-><init>(Lmiuix/preference/StretchablePickerPreference;Lmiuix/slidingwidget/widget/SlidingButton;Lmiuix/pickerwidget/widget/DateTimePicker;)V
    ...
    new-instance p1, Lat/c0;

    invoke-direct {p1, p0, v2}, Lat/c0;-><init>(Lmiuix/preference/StretchablePickerPreference;Lmiuix/pickerwidget/widget/DateTimePicker;)V
    ...
    new-instance p1, Lat/b0;

    invoke-direct {p1, p0}, Lat/b0;-><init>(Lmiuix/preference/StretchablePickerPreference;)V
