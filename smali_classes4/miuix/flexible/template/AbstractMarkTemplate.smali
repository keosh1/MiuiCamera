...
.method public static synthetic a(Lmiuix/flexible/template/AbstractMarkTemplate;Lur/d;Lur/d;)I
    .locals 0

    invoke-direct {p0, p1, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->lambda$measureViewList$0(Lur/d;Lur/d;)I
...
.method private synthetic lambda$measureViewList$0(Lur/d;Lur/d;)I
    .locals 0

    invoke-virtual {p0, p1}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(Lur/d;)I

    move-result p1

    invoke-virtual {p0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(Lur/d;)I
...
.method private layoutViewList(Lur/c;ZIII)V
    .locals 17
    ...
    iget v0, v9, Lur/d;->c:I

    add-int v0, p4, v0

    iget v1, v9, Lur/d;->d:I

    add-int v1, p5, v1

    new-instance v2, Ljava/util/ArrayList;

    iget-object v3, v9, Lur/c;->g:Ljava/util/ArrayList;
    ...
    iget-object v7, v6, Lur/d;->b:Landroid/view/View;
    ...
    check-cast v15, Lur/c;

    iget-object v0, v15, Lur/c;->g:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lur/d;->b:Landroid/view/View;
    ...
    iget v0, v9, Lur/d;->d:I

    iget v1, v15, Lur/d;->d:I

    const/4 v2, 0x2

    invoke-static {v0, v1, v2, v7}, La0/z;->a(IIII)I
    ...
    iget v1, v15, Lur/d;->c:I

    const/4 v2, 0x2

    invoke-static {v0, v1, v2, v6}, La0/z;->a(IIII)I
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(Lur/c;ZIII)V

    iget v0, v9, Lur/c;->f:I

    if-ne v0, v14, :cond_7

    iget v0, v15, Lur/d;->c:I
    ...
    :cond_8
    iget-object v1, v0, Lur/d;->b:Landroid/view/View;
    ...
    iget v2, v9, Lur/d;->d:I

    iget v0, v0, Lur/d;->d:I

    const/4 v5, 0x2

    invoke-static {v2, v0, v5, v7}, La0/z;->a(IIII)I
    ...
    iget v2, v9, Lur/d;->c:I

    iget v0, v0, Lur/d;->c:I

    const/4 v4, 0x2

    invoke-static {v2, v0, v4, v6}, La0/z;->a(IIII)I
...
.method private measureChildView(Lur/d;IIII)V
    .locals 7

    iget-object v0, p1, Lur/d;->b:Landroid/view/View;
    ...
    iput p2, p1, Lur/d;->c:I

    iput p3, p1, Lur/d;->d:I

    :cond_8
    return-void
.end method

.method private measureViewList(Lur/c;Lur/c;IIII)V
    .locals 19
    ...
    iget-object v1, v9, Lur/c;->g:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(Lur/c;Lur/c;IIII)V

    iget v0, v9, Lur/c;->f:I

    if-ne v0, v13, :cond_3

    iget v0, v12, Lur/d;->c:I
    ...
    iget-object v0, v4, Lur/d;->b:Landroid/view/View;
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureChildView(Lur/d;IIII)V

    iget v0, v9, Lur/c;->f:I

    if-ne v0, v13, :cond_5

    iget v0, v6, Lur/d;->c:I
    ...
    :cond_b
    iget-object v0, v5, Lur/d;->b:Landroid/view/View;
    ...
    :cond_14
    iput v15, v9, Lur/d;->d:I

    iget-object v0, v9, Lur/c;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, v2, v10}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lur/c;I)Z

    move-result v0

    if-eqz v0, :cond_16

    iget v3, v2, Lur/d;->c:I

    iget v4, v9, Lur/d;->d:I
    ...
    iget v0, v2, Lur/d;->c:I

    iget v1, v9, Lur/d;->c:I

    if-ge v0, v1, :cond_15

    invoke-virtual {v7, v2, v13}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lur/c;I)Z

    move-result v0

    if-eqz v0, :cond_15

    iget v3, v9, Lur/d;->c:I

    iget v4, v2, Lur/d;->d:I
    ...
    iget-object v0, v1, Lur/d;->b:Landroid/view/View;
    ...
    iget v2, v9, Lur/c;->f:I

    if-ne v2, v13, :cond_19

    iget v2, v1, Lur/d;->d:I

    iget v4, v9, Lur/d;->d:I

    if-ge v2, v4, :cond_19

    iget v2, v1, Lur/d;->c:I
    ...
    iget v0, v1, Lur/d;->c:I

    iget v2, v9, Lur/d;->c:I

    if-ge v0, v2, :cond_15

    iget v3, v1, Lur/d;->d:I
...
.method public buildViewTree(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p1, p0}, Lur/a;-><init>(Lur/b$a;)V

    invoke-static {v1, p1}, Ljava/util/Arrays;->sort([Ljava/lang/Object;Ljava/util/Comparator;)V

    new-instance p1, Lur/c;

    invoke-direct {p1}, Lur/c;-><init>()V

    const/4 v0, 0x1

    iput v0, p1, Lur/d;->a:I

    const/high16 v3, 0x3f800000    # 1.0f

    iput v3, p1, Lur/d;->e:F

    iput v0, p1, Lur/c;->f:I

    invoke-static {v1, v2, p1, p0}, Lur/b;->a([Landroid/view/View;ILur/c;Lur/b$a;)I

    iput-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lur/c;
...
.method public getViewNodePriority(Lur/d;)I
    .locals 2
    ...
    iget-object p1, p1, Lur/c;->g:Ljava/util/ArrayList;
...
.method public hasMatchParentChild(Lur/c;I)Z
    .locals 4
    ...
    invoke-virtual {p0, v0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(Lur/c;I)Z
...
.method public init(Landroid/view/ViewGroup;Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p1, Ltr/c;->HyperCellLayout:[I
    ...
    sget v2, Ltr/c;->HyperCellLayout_android_gravity:I
    ...
    :cond_0
    sget v2, Ltr/c;->HyperCellLayout_column_spacing:I
    ...
    :cond_1
    sget v2, Ltr/c;->HyperCellLayout_row_spacing:I
...
.method public onLayout(Landroid/view/ViewGroup;ZIIII)V
    ...
    iget-object p2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lur/c;
    ...
    iget-object p5, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lur/c;

    iget p5, p5, Lur/d;->d:I

    const/4 v1, 0x2

    invoke-static {p6, p5, v1, p3}, La0/z;->a(IIII)I
    ...
    iget-object p3, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lur/c;

    iget p3, p3, Lur/d;->d:I
    ...
    iget-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lur/c;

    iget p1, p1, Lur/d;->c:I

    const/4 p4, 0x2

    invoke-static {p3, p1, p4, p2}, La0/z;->a(IIII)I
    ...
    :goto_2
    iget-object v2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lur/c;

    move-object v1, p0

    invoke-direct/range {v1 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(Lur/c;ZIII)V
...
.method public onMeasure(Landroid/view/ViewGroup;II)[I
    ...
    iget-object v4, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lur/c;
    ...
    invoke-direct/range {v2 .. v8}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(Lur/c;Lur/c;IIII)V
    ...
    :cond_1
    iget-object p0, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:Lur/c;

    iget p0, p0, Lur/d;->d:I
