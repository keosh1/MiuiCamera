...
# direct methods
.method public static final collectRecursively(Ldq/i;Lokio/FileSystem;Lmp/g;Lokio/Path;ZZLpp/d;)Ljava/lang/Object;
    .locals 17
    ...
    invoke-direct {v4, v3}, Lokio/internal/_FileSystemKt$collectRecursively$1;-><init>(Lpp/d;)V

    :goto_0
    iget-object v3, v4, Lokio/internal/_FileSystemKt$collectRecursively$1;->result:Ljava/lang/Object;

    sget-object v5, Lqp/a;->a:Lqp/a;
    ...
    invoke-static {v3}, Lal/a;->v(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v4}, Ldq/i;->a(Ljava/lang/Object;Lpp/d;)V
    ...
    invoke-virtual {v6, v13}, Lmp/g;->contains(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-virtual {v6, v13}, Lmp/g;->addLast(Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p6}, Lokio/internal/_FileSystemKt;->collectRecursively(Ldq/i;Lokio/FileSystem;Lmp/g;Lokio/Path;ZZLpp/d;)Ljava/lang/Object;
    ...
    :cond_c
    invoke-virtual {v11}, Lmp/g;->removeLast()Ljava/lang/Object;
    ...
    :goto_7
    invoke-virtual {v6}, Lmp/g;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v12, v1, v4}, Ldq/i;->a(Ljava/lang/Object;Lpp/d;)V
...
.method public static final commonCopy(Lokio/FileSystem;Lokio/Path;Lokio/Path;)V
    ...
    :cond_0
    :try_start_3
    invoke-static {p2, p0}, Llq/h;->b(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    :cond_3
    invoke-static {v0, p1}, Llq/h;->b(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final commonCreateDirectories(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-virtual {v0, v1}, Lmp/g;->addFirst(Ljava/lang/Object;)V
...
.method public static final commonDeleteRecursively(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/_FileSystemKt$commonDeleteRecursively$sequence$1;-><init>(Lokio/FileSystem;Lokio/Path;Lpp/d;)V

    new-instance p1, Ldq/h;

    invoke-direct {p1}, Ldq/h;-><init>()V

    invoke-static {p1, p1, v0}, Lqo/y0;->g(Ljava/lang/Object;Lpp/d;Lxp/p;)Lpp/d;

    move-result-object v0

    iput-object v0, p1, Ldq/h;->d:Lpp/d;

    :goto_0
    invoke-virtual {p1}, Ldq/h;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Ldq/h;->next()Ljava/lang/Object;
...
.method public static final commonListRecursively(Lokio/FileSystem;Lokio/Path;Z)Ldq/g;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/_FileSystemKt$commonListRecursively$1;-><init>(Lokio/Path;Lokio/FileSystem;ZLpp/d;)V
