...
.method private static final buildIndex(Ljava/util/List;)Ljava/util/Map;
    ...
    new-instance v4, Llp/e;

    invoke-direct {v4, v0, v3}, Llp/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v2}, Lmp/s;->P(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Lxp/l;)Lokio/ZipFileSystem;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v9, Llp/k;->a:Llp/k;
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0

    :try_start_5
    invoke-static {v5, v11}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    :try_start_8
    invoke-static {v5, v1}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :try_start_9
    invoke-static {v3, v11}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_9
    ...
    :try_start_b
    invoke-static {v3, v1}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v2, v6}, Lxp/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v4, v11}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v1}, La0/j5;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    throw v2
.end method

.method public static synthetic openZip$default(Lokio/Path;Lokio/FileSystem;Lxp/l;ILjava/lang/Object;)Lokio/ZipFileSystem;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lokio/internal/ZipKt;->openZip(Lokio/Path;Lokio/FileSystem;Lxp/l;)Lokio/ZipFileSystem;
...
.method public static final readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    ...
    invoke-static {v2, v3}, Leq/m;->R(Ljava/lang/CharSequence;C)Z
    ...
    invoke-static {v8, v15, v13}, Lokio/internal/ZipKt;->readExtra(Lokio/BufferedSource;ILxp/p;)V
    ...
    invoke-static {v9, v1, v4}, Leq/i;->H(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private static final readExtra(Lokio/BufferedSource;ILxp/p;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, v8, v9}, Lxp/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final readOrSkipLocalHeader(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    ...
    invoke-static {v0, v5, v2}, Lokio/internal/ZipKt;->readExtra(Lokio/BufferedSource;ILxp/p;)V
