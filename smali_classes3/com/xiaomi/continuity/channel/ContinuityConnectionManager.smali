...
.field private mService:Lok/f;


# direct methods
.method private constructor <init>(Lok/f;Landroid/content/Context;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lok/f;
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lok/b;)V

    return-void
.end method

.method public static synthetic access$002(Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;Lok/f;)Lok/f;
    .locals 0
...
.method private checkApiFeatureStatusChanged()Z
    ...
    invoke-static {p0, v0}, Llq/h;->l(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;
    ...
    invoke-static {p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getSystemService(Landroid/content/Context;)Lok/f;
    ...
    invoke-direct {v2, v1, p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;-><init>(Lok/f;Landroid/content/Context;)V
...
.method private declared-synchronized getService()Lok/f;
    .locals 3

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lok/f;
    ...
    invoke-static {v0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getSystemService(Landroid/content/Context;)Lok/f;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lok/f;
    ...
    invoke-static {v1, v2, v0}, Lrk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static getSystemService(Landroid/content/Context;)Lok/f;
    .locals 9

    invoke-static {p0}, Lok/d;->a(Landroid/content/Context;)Lok/d;
    ...
    :try_start_0
    iget-object v5, p0, Lok/d;->b:Lok/e;

    new-instance v6, Lok/c;

    invoke-direct {v6}, Lok/c;-><init>()V

    invoke-virtual {v5, v6}, Lpk/e;->l(Lok/c;)Lpk/e$a;
    ...
    iget-object v5, p0, Lok/d;->d:Ljava/util/ArrayList;

    monitor-enter v5

    :try_start_1
    iget-object v3, p0, Lok/d;->d:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lok/d;->d:Ljava/util/ArrayList;
    ...
    :cond_3
    new-instance p0, Lok/f$a$a;

    invoke-direct {p0, v4}, Lok/f$a$a;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-static {v0, v1, p0}, Lrk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
# virtual methods
.method public addServiceListener(Lok/b;)V
    .locals 0
    ...
    iget-object p0, p0, Lok/d;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public confirmChannel(IILcom/xiaomi/continuity/channel/ChannelConfirmOptions;)I
    ...
    invoke-direct {p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getService()Lok/f;
    ...
    invoke-interface {v0, p1, p2, p3}, Lok/f;->Z(IILcom/xiaomi/continuity/channel/ChannelConfirmOptions;)V
    ...
    invoke-interface {v0, p1, p2, p0}, Lok/f;->O(IILjava/lang/String;)V

    goto :goto_0

    :cond_1
    invoke-interface {v0, p1, p2}, Lok/f;->L(II)V
    ...
    invoke-static {v1, p0, p1}, Lrk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-static {p2, v1, p0, p3, p1}, Lrk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public createChannel(Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p5}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lok/b;)V
    ...
    invoke-interface/range {v1 .. v6}, Lok/f;->s(Ljava/lang/String;Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$c;)I
    ...
    invoke-interface/range {v1 .. v6}, Lok/f;->y(Ljava/lang/String;Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptions;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$c;)I
    ...
    .line 3
    invoke-static {v0, p3, p1, p4, p2}, Lrk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 4
    invoke-virtual {p0, p5}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lok/b;)V
...
.method public createChannel(Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    invoke-interface/range {v1 .. v6}, Lok/f;->a(Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$b;)I
    ...
    invoke-interface/range {v1 .. v6}, Lok/f;->D(Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptions;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$b;)I
...
.method public destroyChannel(I)I
    ...
    :try_start_0
    invoke-interface {p0, p1}, Lok/f;->C(I)V
    ...
    invoke-static {v2, p0, p1}, Lrk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, v2, p0, v3, p1}, Lrk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public getApiFeature()Ljava/lang/String;
    ...
    :try_start_0
    invoke-interface {v0}, Lok/f;->g()Ljava/lang/String;
...
.method public getChannelInfoExt(II)Landroid/os/Bundle;
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Lok/f;->V(II)Landroid/os/Bundle;
    ...
    invoke-static {p2, v0, p0, v1, p1}, Lrk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerConnected(Lcom/xiaomi/continuity/ServiceName;I)V
    ...
    invoke-static {p0, v3}, Llq/h;->l(Ljava/lang/String;Ljava/lang/String;)Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-interface {v0, p1, p2}, Lok/f;->j(Lcom/xiaomi/continuity/ServiceName;I)V
    ...
    invoke-static {p2, v2, p0, v0, p1}, Lrk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerCreateFailed(I)V
    ...
    :try_start_0
    invoke-interface {p0, p1, v1}, Lok/f;->T(II)V
    ...
    invoke-static {v0, p0, p1}, Lrk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, v0, p0, v2, p1}, Lrk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerCreated(II)V
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Lok/f;->T(II)V
    ...
    invoke-static {v2, p2}, La0/t3;->e(Ljava/lang/String;I)Ljava/lang/String;

    move-result-object p2

    new-array v1, v1, [Ljava/lang/Object;

    invoke-static {v0, p2, v1}, Lrk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public registerChannelListener(Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ServerChannelOptions;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lok/b;)V
    ...
    invoke-interface {v0, p3, p1, p2, v1}, Lok/f;->J(Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ServerChannelOptions;Lcom/xiaomi/continuity/channel/a;)I
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lok/b;)V
    ...
    invoke-static {p4, p2, p0, p3, p1}, Lrk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public removeServiceListener(Lok/b;)V
    .locals 0
...
.method public send(I[BLandroid/os/Bundle;Lcom/xiaomi/continuity/channel/SendResultCallback;Ljava/util/concurrent/Executor;)I
    ...
    invoke-interface {p0, p1, p2, p3, v3}, Lok/f;->t(I[BLandroid/os/Bundle;Lcom/xiaomi/continuity/channel/e;)I
    ...
    invoke-static {p2, v2, p0, p3, p1}, Lrk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public unbindService()V
    ...
    invoke-static {v1, v2, v0}, Lrk/a;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lok/d;->a(Landroid/content/Context;)Lok/d;

    move-result-object v0

    const-string v1, "continuity_connection"

    iget-object v2, v0, Lok/d;->d:Ljava/util/ArrayList;

    monitor-enter v2

    :try_start_0
    iget-object v3, v0, Lok/d;->d:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v1, v0, Lok/d;->d:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lok/d;->b:Lok/e;

    iput-boolean v3, v0, Lpk/e;->n:Z

    iget-object v1, v0, Lpk/e;->i:Landroid/os/Handler;

    new-instance v4, Lfk/a;

    invoke-direct {v4, v0, v3}, Lfk/a;-><init>(Ljava/lang/Object;I)V
...
.method public unregisterChannelListener(Lcom/xiaomi/continuity/ServiceName;)I
    ...
    invoke-virtual {p0, v3}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lok/b;)V
    ...
    invoke-interface {p0, p1}, Lok/f;->d0(Lcom/xiaomi/continuity/ServiceName;)I
    ...
    invoke-static {p0, p1, v3}, Lrk/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v3, v1, p0, v2, p1}, Lrk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
