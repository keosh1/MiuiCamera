...
.method private execute(Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getParallelTaskData()Lwg/q;
    ...
    invoke-static {v8, v9, v7}, La0/z;->d(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v8, v10}, Ldg/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v9, v2, Lwg/q;->q:Lwg/r;

    iget-boolean v9, v9, Lwg/r;->y:Z
    ...
    iget-object v10, v2, Lwg/q;->q:Lwg/r;

    iget-boolean v10, v10, Lwg/r;->V:Z

    if-eqz v10, :cond_6

    const-string v10, "process[3]: setOrientation "

    invoke-static {v1, v10}, La0/x;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v12, v2, Lwg/q;->q:Lwg/r;

    iget v12, v12, Lwg/r;->v:I
