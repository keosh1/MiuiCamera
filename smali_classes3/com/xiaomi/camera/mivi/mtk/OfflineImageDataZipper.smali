...
.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lwg/q;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lwg/q;)V
...
.method private doJpeg(Lwg/q;Landroid/media/Image;I)V
    .locals 9
    ...
    invoke-static {v1, v2, p3}, La0/z;->d(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(Lwg/q;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
...
.method private generateReprocessData(Lwg/q;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 18
    ...
    iget-object v13, v1, Lwg/q;->q:Lwg/r;

    iget-object v2, v1, Lwg/q;->h:Landroid/hardware/camera2/TotalCaptureResult;

    iget-boolean v5, v1, Lwg/q;->g0:Z
    ...
    invoke-static {v2, v4}, Ldg/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    iget-boolean v8, v13, Lwg/r;->B:Z

    iget-object v2, v13, Lwg/r;->D:Landroid/util/Size;
    ...
    iget-object v4, v1, Lwg/q;->K:Landroid/media/Image;
    ...
    :cond_1
    iget-boolean v2, v13, Lwg/r;->V:Z

    if-eqz v2, :cond_2

    iget v2, v13, Lwg/r;->v:I

    invoke-virtual {v14, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setOrientation(I)V

    :cond_2
    iget-byte v2, v13, Lwg/r;->W:B

    invoke-virtual {v14, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setSiqeType(B)V

    iget-object v2, v13, Lwg/r;->i:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v13, Lwg/r;->i:Landroid/util/Size;
...
.method private handTimeoutTask(J)V
    ...
    invoke-static {v1, p1, p2, v2}, La0/v3;->e(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p2, v0}, Lm7/k;->d(Ljava/lang/String;)J

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;->getTimestamp()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Lwg/q;
    ...
    :cond_1
    iget-wide v0, p2, Lwg/q;->a0:J

    iget-object v3, p2, Lwg/q;->V:Ljava/lang/String;

    iget-wide v4, p2, Lwg/q;->e:J
    ...
    invoke-virtual {p2, v1, v0}, Lwg/q;->a(I[B)V
    ...
    invoke-static {v1, v3, v4}, La0/z;->d(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-object v0, p2, Lwg/q;->K:Landroid/media/Image;
    ...
    iget-object v1, p2, Lwg/q;->q:Lwg/r;

    iget-boolean v1, v1, Lwg/r;->a:Z
    ...
    invoke-direct {p0, v1, p2, v0}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;Lwg/q;I)V
    ...
    invoke-direct {p0, p2, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(Lwg/q;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2, p1}, Lwg/q;->a(I[B)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(Lwg/q;Ljava/lang/String;)V
...
.method private static synthetic lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lwg/q;)V
    .locals 0

    invoke-virtual {p2}, Lwg/q;->c()I
...
.method private postCvWaterMark(Landroid/media/Image;Lwg/q;I)V
    .locals 4
    ...
    invoke-static {p1, v2}, Ldg/e;->g(Landroid/media/Image;Z)[B

    move-result-object v2

    const-string v3, ""

    invoke-static {p3, v3}, La0/v3;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, La0/z;->d(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public getParallelTaskData(J)Lwg/q;
    .locals 3
...
.method public getParallelTaskSize()Ljava/lang/String;
    ...
    invoke-direct {v3, v0}, Lcom/xiaomi/camera/mivi/mtk/d;-><init>(Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public putParallelTaskData(JLwg/q;)V
    .locals 5
