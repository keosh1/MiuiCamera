...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpk/b;->e:Landroidx/profileinstaller/b;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lpk/b;->e:Landroidx/profileinstaller/b;

    iput-object v0, p0, Lpk/b;->c:Ljava/util/concurrent/Executor;

    sget-object v0, Lpk/b;->f:Landroid/os/Handler;
    ...
    sput-object v0, Lpk/b;->f:Landroid/os/Handler;

    :cond_0
    sget-object v0, Lpk/b;->f:Landroid/os/Handler;

    iput-object v0, p0, Lpk/b;->d:Landroid/os/Handler;
...
.method public static b(Ljava/util/function/BiConsumer;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-static {p2, p1}, La0/x;->d(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, p0, p1, p2}, Lrk/a;->d(ILjava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public c(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lpk/b;->d:Landroid/os/Handler;
    ...
    :try_start_0
    iget-object v1, p0, Lpk/b;->b:Ljava/util/function/BiConsumer;

    const/4 v2, 0x0

    iput-object v2, p0, Lpk/b;->b:Ljava/util/function/BiConsumer;
    ...
    iget-object p0, p0, Lpk/b;->c:Ljava/util/concurrent/Executor;

    sget-object v0, Lpk/b;->e:Landroidx/profileinstaller/b;

    if-ne p0, v0, :cond_0

    invoke-static {v1, p1, p2}, Lpk/b;->b(Ljava/util/function/BiConsumer;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v1, p1, p2, v2}, Ltg/d;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/io/Serializable;I)V
...
.method public cancel(Z)Z
    ...
    invoke-virtual {p0, v1, v0}, Lpk/b;->c(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final complete(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, v1}, Lpk/b;->c(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final completeExceptionally(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p0, v1, p1}, Lpk/b;->c(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final e(Ljava/util/function/Function;)Lpk/b$a;
    .locals 2
    ...
    invoke-direct {v1, p0, p1, v0}, Lpk/b$a;-><init>(Lpk/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V

    return-object v1
.end method

.method public final f(Ljava/util/function/Function;)Lpk/b$c;
    .locals 2

    sget-object v0, Lpk/b;->e:Landroidx/profileinstaller/b;

    new-instance v1, Lpk/b$c;

    invoke-direct {v1, p0, p1, v0}, Lpk/b$c;-><init>(Lpk/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V
...
.method public final g(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)V
    ...
    iget-object v2, p0, Lpk/b;->c:Ljava/util/concurrent/Executor;
    ...
    :cond_0
    iput-object p2, p0, Lpk/b;->c:Ljava/util/concurrent/Executor;
    ...
    invoke-direct {p2, v1, p1}, Lpk/a;-><init>(Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)V

    move-object p1, p2

    :goto_0
    iput-object p1, p0, Lpk/b;->b:Ljava/util/function/BiConsumer;
    ...
    sget-object v1, Lpk/b;->e:Landroidx/profileinstaller/b;

    if-ne p0, v1, :cond_3

    invoke-static {p1, p2, v0}, Lpk/b;->b(Ljava/util/function/BiConsumer;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, p1, p2, v0, v2}, Ltg/d;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/io/Serializable;I)V
...
.method public bridge synthetic orTimeout(JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lpk/b;->d(JLjava/util/concurrent/TimeUnit;)V
...
.method public bridge synthetic thenApply(Ljava/util/function/Function;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1}, Lpk/b;->e(Ljava/util/function/Function;)Lpk/b$a;
...
.method public thenApplyAsync(Ljava/util/function/Function;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v0, p0, p1, p2}, Lpk/b$a;-><init>(Lpk/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V
...
.method public thenCombine(Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v0, p0, p1, p2}, Lpk/b$b;-><init>(Ljava/util/concurrent/CompletableFuture;Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)V
...
.method public bridge synthetic thenCompose(Ljava/util/function/Function;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1}, Lpk/b;->f(Ljava/util/function/Function;)Lpk/b$c;
...
.method public thenComposeAsync(Ljava/util/function/Function;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v0, p0, p1, p2}, Lpk/b$c;-><init>(Lpk/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V
...
.method public whenComplete(Ljava/util/function/BiConsumer;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1, v0}, Lpk/b;->g(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)V
...
.method public bridge synthetic whenCompleteAsync(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1, p2}, Lpk/b;->g(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)V
