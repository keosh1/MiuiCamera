...
# direct methods
.method public constructor <init>(Lij/l;)V
    .locals 0

    iput-object p1, p0, Lij/n;->a:Lij/l;
...
.method public final a(Ljava/nio/ByteBuffer;Llj/c;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object p0, p0, Lij/n;->a:Lij/l;

    iget-object v0, p0, Lij/l;->i:Llj/h;

    if-ne p2, v0, :cond_0

    invoke-virtual {p0}, Lij/l;->c()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object p2, p0, Lij/l;->g:Landroid/media/MediaMuxer;

    iget v0, p0, Lij/l;->k:I

    invoke-virtual {p0, p2, v0, p1, p3}, Lij/l;->f(Landroid/media/MediaMuxer;ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object p3, p0, Lij/l;->g:Landroid/media/MediaMuxer;

    iget v0, p0, Lij/l;->m:I

    invoke-virtual {p0, p3, v0, p1, p2}, Lij/l;->f(Landroid/media/MediaMuxer;ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lij/l;->j:Llj/h;
...
.method public final d(Landroid/media/MediaFormat;Llj/c;)V
    ...
    iget-object v0, p0, Lij/n;->a:Lij/l;

    iget-object v1, v0, Lij/l;->i:Llj/h;
    ...
    iget-object v4, v0, Lij/b;->e:Lij/p;

    iget-boolean v5, v4, Lij/p;->u:Z

    iget-boolean v0, v0, Lij/l;->w:Z

    iget-boolean v4, v4, Lij/p;->v:Z
    ...
    iget-object v1, p0, Lij/n;->a:Lij/l;

    iget v1, v1, Lij/l;->k:I
    ...
    :cond_4
    iget-object v0, v0, Lij/l;->j:Llj/h;
    ...
    invoke-virtual {p0, p2}, Lij/b;->a(I)V

    :goto_2
    iget-object p0, p0, Lij/l;->z:Ljava/lang/Object;
    ...
    iget-object p2, p0, Lij/l;->z:Ljava/lang/Object;
