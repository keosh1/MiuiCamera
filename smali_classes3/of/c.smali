...
.method public constructor <init>(Lnf/a;)V
    ...
    invoke-direct {p0, p1}, Lmf/h;-><init>(Lnf/a;)V
    ...
    iget-object v0, p0, Lmf/h;->a:Lnf/e;
    ...
    iput-object p1, p0, Lof/c;->f:Lokhttp3/OkHttpClient;

    iget-object p1, p0, Lmf/h;->a:Lnf/e;
    ...
    invoke-virtual {p1, v3}, Lmf/g;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v5, Luf/a;->a:Lnb/t;

    invoke-virtual {v5, v4}, Lnb/t;->p(Ljava/lang/String;)Lnb/l;
    ...
    invoke-virtual {v4, v1}, Lzb/r;->z(Ljava/lang/String;)Lnb/l;

    move-result-object v1

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lnb/l;->w()Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-virtual {v1}, Lnb/l;->g()I
    ...
    :cond_1
    invoke-virtual {p1, v3}, Lmf/g;->b(Ljava/lang/String;)V
    :try_end_0
...
.method public final e(Ljava/lang/String;)Z
    ...
    iget-object v1, v0, Lnf/e;->l:Landroid/content/Context;
    ...
    iget v1, p0, Lof/c;->e:I

    iget-object v2, v0, Lnf/e;->b:Lwf/a;

    const-string v5, "track.max_track_times"

    invoke-virtual {v2, v5, v4}, Lwf/a;->c(Ljava/lang/String;I)I
    ...
    iget-object p1, v0, Lnf/e;->b:Lwf/a;

    invoke-virtual {p1, v5, v4}, Lwf/a;->c(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v5, v4}, Lwf/a;->c(Ljava/lang/String;I)I
    ...
    iget-object v1, p0, Lof/c;->f:Lokhttp3/OkHttpClient;
    ...
    invoke-direct {v1, p0, p1}, Lof/c$a;-><init>(Lof/c;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p1, v1}, Lmf/h;->c(Ljava/lang/String;Ljava/lang/String;Lzb/a;)Z

    move-result p1

    if-eqz p1, :cond_5

    iput-boolean v2, p0, Lmf/h;->d:Z
