...
.method public constructor <init>(Lbi/f;)V
    ...
    iput-object p1, p0, Lbi/f$a;->c:Lbi/f;

    invoke-direct {p0, p1}, Lbi/d$d;-><init>(Lbi/d;)V
...
.method public final onOutputFormatChanged(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)V
    ...
    iget-object p0, p0, Lbi/f$a;->c:Lbi/f;
    ...
    iget-boolean p1, p0, Lbi/i$c;->a:Z
    ...
    :cond_2
    iget-object p1, p0, Lbi/i$c;->b:Lbi/i;

    iget-object v0, p1, Lbi/i;->k:[I
    ...
    :catch_0
    iput p0, p1, Lbi/i;->c:I

    :goto_0
    iget v0, p1, Lbi/i;->e:I

    new-array v0, v0, [I

    iput-object v0, p1, Lbi/i;->k:[I

    iget v0, p1, Lbi/i;->d:I
    ...
    invoke-static {v1, v0, v2}, La0/y;->h(Ljava/lang/String;ILjava/lang/String;)V

    iget-object v1, p1, Lbi/i;->h:Landroid/media/MediaMuxer;
    ...
    :goto_1
    iget-object v2, p1, Lbi/i;->k:[I

    array-length v2, v2

    if-ge v1, v2, :cond_6

    iget v2, p1, Lbi/i;->f:I
    ...
    iget-object v3, p1, Lbi/i;->h:Landroid/media/MediaMuxer;
    ...
    :cond_6
    iget-object p2, p1, Lbi/i;->h:Landroid/media/MediaMuxer;

    invoke-virtual {p2}, Landroid/media/MediaMuxer;->start()V

    iget-object p2, p1, Lbi/i;->j:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {p2, p0}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    invoke-virtual {p1}, Lbi/i;->d()V
