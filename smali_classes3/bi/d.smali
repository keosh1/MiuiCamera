...
# direct methods
.method public constructor <init>(IIZIIIILandroid/os/Handler;Lbi/i$c;)V
    .locals 19
    ...
    iput-object v7, v0, Lbi/d;->y:Ljava/util/ArrayList;

    new-instance v7, Ljava/util/ArrayList;

    invoke-direct {v7}, Ljava/util/ArrayList;-><init>()V

    iput-object v7, v0, Lbi/d;->W:Ljava/util/ArrayList;
    ...
    iput-object v7, v0, Lbi/d;->h0:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput v9, v0, Lbi/d;->a:I

    iput v9, v0, Lbi/d;->b:I

    const/16 v10, 0x20

    iput v10, v0, Lbi/d;->c:I

    const-wide/high16 v10, 0x3fd0000000000000L    # 0.25

    iput-wide v10, v0, Lbi/d;->d:D
    ...
    iput-object v7, v0, Lbi/d;->e:Landroid/media/MediaCodec;
    ...
    :cond_1
    iget-object v7, v0, Lbi/d;->e:Landroid/media/MediaCodec;

    invoke-virtual {v7}, Landroid/media/MediaCodec;->release()V

    iput-object v11, v0, Lbi/d;->e:Landroid/media/MediaCodec;
    ...
    :catch_0
    sget-object v7, Lbi/f;->i0:Landroid/media/MediaCodecList;
    ...
    iget v8, v0, Lbi/d;->a:I

    if-gt v1, v8, :cond_8

    iget v8, v0, Lbi/d;->b:I
    ...
    :cond_9
    sget-object v7, Lbi/a;->i0:Landroid/media/MediaCodecList;
    ...
    :goto_c
    iput v4, v0, Lbi/d;->i:I

    const/4 v9, 0x0

    iput-boolean v9, v0, Lbi/d;->j:Z

    move-object/from16 v9, p9

    iput-object v9, v0, Lbi/d;->g:Lbi/d$c;
    ...
    iput-object v10, v0, Lbi/d;->h:Landroid/os/Handler;
    ...
    :goto_11
    iput-boolean v4, v0, Lbi/d;->Z:Z

    iput v1, v0, Lbi/d;->k:I

    iput v2, v0, Lbi/d;->l:I

    iput-boolean v7, v0, Lbi/d;->r:Z

    if-eqz v7, :cond_19

    iget v9, v0, Lbi/d;->a:I

    iget v3, v0, Lbi/d;->b:I
    ...
    iput v1, v0, Lbi/d;->m:I

    iput v2, v0, Lbi/d;->n:I

    const/4 v3, 0x1

    iput v3, v0, Lbi/d;->o:I

    iput v3, v0, Lbi/d;->p:I

    goto :goto_14

    :cond_1e
    iput v9, v0, Lbi/d;->m:I

    iput v3, v0, Lbi/d;->n:I

    iput v11, v0, Lbi/d;->o:I

    iput v12, v0, Lbi/d;->p:I

    :goto_14
    iget v3, v0, Lbi/d;->o:I

    iget v5, v0, Lbi/d;->p:I

    mul-int/2addr v3, v5

    iput v3, v0, Lbi/d;->q:I
    ...
    :goto_18
    iput-object v13, v0, Lbi/d;->f:Landroid/media/MediaFormat;

    new-instance v1, Landroid/graphics/Rect;

    iget v2, v0, Lbi/d;->m:I

    iget v3, v0, Lbi/d;->n:I

    const/4 v4, 0x0

    invoke-direct {v1, v4, v4, v2, v3}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v1, v0, Lbi/d;->w:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, v0, Lbi/d;->u:Landroid/graphics/Rect;
...
.method public final a([B)V
    ...
    iget v1, p0, Lbi/d;->l:I

    iget v2, p0, Lbi/d;->k:I
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lbi/d;->b([B)V
...
.method public final b([B)V
    ...
    iget-object v0, p0, Lbi/d;->y:Ljava/util/ArrayList;
    ...
    :goto_0
    :try_start_0
    iget-boolean v1, p0, Lbi/d;->t:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Lbi/d;->y:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lbi/d;->W:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_3
    iget-object v0, p0, Lbi/d;->W:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lbi/d;->h:Landroid/os/Handler;
...
.method public final c()V
    ...
    iget v1, p0, Lbi/d;->m:I

    iget v2, p0, Lbi/d;->n:I
    ...
    iget-object v9, p0, Lbi/d;->u:Landroid/graphics/Rect;

    invoke-virtual {v9, v5, v6, v7, v8}, Landroid/graphics/Rect;->set(IIII)V

    :try_start_0
    iget-object v5, p0, Lbi/d;->e0:Lbi/b;

    iget v6, p0, Lbi/d;->f0:I

    sget-object v7, Lbi/h;->h:[F

    invoke-virtual {v5, v6, v7, v9}, Lbi/b;->a(I[FLandroid/graphics/Rect;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v5, p0, Lbi/d;->d0:Lbi/c;

    iget v6, p0, Lbi/d;->s:I

    add-int/lit8 v7, v6, 0x1

    iput v7, p0, Lbi/d;->s:I
    ...
    iget-object v8, v5, Lbi/c;->a:Landroid/opengl/EGLDisplay;

    iget-object v5, v5, Lbi/c;->c:Landroid/opengl/EGLSurface;
    ...
    iget-object v6, v5, Lbi/c;->a:Landroid/opengl/EGLDisplay;
    ...
    iget-object p0, p0, Lbi/d;->h0:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final close()V
    ...
    iget-object v0, p0, Lbi/d;->h:Landroid/os/Handler;
...
.method public final d()V
    ...
    :cond_0
    :goto_0
    iget-boolean v1, v0, Lbi/d;->t:Z

    const/4 v3, 0x0

    if-nez v1, :cond_2

    iget-object v1, v0, Lbi/d;->x:Ljava/nio/ByteBuffer;

    if-nez v1, :cond_2

    iget-object v1, v0, Lbi/d;->W:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object v4, v0, Lbi/d;->W:Ljava/util/ArrayList;
    ...
    :goto_1
    iput-object v4, v0, Lbi/d;->x:Ljava/nio/ByteBuffer;
    ...
    iget-object v4, v0, Lbi/d;->Y:Ljava/util/ArrayList;
    ...
    iget v4, v0, Lbi/d;->s:I

    iget v5, v0, Lbi/d;->q:I
    ...
    iget-object v8, v0, Lbi/d;->e:Landroid/media/MediaCodec;

    invoke-virtual {v8, v6}, Landroid/media/MediaCodec;->getInputImage(I)Landroid/media/Image;

    move-result-object v8

    iget v9, v0, Lbi/d;->m:I

    iget v10, v0, Lbi/d;->s:I

    iget v11, v0, Lbi/d;->p:I

    rem-int v12, v10, v11

    mul-int/2addr v12, v9

    iget v13, v0, Lbi/d;->n:I

    div-int/2addr v10, v11

    iget v11, v0, Lbi/d;->o:I

    rem-int/2addr v10, v11

    mul-int/2addr v10, v13

    iget-object v11, v0, Lbi/d;->u:Landroid/graphics/Rect;
    ...
    iget v9, v0, Lbi/d;->k:I

    iget v10, v0, Lbi/d;->l:I

    iget-object v11, v0, Lbi/d;->u:Landroid/graphics/Rect;

    iget-object v12, v0, Lbi/d;->w:Landroid/graphics/Rect;

    iget-boolean v13, v0, Lbi/d;->j:Z
    ...
    :cond_13
    :goto_d
    iget-object v5, v0, Lbi/d;->e:Landroid/media/MediaCodec;
    ...
    :goto_e
    iget v2, v0, Lbi/d;->s:I

    add-int/lit8 v3, v2, 0x1

    iput v3, v0, Lbi/d;->s:I
    ...
    iget v1, v0, Lbi/d;->s:I

    iget v2, v0, Lbi/d;->q:I
    ...
    :cond_16
    iget-object v1, v0, Lbi/d;->y:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_1
    iget-boolean v2, v0, Lbi/d;->t:Z

    or-int/2addr v2, v4

    iput-boolean v2, v0, Lbi/d;->t:Z

    iget-object v2, v0, Lbi/d;->y:Ljava/util/ArrayList;

    iget-object v3, v0, Lbi/d;->x:Ljava/nio/ByteBuffer;
    ...
    iput-object v1, v0, Lbi/d;->x:Ljava/nio/ByteBuffer;
...
.method public final e()V
    ...
    iget-object v1, p0, Lbi/d;->h0:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_0
    iget-object v3, p0, Lbi/d;->e:Landroid/media/MediaCodec;
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, Lbi/d;->e:Landroid/media/MediaCodec;
    ...
    :try_start_2
    iput-boolean v2, p0, Lbi/d;->t:Z

    iget-object v2, p0, Lbi/d;->y:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v0, p0, Lbi/d;->e0:Lbi/b;
    ...
    :try_start_4
    iput-object v1, p0, Lbi/d;->e0:Lbi/b;
    ...
    :try_start_5
    iget-object v0, p0, Lbi/d;->d0:Lbi/c;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lbi/c;->b()V
    :try_end_5
    ...
    :try_start_6
    iput-object v1, p0, Lbi/d;->d0:Lbi/c;
    ...
    :try_start_7
    iget-object v0, p0, Lbi/d;->b0:Landroid/graphics/SurfaceTexture;
    ...
    :try_start_8
    iput-object v1, p0, Lbi/d;->b0:Landroid/graphics/SurfaceTexture;
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    :cond_0
    iget-object v1, v0, Lbi/c;->a:Landroid/opengl/EGLDisplay;

    iget-object v2, v0, Lbi/c;->c:Landroid/opengl/EGLSurface;

    iget-object v0, v0, Lbi/c;->b:Landroid/opengl/EGLContext;
    ...
    iget-object v2, p0, Lbi/d;->a0:Lbi/d$e;

    iget v3, p0, Lbi/d;->s:I

    iget v4, p0, Lbi/d;->q:I
    ...
    iput-wide v6, v2, Lbi/d$e;->e:J

    :cond_3
    iput-wide v0, v2, Lbi/d$e;->c:J

    invoke-virtual {v2}, Lbi/d$e;->a()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {p0}, Lbi/d;->c()V

    :cond_4
    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->releaseTexImage()V

    iget-object p1, p0, Lbi/d;->d0:Lbi/c;

    iget-object p1, p1, Lbi/c;->a:Landroid/opengl/EGLDisplay;
