...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-boolean v0, p0, Llj/c;->f:Z

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Llj/c;->g:J

    iput-wide v1, p0, Llj/c;->h:J

    iput-boolean v0, p0, Llj/c;->i:Z

    iput-boolean v0, p0, Llj/c;->j:Z

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Llj/c;->k:Ljava/lang/Object;

    iput-wide v1, p0, Llj/c;->l:J

    iput-wide v1, p0, Llj/c;->m:J

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Llj/c;->n:J

    iput-wide v1, p0, Llj/c;->o:J

    iput-wide v1, p0, Llj/c;->p:J
    ...
    iput-object v0, p0, Llj/c;->t:Ljava/lang/Integer;

    iput-object p1, p0, Llj/c;->b:Ljava/lang/String;

    return-void
.end method

.method public static a(Llj/c;Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    .locals 2
    ...
    iget-object p1, p0, Llj/c;->a:Ljava/lang/String;

    new-instance p2, Ljava/lang/StringBuilder;

    invoke-direct {p2}, Ljava/lang/StringBuilder;-><init>()V

    iget-object p3, p0, Llj/c;->b:Ljava/lang/String;
    ...
    iget-object p1, p0, Llj/c;->k:Ljava/lang/Object;
    ...
    :try_start_1
    iput-boolean p2, p0, Llj/c;->j:Z

    iget-object p2, p0, Llj/c;->k:Ljava/lang/Object;
    ...
    iput-wide v0, p0, Llj/c;->h:J

    invoke-virtual {p0, p1, p2, p3}, Llj/c;->e(Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    :try_end_2
    ...
    iget-object p2, p0, Llj/c;->a:Ljava/lang/String;
    ...
    iget-object p0, p0, Llj/c;->q:Llj/c$a;

    if-eqz p0, :cond_1

    invoke-interface {p0}, Llj/c$a;->c()V
...
.method public final f(Landroid/media/MediaFormat;I)V
    ...
    iput-object p1, p0, Llj/c;->d:Landroid/media/MediaFormat;

    invoke-virtual {p0}, Llj/c;->h()Z
    ...
    :goto_0
    iget-object v4, p0, Llj/c;->d:Landroid/media/MediaFormat;
    ...
    :cond_3
    iget-object v4, p0, Llj/c;->t:Ljava/lang/Integer;
    ...
    iget-object v6, p0, Llj/c;->b:Ljava/lang/String;
    ...
    iput-object v4, p0, Llj/c;->r:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Ljava/lang/Thread;->start()V

    new-instance v2, Landroid/os/Handler;

    iget-object v4, p0, Llj/c;->r:Landroid/os/HandlerThread;
    ...
    iput-object v2, p0, Llj/c;->s:Landroid/os/Handler;

    iget-object v2, p0, Llj/c;->d:Landroid/media/MediaFormat;
    ...
    invoke-virtual {p0, p1}, Llj/c;->c(Landroid/media/MediaFormat;)Landroid/media/MediaCodec;

    move-result-object v2

    iput-object v2, p0, Llj/c;->c:Landroid/media/MediaCodec;

    const-string v2, " mMediaCodec =  "

    invoke-static {v6, v2}, La0/x;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v4, p0, Llj/c;->c:Landroid/media/MediaCodec;
    ...
    iget-object v5, p0, Llj/c;->a:Ljava/lang/String;

    invoke-static {v5, v2, v4}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v2, p0, Llj/c;->c:Landroid/media/MediaCodec;

    new-instance v4, Llj/b;

    invoke-direct {v4, p0}, Llj/b;-><init>(Llj/c;)V

    iget-object v7, p0, Llj/c;->s:Landroid/os/Handler;
    ...
    invoke-virtual {p0}, Llj/c;->g()Landroid/view/Surface;

    iget-object p1, p0, Llj/c;->q:Llj/c$a;

    if-eqz p1, :cond_5

    iget-object p0, p0, Llj/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {p0}, Landroid/media/MediaCodec;->getOutputFormat()Landroid/media/MediaFormat;

    move-result-object p0

    invoke-interface {p1, p0}, Llj/c$a;->g(Landroid/media/MediaFormat;)V

    :cond_5
    const-string p0, " init End >> "

    invoke-static {v6, p0}, La0/x;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final h()Z
    ...
    iget-object p0, p0, Llj/c;->d:Landroid/media/MediaFormat;
...
.method public final i(J)V
    ...
    iget-object v1, p0, Llj/c;->b:Ljava/lang/String;
    ...
    iget-object v4, p0, Llj/c;->a:Ljava/lang/String;
    ...
    iget-object v5, p0, Llj/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {v5, v0}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    :cond_0
    iput-wide p1, p0, Llj/c;->l:J

    const-wide/16 p1, 0x0

    iput-wide p1, p0, Llj/c;->p:J

    iput-boolean v3, p0, Llj/c;->f:Z

    const-string p1, "pause X mPauseTimeMs = "

    invoke-static {v1, p1}, La0/x;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-wide v0, p0, Llj/c;->l:J
...
.method public j()V
    ...
    iget-object v2, p0, Llj/c;->b:Ljava/lang/String;
    ...
    iget-object v0, p0, Llj/c;->k:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Llj/c;->c:Landroid/media/MediaCodec;
    ...
    iget-object v4, p0, Llj/c;->b:Ljava/lang/String;
    ...
    iput-object v1, p0, Llj/c;->c:Landroid/media/MediaCodec;

    const-wide/16 v3, 0x0

    iput-wide v3, p0, Llj/c;->l:J

    iput-wide v3, p0, Llj/c;->g:J

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Llj/c;->n:J

    iget-object v1, p0, Llj/c;->r:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, Llj/c;->b:Ljava/lang/String;
...
.method public k(J)V
    ...
    iput-wide p1, p0, Llj/c;->m:J

    iget-wide v5, p0, Llj/c;->l:J

    sub-long v5, p1, v5

    iput-wide v5, p0, Llj/c;->p:J

    iget-wide v7, p0, Llj/c;->o:J

    add-long/2addr v7, v5

    iput-wide v7, p0, Llj/c;->o:J
    ...
    iget-object p1, p0, Llj/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {p1, v0}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    :cond_0
    iput-boolean v2, p0, Llj/c;->f:Z
...
.method public m(J)V
    ...
    iget-wide v5, p0, Llj/c;->o:J

    sub-long v5, p1, v5

    iput-wide v5, p0, Llj/c;->n:J
    ...
    iget-object v6, p0, Llj/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {v6, v5}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    iget-object v5, p0, Llj/c;->k:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    iget-boolean v6, p0, Llj/c;->i:Z

    if-nez v6, :cond_3

    iget-boolean v6, p0, Llj/c;->j:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    iget-object v6, p0, Llj/c;->a:Ljava/lang/String;

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v8, p0, Llj/c;->b:Ljava/lang/String;
    ...
    iget-object v6, p0, Llj/c;->k:Ljava/lang/Object;

    invoke-virtual {v6, v8, v9}, Ljava/lang/Object;->wait(J)V

    invoke-virtual {p0}, Llj/c;->b()Z
    ...
    :try_start_2
    iget-object v7, p0, Llj/c;->a:Ljava/lang/String;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v9, p0, Llj/c;->b:Ljava/lang/String;
...
.method public final n()V
    ...
    iget-object v1, p0, Llj/c;->e:Landroid/view/Surface;

    if-eqz v1, :cond_1

    iget-boolean v1, p0, Llj/c;->j:Z
    ...
    :cond_2
    :goto_0
    iget-object v1, p0, Llj/c;->q:Llj/c$a;

    if-eqz v1, :cond_3

    invoke-interface {v1, p0}, Llj/c$a;->e(Llj/c;)V

    :cond_3
    const/4 v1, 0x1

    iput-boolean v1, p0, Llj/c;->i:Z

    iget-object v1, p0, Llj/c;->k:Ljava/lang/Object;
