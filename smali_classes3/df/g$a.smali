...
.method public final a(Ljava/lang/reflect/Type;Ljava/util/Set;Ldf/y;)Ldf/l;
    ...
    :cond_0
    invoke-static/range {p1 .. p1}, Ldf/b0;->c(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    :cond_2
    invoke-static {v2}, Lef/c;->d(Ljava/lang/Class;)Z
    ...
    invoke-static {v0, v1}, Ldf/g$a;->b(Ljava/lang/reflect/Type;Ljava/lang/Class;)V
    ...
    sget-object v4, Lef/c;->d:Ljava/lang/Class;
    ...
    invoke-direct {v10, v9, v2}, Ldf/b;-><init>(Ljava/lang/reflect/Constructor;Ljava/lang/Class;)V
    :try_end_0
    ...
    invoke-direct {v11, v9, v10, v2}, Ldf/c;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Object;Ljava/lang/Class;)V
    :try_end_1
    ...
    new-instance v11, Ldf/d;

    invoke-direct {v11, v7, v2, v10}, Ldf/d;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Class;I)V
    :try_end_2
    ...
    new-instance v10, Ldf/e;

    invoke-direct {v10, v4, v2}, Ldf/e;-><init>(Ljava/lang/reflect/Method;Ljava/lang/Class;)V
    :try_end_3
    ...
    invoke-static {v0}, Ldf/b0;->c(Ljava/lang/reflect/Type;)Ljava/lang/Class;

    move-result-object v4

    invoke-static {v4}, Lef/c;->d(Ljava/lang/Class;)Z
    ...
    invoke-interface {v6}, Ldf/k;->ignore()Z
    ...
    invoke-static {v0, v4, v11, v13}, Lef/c;->f(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;Ljava/util/LinkedHashSet;)Ljava/lang/reflect/Type;
    ...
    invoke-virtual {v4, v11, v1, v3}, Ldf/y;->c(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)Ldf/l;
    ...
    :cond_11
    invoke-interface {v6}, Ldf/k;->name()Ljava/lang/String;
    ...
    :goto_a
    new-instance v6, Ldf/g$b;

    invoke-direct {v6, v3, v12, v1}, Ldf/g$b;-><init>(Ljava/lang/String;Ljava/lang/reflect/Field;Ldf/l;)V

    invoke-virtual {v2, v3, v6}, Ljava/util/TreeMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Ldf/g$b;
    ...
    iget-object v1, v1, Ldf/g$b;->b:Ljava/lang/reflect/Field;
    ...
    invoke-static {v0, v1, v3, v5}, Lef/c;->f(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;Ljava/util/LinkedHashSet;)Ljava/lang/reflect/Type;
    ...
    invoke-direct {v0, v10, v2}, Ldf/g;-><init>(Ldf/f;Ljava/util/TreeMap;)V

    invoke-virtual {v0}, Ldf/l;->nullSafe()Ldf/l;
    ...
    invoke-static {v0}, Lef/c;->g(Ljava/lang/reflect/InvocationTargetException;)V
    ...
    invoke-static {v2, v1, v3}, La0/t3;->d(Ljava/lang/Class;Ljava/lang/StringBuilder;Ljava/lang/String;)Ljava/lang/String;
