...
.method public synthetic constructor <init>(Lcom/xiaomi/continuity/netbus/NetBusManager;Landroid/os/ResultReceiver;)V
    ...
    iput-object p1, p0, Lqk/t;->a:Lcom/xiaomi/continuity/netbus/NetBusManager;

    const-string p1, "00070B2B"

    iput-object p1, p0, Lqk/t;->b:Ljava/lang/String;

    iput-object p2, p0, Lqk/t;->c:Landroid/os/ResultReceiver;
...
.method public final a(Landroid/os/IInterface;)V
    ...
    iget-object v0, p0, Lqk/t;->a:Lcom/xiaomi/continuity/netbus/NetBusManager;

    iget-object v1, v0, Lcom/xiaomi/continuity/netbus/NetBusManager;->c:Landroid/os/Binder;

    iget-object v2, p0, Lqk/t;->b:Ljava/lang/String;

    iget-object p0, p0, Lqk/t;->c:Landroid/os/ResultReceiver;

    iget-object v0, v0, Lcom/xiaomi/continuity/netbus/NetBusManager;->d:Ljava/lang/String;

    invoke-interface {p1, v1, v2, v0, p0}, Lcom/xiaomi/continuity/netbus/c;->j0(Landroid/os/Binder;Ljava/lang/String;Ljava/lang/String;Landroid/os/ResultReceiver;)V
