...
# direct methods
.method public constructor <init>(Lbj/g;Ljava/lang/String;)V
    .locals 1
    ...
    iput-object p1, p0, Lbj/d;->c:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object p1, p0, Lbj/d;->b:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    iput-object p1, p0, Lbj/d;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p1, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p1, p0, Lbj/d;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    new-instance p2, Lbj/d$a;

    invoke-direct {p2, p0, p1}, Lbj/d$a;-><init>(Lbj/d;Ljava/net/InetAddress;)V

    iput-object p2, p0, Lbj/d;->d:Lbj/d$a;
    ...
    invoke-virtual {p0, p1}, Lbj/d;->d(Ljava/lang/String;)V
...
.method public final e(Ljava/io/FileInputStream;Ljava/lang/String;IJ)V
    ...
    iget-object v3, p0, Lbj/d;->d:Lbj/d$a;
    ...
    invoke-virtual/range {v3 .. v8}, Lbj/d$a;->d(Ljava/io/FileInputStream;Ljava/lang/String;IJ)V
    :try_end_0
...
.method public final f(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;I)V
    ...
    invoke-virtual/range {v2 .. v7}, Lbj/d;->e(Ljava/io/FileInputStream;Ljava/lang/String;IJ)V
