...
.field public final synthetic c:Lkj/b;
...
.method public constructor <init>(Lkj/b;)V
    ...
    iput-object p1, p0, Lkj/d;->c:Lkj/b;
...
.method public final a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    iget-object v0, v1, Lkj/d;->c:Lkj/b;
    ...
    iput-wide v8, v1, Lkj/d;->b:J

    :goto_0
    iget-object v0, v1, Lkj/d;->c:Lkj/b;

    iget-object v0, v0, Lkj/b;->m:Ljj/b;

    iget-wide v8, v1, Lkj/d;->b:J

    iput-wide v8, v0, Ljj/b;->d:J
    ...
    iget-object v8, v0, Lkj/b;->m:Ljj/b;

    iget-wide v9, v8, Ljj/b;->d:J
    ...
    :cond_2
    :try_start_0
    iget-object v0, v8, Ljj/b;->c:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->clear()Ljava/nio/Buffer;

    iget-object v0, v8, Ljj/b;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v6, v8, Ljj/b;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object v6, v8, Ljj/b;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v6, v8, Ljj/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v9, v8, Ljj/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v8, Ljj/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v11, v8, Ljj/b;->c:Ljava/nio/ByteBuffer;
    ...
    :cond_5
    iget-wide v10, v8, Ljj/b;->e:J

    const-wide/16 v12, 0x400

    add-long/2addr v10, v12

    iput-wide v10, v8, Ljj/b;->e:J

    iget-wide v12, v8, Ljj/b;->d:J

    const-wide/32 v14, 0xf4240

    mul-long/2addr v10, v14

    iget v0, v8, Ljj/b;->a:I
    ...
    iget-object v0, v8, Ljj/b;->g:Ljj/a;
    ...
    check-cast v0, Lkj/b$a;

    iget-object v12, v0, Lkj/b$a;->a:Lkj/b;

    iget-boolean v12, v12, Lkj/b;->d:Z

    if-nez v12, :cond_7

    new-instance v12, Llj/f;

    invoke-direct {v12, v10, v11, v7, v9}, Llj/f;-><init>(JILjava/nio/ByteBuffer;)V

    iget-object v0, v0, Lkj/b$a;->a:Lkj/b;

    iget-object v13, v0, Lkj/b;->o:Lkj/b$b;

    if-eqz v13, :cond_6

    check-cast v13, Lm2/t;

    iget-object v0, v13, Lm2/t;->a:Ljava/lang/Object;

    check-cast v0, Lfi/a;

    sget-boolean v12, Lfi/a;->G:Z
    ...
    invoke-virtual {v0, v9, v12}, Lfi/c;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    :cond_a
    iget-object v3, v8, Ljj/b;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object v3, v8, Ljj/b;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v4, v8, Ljj/b;->c:Ljava/nio/ByteBuffer;
    ...
    iget-wide v4, v1, Lkj/d;->a:J

    cmp-long v0, v2, v4

    if-lez v0, :cond_d

    iput-wide v2, v1, Lkj/d;->a:J
...
.method public final run()V
    ...
    iget-object v0, p0, Lkj/d;->c:Lkj/b;

    iget v0, v0, Lkj/b;->g:I

    invoke-static {v0}, Ljava/nio/ByteBuffer;->allocateDirect(I)Ljava/nio/ByteBuffer;

    move-result-object v0

    iget-object v1, p0, Lkj/d;->c:Lkj/b;

    invoke-static {v1}, Lkj/b;->b(Lkj/b;)V

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Lkj/d;->b:J

    :goto_0
    iget-object v1, p0, Lkj/d;->c:Lkj/b;

    iget-boolean v1, v1, Lkj/b;->c:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Lkj/d;->c:Lkj/b;

    iget-object v1, v1, Lkj/b;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v3, p0, Lkj/d;->c:Lkj/b;

    iget-object v4, v3, Lkj/b;->a:Landroid/media/AudioRecord;

    if-eqz v4, :cond_1

    iget v3, v3, Lkj/b;->g:I

    invoke-virtual {v4, v0, v3}, Landroid/media/AudioRecord;->read(Ljava/nio/ByteBuffer;I)I

    move-result v3

    iget-object v4, p0, Lkj/d;->c:Lkj/b;

    iget-object v5, v4, Lkj/b;->a:Landroid/media/AudioRecord;

    iget-object v6, v4, Lkj/b;->k:Landroid/media/AudioTimestamp;

    iget v4, v4, Lkj/b;->n:I
    ...
    iget-object v5, p0, Lkj/d;->c:Lkj/b;

    iget-object v5, v5, Lkj/b;->k:Landroid/media/AudioTimestamp;

    invoke-virtual {p0, v4, v5, v0, v3}, Lkj/d;->a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    invoke-static {v4, v5, v3}, Lkj/b;->a(Lkj/b;Ljava/lang/String;I)V
    ...
    :cond_2
    :try_start_1
    iget-object p0, p0, Lkj/d;->c:Lkj/b;
