...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lak/d;->c:Ljava/lang/Boolean;
...
.method public static o(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lak/d;->r(Landroid/content/Intent;)Z
...
.method public final a(Landroid/app/Activity;)Z
    ...
    :cond_3
    iget-object v1, p0, Lak/d;->a:Landroid/content/Intent;
    ...
    invoke-static {p0, v4}, La0/z;->c(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public final b()V
    ...
    invoke-virtual {p0}, Lak/d;->q()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, Lak/d;->a:Landroid/content/Intent;
...
.method public final c()Z
    ...
    iget-object v0, p0, Lak/d;->c:Ljava/lang/Boolean;

    if-nez v0, :cond_9

    invoke-virtual {p0}, Lak/d;->d()Ljava/lang/String;
    ...
    :cond_9
    :goto_1
    iget-object p0, p0, Lak/d;->c:Ljava/lang/Boolean;
...
.method public final d()Ljava/lang/String;
    ...
    iget-object v0, p0, Lak/d;->b:Landroid/net/Uri;

    if-nez v0, :cond_0

    iget-object v0, p0, Lak/d;->a:Landroid/content/Intent;

    invoke-static {v0}, Lak/d;->w(Landroid/content/Intent;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Lak/d;->b:Landroid/net/Uri;

    :cond_0
    iget-object p0, p0, Lak/d;->b:Landroid/net/Uri;
...
.method public final j()Z
    ...
    invoke-static {p0}, Lak/d;->k(Landroid/content/Intent;)Z
...
.method public final n()Z
    ...
    invoke-static {p0}, Lak/d;->o(Landroid/content/Intent;)Z
...
.method public final p()Z
    ...
    :cond_7
    iget-object v2, p0, Lak/d;->a:Landroid/content/Intent;
    ...
    :cond_8
    sget-object v4, La0/p5$a;->a:La0/p5;

    iget v4, v4, La0/p5;->a:I
...
.method public final t()Z
    ...
    invoke-static {p0}, Lak/d;->u(Landroid/content/Intent;)Z
...
.method public final y(Landroid/content/Intent;)V
    ...
    iput-object p1, p0, Lak/d;->a:Landroid/content/Intent;

    invoke-static {p1}, Lak/d;->w(Landroid/content/Intent;)Landroid/net/Uri;
    ...
    invoke-static {p1}, Lak/d$a;->a(Landroid/os/Bundle;)V
