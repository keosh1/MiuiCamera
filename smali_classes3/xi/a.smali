...
.field public final e:Lxi/a$d;

.field public final f:Lxi/a$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lxi/a;->c:Ljava/lang/Object;

    new-instance v0, Lxi/a$a;

    invoke-direct {v0, p0}, Lxi/a$a;-><init>(Lxi/a;)V

    iput-object v0, p0, Lxi/a;->f:Lxi/a$a;
    ...
    iput-object v0, p0, Lxi/a;->d:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Ljava/lang/Thread;->start()V

    new-instance v1, Lxi/a$d;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v0

    invoke-direct {v1, p0, v0}, Lxi/a$d;-><init>(Lxi/a;Landroid/os/Looper;)V

    iput-object v1, p0, Lxi/a;->e:Lxi/a$d;

    return-void
.end method

.method public static a(Lxi/a;Lgg/b$a;IZ)V
    .locals 17
    ...
    new-instance v12, Lxi/b;

    invoke-direct {v12, v1, v0, v2}, Lxi/b;-><init>(Lxi/a;Lgg/b$a;I)V

    const/4 v13, 0x1

    if-nez v2, :cond_0

    iget-object v3, v0, Lgg/b$a;->d:Landroid/media/Image;
    ...
    iget-object v3, v0, Lgg/b$a;->e:Landroid/media/Image;
    ...
    iget-object v5, v0, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v4, v5, v2}, La0/z;->d(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v4, v3, v6, v13}, Ldg/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v3, v1, Lxi/a;->c:Ljava/lang/Object;
    ...
    iput-wide v6, v1, Lxi/a;->a:J

    iput-boolean v13, v1, Lxi/a;->b:Z
    ...
    iget-object v7, v0, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, v1, Lxi/a;->c:Ljava/lang/Object;
    ...
    :try_start_2
    iget-boolean v0, v1, Lxi/a;->b:Z

    if-eqz v0, :cond_1

    iget-object v0, v1, Lxi/a;->c:Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v3}, La0/y;->c(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
# virtual methods
.method public final b(Lgg/b;Lcom/xiaomi/engine/TaskSession;)V
    .locals 33
    ...
    sget-boolean v0, Lxa/c;->w:Z

    iget-object v4, v1, Lgg/b;->f:Ljava/util/ArrayList;

    move-object/from16 v6, p0

    iget-object v6, v6, Lxi/a;->f:Lxi/a$a;
    ...
    iget-object v2, v0, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-object v2, v0, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean v7, v0, Lgg/b$a;->a:Z

    iget-boolean v2, v0, Lgg/b$a;->m:Z

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lgg/b$a;->b()V

    :cond_0
    iget-object v2, v1, Lgg/b;->p:Lwg/d;
    ...
    iget-object v8, v5, Lgg/b$a;->d:Landroid/media/Image;

    iget-object v9, v5, Lgg/b$a;->e:Landroid/media/Image;

    iget-object v5, v5, Lgg/b$a;->g:Landroid/media/Image;
    ...
    check-cast v10, Lwg/t$c;

    invoke-virtual {v10, v8}, Lwg/t$c;->b(Landroid/media/Image;)V
    ...
    check-cast v8, Lwg/t$c;

    invoke-virtual {v8, v9}, Lwg/t$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v8, v5}, Lwg/t$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v0}, Lgg/b$a;->c()Z

    move-result v2

    if-eqz v2, :cond_5

    iput-object v0, v1, Lgg/b;->i:Lgg/b$a;

    invoke-virtual {v6, v1, v3}, Lxi/a$a;->a(Lgg/b;Z)V
    ...
    new-instance v2, Lgg/b$a;

    iget v14, v1, Lgg/b;->b:I

    iget-boolean v15, v1, Lgg/b;->l:Z

    iget-object v10, v1, Lgg/b;->o:Lgg/d;

    const/16 v17, 0x1

    iget-boolean v11, v1, Lgg/b;->m:Z
    ...
    invoke-direct/range {v13 .. v18}, Lgg/b$a;-><init>(IZLgg/d;ZZ)V

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10, v9}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v4, v10}, La0/k0;->f(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v12, v9, v10, v11}, La0/a0;->j(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v14, v13, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v0, v0, Lgg/b$a;->d:Landroid/media/Image;
    ...
    :cond_9
    invoke-static {v8, v5}, La0/t3;->e(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v8, v5, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_3
    invoke-virtual {v2, v0, v3, v3}, Lgg/b$a;->d(Landroid/media/Image;IZ)V
    ...
    iget-object v0, v1, Lgg/b;->p:Lwg/d;
    ...
    iget-object v11, v10, Lgg/b$a;->d:Landroid/media/Image;

    invoke-virtual {v11}, Landroid/media/Image;->close()V

    move-object v13, v0

    check-cast v13, Lwg/t$c;

    invoke-virtual {v13, v11}, Lwg/t$c;->b(Landroid/media/Image;)V

    iget-object v11, v10, Lgg/b$a;->e:Landroid/media/Image;
    ...
    :cond_d
    iget-object v10, v10, Lgg/b$a;->g:Landroid/media/Image;

    if-eqz v10, :cond_c

    invoke-virtual {v10}, Landroid/media/Image;->close()V

    invoke-virtual {v13, v10}, Lwg/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v4, v5, Lgg/b$a;->d:Landroid/media/Image;

    invoke-virtual {v4}, Landroid/media/Image;->close()V

    check-cast v0, Lwg/t$c;

    invoke-virtual {v0, v4}, Lwg/t$c;->b(Landroid/media/Image;)V

    iput-object v8, v2, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    const/4 v0, 0x1

    iput-boolean v0, v2, Lgg/b$a;->a:Z

    iget-boolean v0, v2, Lgg/b$a;->m:Z

    if-eqz v0, :cond_f

    invoke-virtual {v2}, Lgg/b$a;->b()V

    :cond_f
    iget-boolean v0, v1, Lgg/b;->l:Z

    if-eqz v0, :cond_10

    iget-object v0, v5, Lgg/b$a;->g:Landroid/media/Image;

    iget-boolean v4, v5, Lgg/b$a;->l:Z

    const/4 v8, 0x2

    invoke-virtual {v2, v0, v8, v4}, Lgg/b$a;->d(Landroid/media/Image;IZ)V

    :cond_10
    iget-object v0, v5, Lgg/b$a;->e:Landroid/media/Image;

    const/4 v4, 0x1

    if-eqz v0, :cond_11

    invoke-virtual {v2, v0, v4, v3}, Lgg/b$a;->d(Landroid/media/Image;IZ)V

    :cond_11
    invoke-virtual {v2}, Lgg/b$a;->c()Z

    move-result v0

    if-eqz v0, :cond_12

    iput-object v2, v1, Lgg/b;->i:Lgg/b$a;

    invoke-virtual {v6, v1, v4}, Lxi/a$a;->a(Lgg/b;Z)V
    ...
    iget-object v0, v1, Lgg/b;->n:Landroid/util/Size;
    ...
    invoke-static {v13, v12, v14, v0}, La0/e0;->d(Ljava/lang/String;ILjava/lang/String;I)Ljava/lang/String;
    ...
    new-instance v10, Lgg/b$a;

    iget v15, v1, Lgg/b;->b:I

    iget-boolean v0, v1, Lgg/b;->l:Z

    iget-object v11, v1, Lgg/b;->o:Lgg/d;

    const/16 v18, 0x1

    iget-boolean v14, v1, Lgg/b;->m:Z
    ...
    invoke-direct/range {v14 .. v19}, Lgg/b$a;-><init>(IZLgg/d;ZZ)V

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0, v9}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v4, v0}, La0/k0;->f(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v0, v3, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v17, Lqa/y;->n1:Lqa/x;

    invoke-virtual/range {v17 .. v17}, Lqa/z;->b()Ljava/lang/Object;
    ...
    iget-object v6, v3, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v3, Lgg/b$a;->d:Landroid/media/Image;
    ...
    invoke-static {v10, v7}, La0/t3;->e(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v11, v7, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v11}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getTimeStamp()J

    move-result-wide v12

    iget-object v0, v1, Lgg/b;->o:Lgg/d;
    ...
    check-cast v14, Lgg/b$a;

    iget-object v0, v14, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v18, Lqa/y;->n1:Lqa/x;

    invoke-virtual/range {v18 .. v18}, Lqa/z;->b()Ljava/lang/Object;
    ...
    iget-object v3, v14, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v14, Lgg/b$a;->e:Landroid/media/Image;
    ...
    iget-object v3, v3, Lgg/b$a;->e:Landroid/media/Image;
    ...
    :cond_20
    invoke-static {v8, v2}, La0/t3;->e(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_21
    invoke-static {v10, v2}, La0/t3;->e(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v0, v3, v2}, Lgg/b$a;->d(Landroid/media/Image;IZ)V
    ...
    :goto_13
    iput-object v11, v8, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean v3, v8, Lgg/b$a;->a:Z

    iget-boolean v0, v8, Lgg/b$a;->m:Z

    if-eqz v0, :cond_24

    invoke-virtual {v8}, Lgg/b$a;->b()V
    ...
    iget-object v0, v7, Lgg/b$a;->g:Landroid/media/Image;

    iget-boolean v2, v7, Lgg/b$a;->l:Z
    ...
    invoke-virtual {v8, v0, v2, v2}, Lgg/b$a;->d(Landroid/media/Image;IZ)V
    ...
    :cond_28
    iget-object v9, v3, Lgg/b$a;->d:Landroid/media/Image;
    ...
    invoke-virtual {v10, v9}, Lwg/t$c;->b(Landroid/media/Image;)V

    iget-object v9, v3, Lgg/b$a;->e:Landroid/media/Image;
    ...
    :cond_29
    iget-object v3, v3, Lgg/b$a;->g:Landroid/media/Image;

    if-eqz v3, :cond_2a

    invoke-virtual {v3}, Landroid/media/Image;->close()V

    invoke-virtual {v10, v3}, Lwg/t$c;->b(Landroid/media/Image;)V
    ...
    iget-object v2, v7, Lgg/b$a;->d:Landroid/media/Image;

    invoke-virtual {v2}, Landroid/media/Image;->close()V

    check-cast v0, Lwg/t$c;

    invoke-virtual {v0, v2}, Lwg/t$c;->b(Landroid/media/Image;)V

    iget-object v2, v7, Lgg/b$a;->e:Landroid/media/Image;

    if-eqz v2, :cond_2d

    iget-object v3, v1, Lgg/b;->o:Lgg/d;
    ...
    invoke-virtual {v8, v2, v3, v0}, Lgg/b$a;->d(Landroid/media/Image;IZ)V
    ...
    iput-boolean v0, v3, Lgg/b$a;->i:Z
    ...
    iput-object v6, v1, Lgg/b;->g:Ljava/util/List;

    iget-boolean v0, v1, Lgg/b;->k:Z

    xor-int/lit8 v0, v0, 0x1

    move-object/from16 v2, v24

    invoke-virtual {v2, v1, v0}, Lxi/a$a;->a(Lgg/b;Z)V
    ...
    iput-object v8, v1, Lgg/b;->i:Lgg/b$a;
    ...
    invoke-static {v1, v12}, La0/t3;->e(Ljava/lang/String;I)Ljava/lang/String;
