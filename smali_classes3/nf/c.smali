...
.method public constructor <init>(Lnf/e;)V
    ...
    iput-object v1, p0, Lnf/c;->j:Ljava/security/SecureRandom;

    iput-object p1, p0, Lnf/c;->a:Lnf/e;

    iget-object v1, p1, Lnf/e;->l:Landroid/content/Context;

    iput-object v1, p0, Lnf/c;->b:Landroid/content/Context;

    iget-object v1, p1, Lnf/e;->b:Lwf/a;

    const-string v2, "auth.client_id"

    invoke-virtual {v1, v2}, Lwf/a;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lnf/c;->d:Ljava/lang/String;
    ...
    iput-object v2, p0, Lnf/c;->f:Ljava/lang/String;

    iget-object v2, p1, Lnf/e;->o:Ltf/ga;
    ...
    iget-object p1, p1, Lnf/e;->o:Ltf/ga;
    ...
    iput-object p1, p0, Lnf/c;->g:Lokhttp3/OkHttpClient;

    new-instance p1, Lnf/c$a;

    invoke-direct {p1, p0}, Lnf/c$a;-><init>(Lnf/c;)V

    iput-object p1, p0, Lnf/c;->c:Lnf/c$a;

    return-void
.end method

.method public static b(Lnf/c;J)V
    .locals 5
    ...
    iget-object v0, p0, Lnf/c;->c:Lnf/c$a;
    ...
    :cond_0
    iget-object v2, p0, Lnf/c;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    sget-object v3, Lvf/b;->a:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-static {v2, v3}, Lyf/a;->c(Ljava/lang/String;Ljava/lang/String;)V

    :cond_2
    :goto_0
    :try_start_0
    invoke-static {v0, p1, p2}, Lvf/b;->a(Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;

    move-result-object p1

    iput-object p1, p0, Lnf/c;->i:Ljava/util/concurrent/ScheduledFuture;
    :try_end_0
...
.method public static c(Lnf/c;I)J
    .locals 6

    const-string v0, "cloud_config_last_request_time"

    invoke-virtual {p0, v0}, Lnf/c;->a(Ljava/lang/String;)J
    ...
    invoke-static {p1, v1}, Lyf/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p0, p0, Lnf/c;->b:Landroid/content/Context;

    const-string p1, "aivs_cloud_control"

    invoke-static {p0, p1, v0}, Lrf/b;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    return-wide v4
.end method

.method public static d(Lnf/c;)V
    .locals 6
    ...
    iget-object v2, p0, Lnf/c;->b:Landroid/content/Context;

    const-string v3, "aivs_cloud_control"

    const-string v4, "cloud_config_last_request_time"

    invoke-static {v2, v3, v4, v1}, Lrf/b;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "parse error"

    const-string v2, "getCloudConfigFromNet body: "

    iget-object v3, p0, Lnf/c;->a:Lnf/e;
    ...
    invoke-virtual {v3, v5, v4}, Lwf/a;->c(Ljava/lang/String;I)I
    ...
    iget-object v5, p0, Lnf/c;->d:Ljava/lang/String;
    ...
    iget-object v5, p0, Lnf/c;->e:Ljava/lang/String;

    invoke-virtual {v3, v4, v5}, Lokhttp3/HttpUrl$Builder;->addQueryParameter(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    const-string v4, "uid"

    iget-object v5, p0, Lnf/c;->f:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v4, p0, Lnf/c;->g:Lokhttp3/OkHttpClient;
    ...
    invoke-static {v1, v4}, Lnb/t;->b(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v4, v2, Lnb/t;->b:Ldc/n;

    invoke-virtual {v4, v3}, Ldc/n;->m(Ljava/lang/reflect/Type;)Lnb/i;
    ...
    :try_start_1
    iget-object v4, v2, Lnb/t;->a:Lfb/c;

    invoke-virtual {v4, v1}, Lfb/c;->m(Ljava/lang/String;)Lfb/h;

    move-result-object v1

    invoke-virtual {v2, v1, v3}, Lnb/t;->g(Lfb/h;Lnb/i;)Ljava/lang/Object;
    ...
    invoke-static {v1}, Lnb/k;->g(Ljava/io/IOException;)Lnb/k;
    ...
    iget-object p0, p0, Lnf/c;->c:Lnf/c$a;
...
.method public final a(Ljava/lang/String;)J
    ...
    invoke-static {p0, v0, p1}, Lrf/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, p1, v3}, La0/x3;->f(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p1, p0}, Lyf/a;->c(Ljava/lang/String;Ljava/lang/String;)V
