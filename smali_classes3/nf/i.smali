...
.method public constructor <init>(Lnf/e;)V
    ...
    iput-object v0, p0, Lnf/i;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lnf/i;->g:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lnf/i;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lnf/i;->i:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lnf/i;->j:Ljava/util/concurrent/CopyOnWriteArraySet;

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lnf/i;->k:J

    const/4 v0, 0x0

    iput-boolean v0, p0, Lnf/i;->l:Z

    iput-object p1, p0, Lnf/i;->c:Lnf/e;

    new-instance v1, Lqf/a;

    invoke-direct {v1, p1}, Lqf/a;-><init>(Lnf/e;)V

    iput-object v1, p0, Lnf/i;->d:Lqf/a;

    new-instance v2, Lnf/i$a;

    invoke-direct {v2, p0}, Lnf/i$a;-><init>(Lnf/i;)V

    new-instance v3, Lqf/c;

    invoke-direct {v3, p1, v1, v2}, Lqf/c;-><init>(Lnf/e;Lqf/a;Lnf/i$a;)V

    iput-object v3, p0, Lnf/i;->e:Lqf/c;
    ...
    iput-object p1, p0, Lnf/i;->a:Landroid/os/HandlerThread;
    ...
    invoke-direct {v1, p0}, Lnf/i$b;-><init>(Lnf/i;)V

    invoke-direct {v0, p1, v1}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    iput-object v0, p0, Lnf/i;->b:Landroid/os/Handler;
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lnf/i;->c:Lnf/e;
    ...
    :cond_0
    iget-object v0, p0, Lnf/i;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p1, v0}, Lzf/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, p0}, Lzf/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, v0, v1, p0}, Lzf/a;->e(JLjava/lang/String;)V
    ...
    invoke-virtual {p1, v5, v6, v0}, Lzf/a;->e(JLjava/lang/String;)V

    iget-wide v0, p0, Lnf/i;->k:J
    ...
    iput-wide v3, p0, Lnf/i;->k:J

    iget-boolean v3, p0, Lnf/i;->l:Z
    ...
    :goto_2
    invoke-virtual {p1, v3}, Lzf/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p1, v0, v1, v3}, Lzf/a;->e(JLjava/lang/String;)V

    :cond_7
    iput-boolean v2, p0, Lnf/i;->l:Z
...
.method public final b(Z)V
    ...
    :try_start_0
    iget-object v2, p0, Lnf/i;->c:Lnf/e;
    ...
    iget-object p0, p0, Lnf/i;->b:Landroid/os/Handler;
...
.method public final c()V
    ...
    iget-object v0, v0, Lnf/e;->l:Landroid/content/Context;
...
.method public final d(Luf/f;)V
    .locals 8

    iget-object v0, p0, Lnf/i;->c:Lnf/e;

    iget-object v1, v0, Lnf/e;->b:Lwf/a;
    ...
    :cond_0
    iget-object v2, p1, Luf/h;->a:Luf/i;
    ...
    invoke-static {v2}, Llk/a;->c(Ljava/lang/Object;)Llk/a;

    move-result-object v4

    iget-object v5, p0, Lnf/i;->j:Ljava/util/concurrent/CopyOnWriteArraySet;

    iget-object v6, p0, Lnf/i;->f:Ljava/util/concurrent/ConcurrentHashMap;

    if-eqz v4, :cond_4

    invoke-virtual {v4}, Llk/a;->b()Z
    ...
    invoke-direct {v7, p0}, Lzf/a;-><init>(Lzf/b;)V
    ...
    iget-object p0, v0, Lnf/e;->l:Landroid/content/Context;
    ...
    invoke-virtual {v7, v6, v0}, Lzf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, v0, p0}, Lzf/a;->c(Ljava/lang/String;I)V
    ...
    invoke-virtual {v7, v0, p0}, Lzf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v7, p0, v0}, Lzf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6, v0}, Lyf/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, v3, p1}, Lzf/a;->e(JLjava/lang/String;)V
    ...
    :pswitch_4
    check-cast p1, Ltf/vb;

    const-wide/16 v0, 0x0

    if-eqz p1, :cond_d

    iget-object p1, p1, Ltf/vb;->a:Llk/a;
    ...
    invoke-virtual {p0, p1}, Lzf/a;->b(Ljava/lang/String;)J
    ...
    invoke-virtual {p0, v0, v1, p1}, Lzf/a;->e(JLjava/lang/String;)V
