...
.method public static constructor <clinit>()V
    ...
    sput-boolean v0, Lfi/a;->G:Z

    const/4 v0, 0x1

    sput-boolean v0, Lfi/a;->H:Z
...
.method public constructor <init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V
    ...
    invoke-direct/range {p0 .. p6}, Lfi/c;-><init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V
    ...
    iput-object p2, p0, Lfi/a;->F:Landroid/media/AudioFormat;

    iget-object p2, p0, Lfi/c;->b:Landroid/media/MediaFormat;
    ...
    iput p2, p0, Lfi/a;->z:I

    iget-object p3, p0, Lfi/c;->b:Landroid/media/MediaFormat;
    ...
    iput p3, p0, Lfi/a;->A:I

    iget-object p4, p0, Lfi/c;->b:Landroid/media/MediaFormat;
    ...
    iput v2, p0, Lfi/a;->C:I

    invoke-static {p2, p3}, Lij/v;->i(II)Z
    ...
    iget-object p3, p0, Lfi/a;->F:Landroid/media/AudioFormat;
    ...
    iget-object p2, p0, Lfi/a;->F:Landroid/media/AudioFormat;

    invoke-virtual {p0, p2}, Lfi/a;->w(Landroid/media/AudioFormat;)V

    iget-object p2, p0, Lfi/c;->b:Landroid/media/MediaFormat;

    const-string p3, "max-input-size"

    iget p4, p0, Lfi/a;->C:I
    ...
    iget-object p3, p0, Lfi/a;->D:Lkj/b;

    iget-object p3, p3, Lkj/b;->a:Landroid/media/AudioRecord;
    ...
    iget-boolean p1, p0, Lfi/a;->E:Z

    if-nez p1, :cond_6

    :try_start_0
    iget-object p1, p0, Lfi/c;->b:Landroid/media/MediaFormat;
    ...
    iput-object p1, p0, Lfi/c;->k:Landroid/media/MediaCodec;
    :try_end_0
...
.method public final f()V
    ...
    :cond_0
    invoke-super {p0}, Lfi/c;->f()V

    const/4 v0, 0x0

    :try_start_0
    iget-object v1, p0, Lfi/a;->D:Lkj/b;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lkj/b;->e()V
    :try_end_0
...
.method public final g()V
    ...
    :cond_2
    iget-object v2, p0, Lfi/c;->m:Lfi/c$a;

    invoke-virtual {v2}, Lfi/c$a;->a()V
    ...
    iget-object v2, p0, Lfi/c;->k:Landroid/media/MediaCodec;
    ...
    iget-object v5, p0, Lfi/c;->h:Lhi/b;

    invoke-virtual {v5}, Lhi/b;->a()V

    iget-object v5, v5, Lhi/b;->d:Landroid/os/Looper;
    ...
    :cond_3
    iput-boolean v1, p0, Lfi/c;->r:Z

    iput-boolean v1, p0, Lfi/c;->s:Z

    invoke-virtual {p0}, Lfi/c;->t()V

    :try_start_0
    iget-object v2, p0, Lfi/a;->D:Lkj/b;

    if-nez v2, :cond_4

    iget-object v2, p0, Lfi/a;->F:Landroid/media/AudioFormat;

    invoke-virtual {p0, v2}, Lfi/a;->w(Landroid/media/AudioFormat;)V

    :cond_4
    iget-object v2, p0, Lfi/a;->D:Lkj/b;

    invoke-virtual {v2}, Lkj/b;->f()V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :try_start_1
    iput-boolean v3, p0, Lfi/c;->r:Z

    const-string v2, "audio/mp4a-latm"

    iget v4, p0, Lfi/a;->z:I

    iget v5, p0, Lfi/a;->A:I
    ...
    iget v5, p0, Lfi/a;->z:I

    iget v6, p0, Lfi/a;->A:I

    invoke-static {v5, v6}, Lij/v;->a(II)Ljava/nio/ByteBuffer;

    move-result-object v5

    invoke-virtual {v2, v4, v5}, Landroid/media/MediaFormat;->setByteBuffer(Ljava/lang/String;Ljava/nio/ByteBuffer;)V

    iget-object v2, p0, Lfi/c;->l:Landroid/media/MediaFormat;

    const-string v4, "bitrate"

    iget v5, p0, Lfi/a;->y:I

    invoke-virtual {v2, v4, v5}, Landroid/media/MediaFormat;->setInteger(Ljava/lang/String;I)V

    invoke-virtual {p0}, Ljava/lang/Object;->notifyAll()V

    iget-object v2, p0, Lfi/c;->f:Ljava/util/ArrayList;
    ...
    :cond_5
    :goto_0
    iput-boolean v3, p0, Lfi/c;->n:Z

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Lfi/c;->p:J
...
.method public final h()V
    ...
    :cond_3
    :try_start_0
    iget-object v0, p0, Lfi/a;->D:Lkj/b;

    invoke-virtual {v0}, Lkj/b;->g()V

    iget-boolean v0, p0, Lfi/a;->E:Z
    ...
    iput-object v0, p0, Lfi/a;->D:Lkj/b;
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v3, p0, Lfi/c;->f:Ljava/util/ArrayList;

    monitor-enter v3

    :try_start_1
    iget-object v4, p0, Lfi/c;->f:Ljava/util/ArrayList;

    invoke-virtual {v2, v4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object p0, p0, Lfi/c;->f:Ljava/util/ArrayList;
    ...
    check-cast v0, Lfi/c$d;

    :try_start_2
    invoke-virtual {v0}, Lfi/c$d;->c()V
    :try_end_2
...
.method public final onInputBufferAvailable(Landroid/media/MediaCodec;I)V
    ...
    :try_start_0
    iget-object v0, v0, Lkj/a;->a:Ljava/util/concurrent/ArrayBlockingQueue;
    ...
    iget-object v4, v0, Llj/f;->a:Ljava/nio/ByteBuffer;
    ...
    iget p1, p0, Lfi/a;->B:I

    div-int p1, v7, p1

    iget-wide v8, v0, Llj/f;->c:J

    iget-boolean p1, p0, Lfi/c;->n:Z
    ...
    iput-wide v8, p0, Lfi/c;->w:J

    iget-object v4, p0, Lfi/c;->k:Landroid/media/MediaCodec;
...
.method public final w(Landroid/media/AudioFormat;)V
    ...
    iget v4, p0, Lfi/a;->y:I

    const/4 v5, 0x1

    move-object v1, p1

    invoke-virtual/range {v0 .. v5}, Lkj/b;->d(Landroid/media/AudioFormat;IIII)V

    iget-object p1, p0, Lfi/a;->D:Lkj/b;

    iget-object p1, p1, Lkj/b;->a:Landroid/media/AudioRecord;
    ...
    invoke-direct {v0, p0}, Lm2/t;-><init>(Ljava/lang/Object;)V

    iput-object v0, p1, Lkj/b;->o:Lkj/b$b;

    :cond_0
    return-void

    :cond_1
    iget-object p0, p0, Lfi/a;->D:Lkj/b;
