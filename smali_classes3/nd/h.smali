...
# direct methods
.method public constructor <init>(Lqd/a;Lpd/d;Lpd/c;)V
    .locals 1
    ...
    iput-object p1, p0, Lnd/h;->a:Lqd/a;

    iput-object p3, p0, Lnd/h;->b:Lpd/c;

    new-instance p1, Lnd/h$a;

    new-instance p3, Ljava/lang/ref/WeakReference;

    invoke-direct {p3, p2}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    invoke-direct {p1, p3}, Lnd/h$a;-><init>(Ljava/lang/ref/WeakReference;)V

    iput-object p1, p0, Lnd/h;->c:Lnd/h$a;

    iget-object p1, p2, Lpd/d;->c:Ljava/lang/String;

    iput-object p1, p0, Lnd/h;->d:Ljava/lang/String;

    iget-object p1, p2, Lpd/d;->b:Ljava/lang/String;

    iput-object p1, p0, Lnd/h;->e:Ljava/lang/String;

    iget-object p1, p2, Lpd/d;->e:Ljava/util/Locale;

    iput-object p1, p0, Lnd/h;->f:Ljava/util/Locale;

    iget-object p1, p2, Lpd/d;->d:Ljava/lang/String;

    iput-object p1, p0, Lnd/h;->g:Ljava/lang/String;
...
.method public final call()Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v1, p0, Lnd/h;->b:Lpd/c;

    iget-object v2, p0, Lnd/h;->d:Ljava/lang/String;
    ...
    iget-object v3, v1, Lpd/c;->c:Landroid/util/LruCache;
    ...
    iget-object v1, p0, Lnd/h;->a:Lqd/a;

    iget-object v2, p0, Lnd/h;->e:Ljava/lang/String;

    invoke-interface {v1, v2}, Lqd/a;->a(Ljava/lang/String;)Lvu/b;

    move-result-object v1

    invoke-interface {v1}, Lvu/b;->execute()Lvu/z;

    move-result-object v1

    iget-object v1, v1, Lvu/z;->b:Ljava/lang/Object;
    ...
    iget-object v3, p0, Lnd/h;->b:Lpd/c;
    ...
    iget-object v5, v3, Lpd/c;->c:Landroid/util/LruCache;
    ...
    :cond_1
    :goto_1
    iget-object v1, p0, Lnd/h;->f:Ljava/util/Locale;
    ...
    iget-object v3, p0, Lnd/h;->f:Ljava/util/Locale;
    ...
    invoke-static {v1, v3, v2}, Lnd/c;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Ljava/lang/String;
    ...
    sget-object v2, Lmd/a;->c:Landroid/content/Context;
    ...
    iget-object v3, p0, Lnd/h;->d:Ljava/lang/String;
    ...
    iget-object v1, p0, Lnd/h;->g:Ljava/lang/String;

    :cond_4
    iget-object p0, p0, Lnd/h;->c:Lnd/h$a;
