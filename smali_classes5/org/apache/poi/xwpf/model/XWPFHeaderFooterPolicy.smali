...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    sget-object p1, Lcv/c;->D:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {p0}, Lcv/c;->k()Lcv/e;

    move-result-object p0

    const-string p1, "_x0000_t136"

    invoke-interface {p0, p1}, Lcv/e;->setId(Ljava/lang/String;)V

    invoke-interface {p0}, Lcv/e;->h()V

    invoke-interface {p0}, Lcv/e;->a()V

    invoke-interface {p0}, Lcv/e;->m()V

    invoke-interface {p0}, Lcv/e;->n()V

    invoke-interface {p0}, Lcv/e;->f()Lcv/b;
