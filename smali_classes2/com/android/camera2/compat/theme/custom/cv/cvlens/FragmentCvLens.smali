...
# instance fields
.field private mComponentRunningCvLens:Lh1/x;
...
.method public static synthetic hh(Ljava/lang/String;Lw7/c0;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->lambda$onItemSelected$1(Ljava/lang/String;Lw7/c0;)V
...
.method private static synthetic lambda$onItemSelected$1(Ljava/lang/String;Lw7/c0;)V
    .locals 0

    invoke-interface {p1, p0}, Lw7/c0;->lg(Ljava/lang/String;)V
...
.method private notifyItemChanged(II)V
    ...
    iget-object v4, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh1/x;

    if-eqz v4, :cond_2

    invoke-virtual {v4}, Lh1/x;->getItems()Ljava/util/List;
    ...
    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh1/x;

    if-eqz p1, :cond_4

    invoke-virtual {p1}, Lh1/x;->getItems()Ljava/util/List;
...
.method private onItemSelected(IZ)V
    ...
    .line 14
    :try_start_0
    iget-object p2, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh1/x;

    invoke-virtual {p2}, Lh1/x;->getItems()Ljava/util/List;
    ...
    .line 15
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh1/x;

    invoke-virtual {v1}, Lh1/x;->getItems()Ljava/util/List;
    ...
    invoke-direct {v1, p2, v2}, Lcom/android/camera/features/mode/capture/v;-><init>(Ljava/lang/String;I)V
...
.method public initView(Landroid/view/View;)V
    ...
    iput-object p1, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh1/x;
    ...
    iget-object v2, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh1/x;
    ...
    invoke-direct {v0, p0, v2}, Lcom/android/camera/fragment/beauty/f;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/cv/cvlens/FragmentCvLens;->mComponentRunningCvLens:Lh1/x;

    invoke-virtual {v0}, Lh1/x;->getItems()Ljava/util/List;
...
.method public showCvLens()V
    ...
    invoke-static {v0, v1, v3, v2}, Ln0/h;->d(Landroid/view/View;III)V
