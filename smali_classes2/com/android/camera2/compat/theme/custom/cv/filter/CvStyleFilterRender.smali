...
.method public constructor <init>(Lsa/g;ILw2/f;Landroid/content/Context;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/effect/renders/s;-><init>(Lsa/g;I)V
    ...
    iput-object p3, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lw2/f;
...
.method private updateVertexData(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lsa/g;
    ...
    iget-object p1, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lsa/g;

    check-cast p1, Lsa/a;

    iget-object p1, p1, Lsa/a;->c:Lcom/android/camera/effect/v;
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/o;->mGLCanvas:Lsa/g;
...
.method public draw(Lq2/b;)Z
    .locals 4

    iget v0, p1, Lq2/b;->a:I
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lw2/f;
    ...
    iget v0, p1, Lq2/g;->c:I

    iget-object p1, p1, Lq2/g;->b:Landroid/graphics/Rect;

    sget-object v1, Lbg/b;->a:Landroid/content/Context;
    ...
    iget-object v0, p1, Lq2/c;->c:Lsa/b;

    iget-object p1, p1, Lq2/n;->b:Landroid/graphics/Rect;

    sget-object v1, Lbg/b;->a:Landroid/content/Context;

    invoke-virtual {p0, v0, p1, v1}, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->drawTexture(Lsa/b;Landroid/graphics/Rect;Landroid/content/Context;)V
...
.method public drawTexture(ILandroid/graphics/Rect;Landroid/content/Context;)V
    ...
    .line 17
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lw2/f;

    invoke-virtual {p0, p1, p2, v0, p3}, Lw2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V

    :cond_1
    return-void
.end method

.method public drawTexture(Lsa/b;Landroid/graphics/Rect;Landroid/content/Context;)V
    .locals 1
    ...
    invoke-virtual {p1, v0}, Lsa/b;->f(Lsa/g;)Z
    ...
    .line 4
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/effect/renders/s;->bindTexture(Lsa/b;I)Z
    ...
    .line 9
    iget-object p2, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:Lw2/f;

    invoke-virtual {p1}, Lsa/b;->b()I
    ...
    invoke-virtual {p2, p1, v0, p0, p3}, Lw2/f;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
...
.method public initFilter(Landroid/content/Context;)V
    ...
    iget-boolean v1, v0, Lw2/f;->h:Z

    if-nez v1, :cond_0

    invoke-virtual {v0, p1}, Lw2/f;->a(Landroid/content/Context;)V
...
.method public releaseFilter()V
    ...
    iput-boolean v0, p0, Lw2/f;->h:Z

    iget v1, p0, Lw2/f;->d:I
