...
.method private onLongExposeFinish(Ls4/b;La9/b;)V
    .locals 1

    iget-object p0, p2, La9/b;->k:Ljava/util/ArrayList;
    ...
    iget p1, p1, Lx8/d;->i:I

    invoke-virtual {v0, p1}, Lx8/d;->i(I)V

    goto :goto_0

    :cond_0
    iget-object p0, p2, La9/b;->d:La9/x;

    iget p1, p0, La9/x;->Y:F

    invoke-virtual {p0, p1}, La9/x;->t(F)V

    iget-object p0, p2, La9/b;->d:La9/x;

    iget p1, p0, La9/x;->c0:I

    invoke-virtual {p0, p1}, La9/x;->s(I)V

    iget-object p0, p2, La9/b;->f:La9/q;

    iget p1, p0, La9/q;->T:I

    iput p1, p0, La9/q;->S:I

    const/4 p1, 0x0

    iput p1, p0, La9/q;->U:I
...
.method public handleIntoPattern(Lh1/z1;La9/b;)Z
    .locals 18
    ...
    iput v2, v1, La9/b;->j:F

    iget-object v2, v1, La9/b;->d:La9/x;

    iget v3, v2, Lx8/d;->g:F

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4}, La9/x;->r(FI)V

    iget-object v2, v1, La9/b;->f:La9/q;

    invoke-virtual {v2, v4}, La9/q;->o(I)V
    ...
    iget-object v11, v1, La9/b;->l:Landroid/content/Context;

    iget-object v13, v1, La9/b;->g:La9/r;

    iget-object v14, v1, La9/b;->e:La9/z;

    packed-switch v9, :pswitch_data_0

    :pswitch_0
    iget-object v0, v1, La9/b;->d:La9/x;
    ...
    :pswitch_1
    iget-object v6, v1, La9/b;->c:La9/s;
    ...
    invoke-virtual {v6, v10, v7, v5, v4}, Lx8/d;->l(FFII)V

    iget-object v6, v1, La9/b;->d:La9/x;

    invoke-virtual {v6, v3, v5}, La9/x;->r(FI)V

    iget-object v6, v1, La9/b;->d:La9/x;

    iget v7, v1, La9/b;->j:F

    mul-float/2addr v7, v10

    invoke-virtual {v6, v7, v12, v5, v4}, Lx8/d;->l(FFII)V

    invoke-virtual {v14, v3, v15, v5, v4}, Lx8/d;->l(FFII)V

    invoke-virtual {v14}, La9/z;->o()V

    iget v0, v0, Lh1/z1;->e:I

    invoke-static {v0, v4}, Lak/c;->y(IZ)Z

    move-result v0

    if-eqz v0, :cond_4

    iget-object v0, v1, La9/b;->f:La9/q;

    const v5, 0x2effffff

    const/16 v6, 0x2e

    invoke-virtual {v0, v3, v15, v5, v6}, Lx8/d;->l(FFII)V
    ...
    invoke-virtual {v13, v0}, Lx8/d;->i(I)V

    iput v4, v13, Lx8/d;->e:I

    const v0, 0x7f0806c1

    invoke-virtual {v13, v0, v11}, La9/r;->p(ILandroid/content/Context;)V
    ...
    invoke-virtual {v9, v15}, Lbh/b;->v(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-virtual {v14, v3, v6, v5, v4}, Lx8/d;->l(FFII)V
    ...
    invoke-virtual {v0, v3, v6, v5, v7}, Lx8/d;->l(FFII)V
    ...
    :cond_8
    iget-object v0, v1, La9/b;->c:La9/s;
    ...
    invoke-virtual {v0, v10, v9, v7, v4}, Lx8/d;->l(FFII)V

    iget-object v0, v1, La9/b;->d:La9/x;

    invoke-virtual {v0, v3, v6}, La9/x;->r(FI)V

    iget-object v0, v1, La9/b;->d:La9/x;

    iget v6, v1, La9/b;->j:F

    const v7, -0x1ee4e5

    const/16 v9, 0xff

    invoke-virtual {v0, v6, v12, v7, v9}, Lx8/d;->l(FFII)V

    const/high16 v0, 0x40400000    # 3.0f

    invoke-virtual {v14, v3, v0, v5, v4}, Lx8/d;->l(FFII)V

    invoke-virtual {v14}, La9/z;->o()V

    iget-object v5, v1, La9/b;->f:La9/q;

    const/16 v6, 0x33

    invoke-virtual {v5, v3, v0, v8, v6}, Lx8/d;->l(FFII)V
    ...
    :goto_8
    invoke-virtual {v0, v4}, La9/q;->o(I)V

    goto/16 :goto_f

    :pswitch_3
    iget-boolean v9, v0, Lh1/z1;->d:Z
    ...
    :cond_b
    iget-object v9, v1, La9/b;->c:La9/s;
    ...
    invoke-virtual {v9, v10, v11, v7, v4}, Lx8/d;->l(FFII)V

    iget-object v7, v1, La9/b;->d:La9/x;

    invoke-virtual {v7, v3, v6}, La9/x;->r(FI)V
    ...
    invoke-virtual {v0, v3, v6, v8, v5}, Lx8/d;->l(FFII)V
    ...
    iget v9, v1, La9/b;->j:F

    mul-float/2addr v9, v10

    invoke-virtual {v7, v9, v12, v6, v4}, Lx8/d;->l(FFII)V
...
.method public handleLongExposeCaptureCompleted(Ls4/b;La9/b;)Z
    .locals 2

    iget p0, p1, Ls4/b;->a:I
    ...
    :cond_0
    iget-boolean p0, p1, Ls4/b;->k:Z

    if-eqz p0, :cond_1

    iget-object p0, p2, La9/b;->f:La9/q;

    invoke-virtual {p0, v1}, La9/q;->s(I)V
...
.method public handlePrepareRecording(Ls4/b;La9/b;)Z
    .locals 16
    ...
    :pswitch_0
    iget-boolean v0, v0, Ls4/b;->e:Z

    if-eqz v0, :cond_0

    iget-object v0, v1, La9/b;->d:La9/x;

    iget v2, v0, La9/x;->Y:F

    mul-float/2addr v2, v14

    invoke-virtual {v0, v2}, La9/x;->t(F)V

    iget-object v0, v1, La9/b;->d:La9/x;

    invoke-virtual {v0, v13}, La9/x;->s(I)V

    iget-object v0, v1, La9/b;->d:La9/x;

    iget v2, v0, Lx8/d;->g:F

    invoke-virtual {v0, v2}, La9/x;->u(F)V

    iget-object v0, v1, La9/b;->d:La9/x;

    invoke-virtual {v0, v7}, La9/x;->v(F)V

    iget-object v0, v1, La9/b;->c:La9/s;

    invoke-virtual {v0, v8}, La9/s;->p(Z)V

    iget-object v0, v1, La9/b;->c:La9/s;

    const/4 v2, 0x0

    iput v2, v0, La9/s;->I:F
    ...
    invoke-virtual {v0, v2}, Lx8/d;->k(F)V
    ...
    iget-object v2, v1, La9/b;->c:La9/s;

    iget v3, v2, Lx8/d;->A:F
    ...
    invoke-virtual {v2, v0}, Lx8/d;->m(F)Lx8/d;

    iget-object v0, v1, La9/b;->c:La9/s;

    invoke-virtual {v0}, La9/s;->o()V

    iget-object v0, v1, La9/b;->k:Ljava/util/ArrayList;

    iget-object v1, v1, La9/b;->c:La9/s;
    ...
    invoke-virtual {v0, v13}, La9/s;->p(Z)V
    ...
    invoke-virtual {v0, v2}, La9/q;->q(F)V
    ...
    iget-object v1, v1, La9/b;->f:La9/q;
    ...
    :cond_1
    :pswitch_1
    iget-boolean v2, v0, Ls4/b;->l:Z

    if-eqz v2, :cond_2

    invoke-virtual/range {p0 .. p2}, Lcom/android/camera2/compat/theme/custom/cv/MiThemeOperationBottomCV;->onLongExposePrepare(Ls4/b;La9/b;)V

    goto/16 :goto_2

    :cond_2
    iget-boolean v2, v0, Ls4/b;->p:Z
    ...
    iput v6, v2, La9/q;->U:I

    iget v3, v2, La9/q;->b0:F

    iput v3, v2, La9/q;->a0:F

    iput v14, v2, La9/q;->c0:F

    invoke-virtual {v2}, La9/q;->h()V

    :cond_3
    iget-boolean v0, v0, Ls4/b;->n:Z
    ...
    iput-object v9, v0, La9/q;->Q:Ljava/lang/String;
    ...
    invoke-virtual {v0, v13}, Lx8/d;->i(I)V
    ...
    iget-object v0, v1, La9/b;->g:La9/r;

    invoke-virtual {v0, v13}, Lx8/d;->i(I)V

    iget-object v0, v1, La9/b;->g:La9/r;

    iput-boolean v8, v0, Lx8/d;->b:Z

    iget-object v0, v0, La9/r;->K:Landroid/graphics/Paint;
    ...
    invoke-virtual {v0, v2}, La9/r;->q(F)V
    ...
    iget-object v1, v1, La9/b;->k:Ljava/util/ArrayList;
    ...
    :cond_7
    iget-boolean v2, v0, Ls4/b;->d:Z

    if-eqz v2, :cond_8

    iget-object v0, v1, La9/b;->d:La9/x;

    invoke-virtual {v0, v4}, Lx8/d;->j(I)V
    ...
    invoke-virtual {v0, v6}, La9/x;->i(I)V
    ...
    invoke-virtual {v0, v2}, Lx8/d;->j(I)V
    ...
    iget-boolean v0, v0, Ls4/b;->k:Z

    if-eqz v0, :cond_11

    iget-object v0, v1, La9/b;->d:La9/x;

    iput-boolean v13, v0, La9/x;->Q:Z
...
.method public handleScaleDown(La9/b;)Z
    .locals 2

    iget-object p0, p1, La9/b;->c:La9/s;
    ...
    invoke-virtual {p0, v0}, Lx8/d;->m(F)Lx8/d;
    ...
    iget v0, p0, La9/x;->Y:F

    mul-float/2addr v0, v1

    invoke-virtual {p0, v0}, La9/x;->t(F)V

    iget-object p0, p1, La9/b;->f:La9/q;

    iget p1, p0, Lx8/d;->o:I

    if-eqz p1, :cond_0

    iget p1, p0, Lx8/d;->g:F

    mul-float/2addr p1, v1

    invoke-virtual {p0, p1}, Lx8/d;->m(F)Lx8/d;
...
.method public handleStartRecording(Ls4/b;La9/b;)Z
    .locals 3
...
.method public handleStopRecording(Ls4/b;La9/b;)Z
    .locals 5
    ...
    :cond_2
    :pswitch_0
    invoke-direct {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/cv/MiThemeOperationBottomCV;->onLongExposeFinish(Ls4/b;La9/b;)V

    goto/16 :goto_2

    :cond_3
    :pswitch_1
    iget-object p0, p2, La9/b;->c:La9/s;

    iget p1, p0, Lx8/d;->h:F

    invoke-virtual {p0, p1}, Lx8/d;->k(F)V
    ...
    invoke-virtual {p0, p1}, La9/x;->u(F)V
    ...
    invoke-virtual {p0, v4}, La9/x;->i(I)V
    ...
    invoke-virtual {p0, p1}, La9/x;->w(F)V

    iget-object p0, p2, La9/b;->d:La9/x;

    invoke-virtual {p0, v2}, La9/x;->v(F)V

    goto/16 :goto_2

    :cond_5
    :pswitch_2
    iget-boolean p0, p1, Ls4/b;->c:Z
    ...
    invoke-virtual {p0, p1}, La9/x;->m(F)Lx8/d;
    ...
    iget p2, p1, Lx8/d;->g:F

    invoke-virtual {p1, p2}, Lx8/d;->m(F)Lx8/d;
...
.method public handleSuspendShutterIntoPattern(Lh1/z1;La9/h0;)Z
    .locals 4
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    iget p0, p1, Lh1/z1;->a:I

    invoke-static {p0}, Lcom/android/camera/module/w0;->a(I)Z
    ...
    invoke-virtual {p0, v1, v2, v0, v3}, Lx8/d;->l(FFII)V

    iget-object p0, p2, La9/b;->d:La9/x;

    invoke-virtual {p0, p1}, La9/x;->i(I)V
    ...
    invoke-virtual {p0, v1, p1, p2, v0}, Lx8/d;->l(FFII)V
...
.method public handleSuspendShutterScaleDown(La9/h0;)Z
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "supportSuspendShutter"
...
.method public handleThemeChanged(ZLh1/z1;La9/b;)Z
    .locals 4

    iget p0, p2, Lh1/z1;->a:I
    ...
    :cond_4
    iget-object v3, p3, La9/b;->c:La9/s;

    invoke-virtual {v3, v2}, Lx8/d;->j(I)V

    iget-object v2, p3, La9/b;->c:La9/s;
    ...
    iget-object v2, p3, La9/b;->d:La9/x;

    iget v3, v2, La9/x;->Z:F

    invoke-virtual {v2, v3, v1}, La9/x;->r(FI)V

    iget-object v1, p3, La9/b;->d:La9/x;

    invoke-virtual {v1, p2}, La9/x;->s(I)V

    invoke-virtual {v1}, La9/x;->h()V

    iget-object v1, p3, La9/b;->f:La9/q;

    invoke-virtual {v1, v0}, Lx8/d;->j(I)V

    iget-object v0, p3, La9/b;->f:La9/q;

    iget v0, v0, Lx8/d;->o:I
    ...
    :goto_3
    invoke-virtual {v0, p2}, La9/q;->o(I)V
...
.method public onLongExposePrepare(Ls4/b;La9/b;)V
    .locals 2
    ...
    invoke-virtual {p0, p1}, La9/s;->p(Z)V

    iget-object p0, p2, La9/b;->c:La9/s;

    iget v1, p0, Lx8/d;->g:F

    mul-float/2addr v1, v0

    invoke-virtual {p0, v1}, Lx8/d;->m(F)Lx8/d;
    ...
    iget v1, p0, La9/x;->Y:F

    mul-float/2addr v1, v0

    invoke-virtual {p0, v1}, La9/x;->t(F)V
    ...
    iput-boolean p1, p0, La9/x;->Q:Z

    iget-object p0, p2, La9/b;->k:Ljava/util/ArrayList;

    iget-object p1, p2, La9/b;->f:La9/q;
...
.method public playPickersAnimation(Lt4/z;)V
    .locals 0

    invoke-virtual {p1}, Lt4/z;->d()V
