...
.method public static synthetic a(Lp5/l;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;->lambda$updateData$1(Lp5/l;Landroid/view/View;)V

    return-void
.end method

.method public static synthetic b(Ljava/util/List;Lp5/l;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;->lambda$updateData$0(Ljava/util/List;Lp5/l;)V

    return-void
.end method

.method public static synthetic c(Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;ILp5/l;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/StartExtraTopBarSecondPartLayout;->lambda$updateData$2(ILp5/l;)V

    return-void
.end method

.method private static lambda$updateData$0(Ljava/util/List;Lp5/l;)V
    .locals 2

    iget v0, p1, Lp5/l;->a:I
...
.method private static lambda$updateData$1(Lp5/l;Landroid/view/View;)V
    .locals 1
    ...
    :cond_0
    iget-object p0, p0, Lp5/l;->i:Landroid/view/View$OnClickListener;
...
.method private lambda$updateData$2(ILp5/l;)V
    .locals 3
    ...
    iget-object v1, p2, Lp5/l;->g:Lp5/l$c;

    invoke-interface {v1, p1}, Lp5/l$c;->updateResource(I)Lp5/m;
    ...
    invoke-virtual {v1, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/ExtraTopBarImageViewHolder;->updateView(Lp5/m;)V
...
.method public notifyItemChanged(I)V
    ...
    iget-object v2, v2, Lp5/l;->g:Lp5/l$c;

    invoke-interface {v2, v3}, Lp5/l$c;->updateResource(I)Lp5/m;
    ...
    invoke-virtual {v3, v2}, Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/ExtraTopBarImageViewHolder;->updateView(Lp5/m;)V

    iget v2, v2, Lp5/m;->j:I
...
.method public updateData(ILjava/util/List;Landroid/view/View$OnClickListener;Lcom/android/camera2/compat/theme/custom/mm/top/extratopbar/IExtraTopBarUIConfig;)V
    ...
    new-instance p4, Lm2/p0;

    const/4 v0, 0x2

    invoke-direct {p4, p3, v0}, Lm2/p0;-><init>(Ljava/util/ArrayList;I)V
    ...
    new-instance p3, Lcom/android/camera/fragment/h0;

    const/4 p4, 0x1

    invoke-direct {p3, p0, p1, p4}, Lcom/android/camera/fragment/h0;-><init>(Ljava/lang/Object;II)V
