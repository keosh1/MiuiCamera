...
.field private mManuallyListener:Lg5/q;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lg5/q;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera/fragment/manually/adapter/b;-><init>()V

    iput-object p3, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Lg5/q;
...
.method public initDataList(Lg9/d;Ljava/util/List;Ljava/lang/String;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ui/b$a;->updateConfig(Lg9/d;)V
...
.method public onCustomWheelScroll(Ljava/lang/String;Z)V
    ...
    .line 9
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Lg5/q;
    ...
    .line 10
    invoke-interface {v1, p1, v0, v2}, Lg5/q;->onZoomItemSlideOn(IZI)V

    .line 11
    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Lg5/q;

    const/4 v0, 0x3

    invoke-interface {p1, p2, v0}, Lg5/q;->onManuallyDataChanged(Ljava/lang/String;I)V
...
.method public onPositionSelect(Landroid/view/View;FII)V
    ...
    .line 6
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Lg5/q;

    if-eqz v0, :cond_0

    .line 7
    invoke-interface {v0, p1, p3, p4}, Lg5/q;->onZoomItemSlideOn(IZI)V
    ...
    invoke-interface {p1, p2, p3}, Lg5/q;->onManuallyDataChanged(Ljava/lang/String;I)V
