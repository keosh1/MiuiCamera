...
.method public static synthetic B9(Lcom/android/camera/module/pano/PanoramaModule;Lio/reactivex/FlowableEmitter;Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 0
...
.method public static synthetic D9(Lcom/android/camera/module/pano/PanoramaModule;)V
    .locals 0
...
.method public static synthetic Da(Ljava/util/concurrent/atomic/AtomicReference;)V
    .locals 0
...
.method public static synthetic Va(Lw7/e3;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$onSaveCompleted$8(Lw7/e3;)V
...
.method private addImageAsApplication(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-static {v13}, Lic/b;->H1(I)Z
    ...
    :try_start_2
    sget-object v10, Lsd/a;->a:Ljava/nio/charset/Charset;
    :try_end_2
    ...
    invoke-direct {v10, v0}, Lsd/b;-><init>(Ljava/io/FileDescriptor;)V
    :try_end_3
    ...
    invoke-static/range {v9 .. v14}, Ll8/e;->h(Lsd/b;Landroid/location/Location;JI[B)V

    invoke-virtual {v0}, Lsd/b;->L()V
    :try_end_4
    ...
    invoke-static/range {p2 .. p2}, La0/y;->l(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v2}, Lsd/b;-><init>(Ljava/lang/String;)V
    :try_end_9
    ...
    invoke-static {v0, v2, v9}, Landroidx/activity/n;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v2}, La0/c0;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-wide v2, v1, Lgg/g;->i:J

    iput v11, v1, Lgg/g;->a:I

    iput-boolean v12, v1, Lgg/g;->b:Z

    iput v12, v1, Lgg/g;->c:I

    iput-object v9, v1, Lgg/g;->g:Lcom/android/camera/fragment/beauty/r;

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/module/BaseModule;->getModuleIndex()I

    move-result v2

    iput v2, v1, Lgg/g;->l:I
    ...
    iput-boolean v2, v1, Lgg/g;->m:Z

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/module/BaseModule;->getCameraManager()Lu6/j;

    move-result-object v2

    invoke-interface {v2}, Lu6/j;->i()I

    move-result v2

    iput v2, v1, Lgg/g;->n:I
    ...
    iput v2, v1, Lgg/g;->o:I

    invoke-virtual {v8, v1}, Lcom/android/camera/module/BaseModule;->trackPictureTaken(Lgg/g;)V

    iget-object v1, v8, Lcom/android/camera/module/BaseModule;->mCallback:Lcom/android/camera/module/v0;
    ...
    invoke-interface {v1, v0, v12, v13, v12}, Lcom/android/camera/module/v0;->ma(Landroid/net/Uri;ZLjava/lang/String;Z)V

    invoke-static {}, Lcom/xiaomi/camera/basic/Global;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-static {v2, v0}, La0/d7;->e(Landroid/content/Context;Landroid/net/Uri;)La0/d7;
    ...
    invoke-interface {v1, v2, v12, v12}, Lcom/android/camera/module/v0;->cf(La0/d7;ZZ)V
...
.method public static synthetic ba(Lcom/android/camera/module/pano/PanoramaModule;ZLw7/o2;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$onStopShooting$6(ZLw7/o2;)V
...
.method private createEngine(D)Z
    ...
    invoke-static {v4, v3}, La0/w3;->a(ILjava/util/Optional;)Ljava/util/Optional;
    ...
    invoke-static {v3}, Lcom/android/camera/data/data/h0;->K(Landroid/content/Context;)Z
...
.method private getQuality()I
    ...
    invoke-virtual {p0, v0}, La0/b5;->a(Z)I
...
.method public static synthetic j9(Lcom/android/camera/module/v0;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$addImageAsApplication$9(Lcom/android/camera/module/v0;)V

    return-void
.end method

.method private static synthetic lambda$addImageAsApplication$9(Lcom/android/camera/module/v0;)V
    .locals 0
...
.method private static synthetic lambda$launchShootingTask$4(Ljava/lang/Throwable;)V
    ...
    invoke-static {p0, v0}, La0/v;->j(Ljava/lang/Throwable;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method private static synthetic lambda$onSaveCompleted$8(Lw7/e3;)V
    .locals 0
...
.method private synthetic lambda$onStopShooting$6(ZLw7/o2;)V
    .locals 1
    ...
    invoke-interface {p2, p1}, Lw7/o2;->x2(I)V

    goto :goto_0

    :cond_0
    invoke-interface {p2}, Lw7/o2;->Ae()V
    ...
    invoke-interface {p2}, Lw7/o2;->gg()V
...
.method private synthetic lambda$startShooting$0(Lw7/o2;)V
    .locals 2
...
.method private static synthetic lambda$stopShooting$5(Lw7/h2;)V
    .locals 3
    ...
    invoke-interface {p0, v0}, Lw7/h2;->oc(Landroid/graphics/Bitmap;)V
...
.method private launchShootingTask()Lio/reactivex/disposables/Disposable;
    ...
    new-instance v4, La0/i4;

    invoke-direct {v4, v0, v2}, La0/i4;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v1, v4}, Lio/reactivex/Flowable;->doFinally(Lio/reactivex/functions/Action;)Lio/reactivex/Flowable;
...
.method public static synthetic o9(Lcom/android/camera/module/pano/PanoramaModule;)V
    .locals 0
...
.method private onSaveCompleted()V
    ...
    invoke-static {v4, v1}, La0/z;->n(ILjava/util/Optional;)V
    ...
    iget-object v5, p0, Lcom/android/camera/module/BaseModule;->mModuleStateMgr:Lu6/f;

    invoke-interface {v5}, Lu6/f;->O0()Z
    ...
    invoke-interface {v4}, Lcom/android/camera/module/v0;->Y6()V
...
.method private onStopShooting(Z)V
    ...
    new-instance v1, Lc7/w0;

    const/4 v2, 0x1

    invoke-direct {v1, p0, p1, v2}, Lc7/w0;-><init>(Ljava/lang/Object;ZI)V
...
.method private savePanoramaFile([Landroid/net/Uri;Ljava/lang/String;II)Z
    ...
    invoke-static {v12, v1}, Lak/g;->q(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private savePanoramaPicture()V
    ...
    invoke-virtual {v1, v0}, Lwg/c;->i(I)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0
...
.method private startBurstRequest(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/FlowableEmitter;)V
    ...
    invoke-virtual {v1}, L섘섔섖셕섖섒셕섟섞섍섒섘섞셕섘섔섖섖섔섕셕세섔섖섖섔섕;->e2()Z
    ...
    iput-object v3, v1, Lca/x;->a:Landroid/location/Location;
    ...
    invoke-virtual {v1, v2}, Lca/w;->J(I)V
    ...
    invoke-static {v2}, Lx6/p;->a(Lu6/j;)Landroid/util/Size;

    move-result-object v2

    iget-object v1, v1, Lca/w;->a:Lca/x;

    iget-object v4, v1, Lca/x;->H:Landroid/util/Size;
    ...
    iput-object v2, v1, Lca/x;->H:Landroid/util/Size;
    ...
    invoke-virtual {v1, v2}, Lca/w;->A(Z)V
    ...
    iget-boolean v2, v1, Lca/x;->n1:Z

    if-eqz v2, :cond_3

    iput-boolean v3, v1, Lca/x;->n1:Z
    ...
    invoke-virtual {v1, v2}, Lca/w;->U(I)V
    ...
    invoke-virtual {p0, p2, v1, p1}, Lca/a;->h(ILca/a$k;Ll8/l;)V
...
.method private startSaveTask()Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct {v1, p0, v2}, Lc5/a;-><init>(Ljava/lang/Object;I)V
...
.method public static synthetic v9(Lcom/android/camera/module/pano/PanoramaModule;Lw7/o2;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$startShooting$0(Lw7/o2;)V

    return-void
.end method

.method public static synthetic y9(Lw7/h2;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/pano/PanoramaModule;->lambda$stopShooting$5(Lw7/h2;)V
...
.method public stopShooting(ZZ)V
    ...
    invoke-interface {p1}, Lu6/j;->N0()Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2}, Lca/a;->z1(Z)V
