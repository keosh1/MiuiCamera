...
.field private mLastMuxer:Lw6/f;

.field private mMediaAudioEncoder:Lw6/d;

.field private final mMediaEncoderListener:Lw6/e$a;

.field private mMediaVideoEncoder:Lw6/g;

.field private mMuxer:Lw6/f;
...
.field private mRenderEngine:Lcom/android/camera/ui/y0;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/camera/module/FunModule;->mMediaEncoderListener:Lw6/e$a;
...
.method public static synthetic Jc(Lw7/q1;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/FunModule;->lambda$onSingleTapUp$1(Lw7/q1;)V
...
.method public static synthetic dc(Lcom/android/camera/module/FunModule;Landroidx/fragment/app/FragmentActivity;)V
    .locals 0
...
.method private initializeRecorder()Z
    ...
    invoke-direct {v3, v1}, Lw6/f;-><init>(Landroid/net/Uri;)V

    iput-object v3, p0, Lcom/android/camera/module/FunModule;->mMuxer:Lw6/f;
    ...
    invoke-static {v6, v5, v3, v4}, Lcom/android/camera/module/video/b0;->c(ILjava/lang/String;J)Ljava/lang/String;
    ...
    invoke-direct {v1, v3}, Lw6/f;-><init>(Ljava/lang/String;)V

    iput-object v1, p0, Lcom/android/camera/module/FunModule;->mMuxer:Lw6/f;
    ...
    iget-object v5, v3, Lso/g;->h:Landroid/opengl/EGLContext;

    sget-object v7, Lxo/a;->a:Lxo/a$a;

    const/4 v8, 0x0

    iget-object v9, p0, Lcom/android/camera/module/FunModule;->mMuxer:Lw6/f;

    iget-object v10, p0, Lcom/android/camera/module/FunModule;->mMediaEncoderListener:Lw6/e$a;
    ...
    invoke-direct/range {v4 .. v12}, Lw6/g;-><init>(Landroid/opengl/EGLContext;Lxo/a;Lxo/a;Ljava/lang/String;Lw6/f;Lw6/e$a;II)V

    iput-object v1, p0, Lcom/android/camera/module/FunModule;->mMediaVideoEncoder:Lw6/g;

    new-instance v1, Lw6/d;

    iget-object v3, p0, Lcom/android/camera/module/FunModule;->mMuxer:Lw6/f;

    iget-object v4, p0, Lcom/android/camera/module/FunModule;->mMediaEncoderListener:Lw6/e$a;

    invoke-direct {v1, v3, v4}, Lw6/d;-><init>(Lw6/f;Lw6/e$a;)V

    iput-object v1, p0, Lcom/android/camera/module/FunModule;->mMediaAudioEncoder:Lw6/d;

    iget-object v3, p0, Lcom/android/camera/module/FunModule;->mMediaVideoEncoder:Lw6/g;

    iget v4, p0, Lcom/android/camera/module/FunModule;->mSpeed:F

    iput v4, v3, Lw6/e;->d:F

    iput v4, v1, Lw6/e;->d:F

    iget-object v1, p0, Lcom/android/camera/module/FunModule;->mMuxer:Lw6/f;

    iget-object v3, v1, Lw6/f;->e:Lw6/e;

    if-eqz v3, :cond_4

    invoke-virtual {v3}, Lw6/e;->e()V

    :cond_4
    iget-object v1, v1, Lw6/f;->f:Lw6/e;

    if-eqz v1, :cond_5

    invoke-virtual {v1}, Lw6/e;->e()V
    ...
    iget-object v0, p0, Lcom/android/camera/module/FunModule;->mMuxer:Lw6/f;
    ...
    iget-object v0, v0, Lw6/f;->a:Landroid/media/MediaMuxer;
...
.method private synthetic lambda$notifyFirstFrameArrived$2()V
    ...
    sget-object v0, Lcom/xiaomi/push/service/l;->p:[I
...
.method public static synthetic lc(Lcom/android/camera/module/FunModule;)V
    .locals 0
...
.method private onStartRecorderSucceed()V
    ...
    invoke-interface {v1}, Laa/a;->t2()V
...
.method private releaseLastMediaRecorder()V
    ...
    iget-object v2, p0, Lcom/android/camera/module/FunModule;->mLastMuxer:Lw6/f;
    ...
    iget-object v0, p0, Lcom/android/camera/module/FunModule;->mLastMuxer:Lw6/f;
    ...
    iput-object v0, p0, Lcom/android/camera/module/FunModule;->mLastMuxer:Lw6/f;
...
.method private startRecorder()Z
    ...
    invoke-static {v0}, Lcom/android/camera/data/data/k;->C0(I)Z

    move-result v0

    iget-object v1, p0, Lcom/android/camera/module/FunModule;->mMuxer:Lw6/f;

    invoke-virtual {v1, v2, v3, v0}, Lw6/f;->b(JZ)Z
...
.method private updateFpsRange()V
    ...
    invoke-virtual {v0, v2}, Lca/w;->a0(Landroid/util/Range;)V
...
.method private updatePictureAndPreviewSize()V
    ...
    invoke-static {v1, v2, v0}, Lcom/android/camera/data/data/k;->F(IILca/c;)F
    ...
    invoke-static {v0, v1}, Lcom/android/camera/data/data/o;->s(II)I
...
.method private updateVideoStabilization()V
    ...
    invoke-static {v5}, Lca/d;->Q0(Lca/c;)Z
    ...
    invoke-virtual {p0, v3, v3}, Ld9/f;->o(FF)V
    ...
    invoke-virtual {v0, v1, v1}, Ld9/f;->o(FF)V
...
.method public executeSaveTask(Z)V
    ...
    :cond_2
    invoke-virtual {v2, v0, v1}, Ll8/l;->c(Ll8/b;Z)V
    ...
    invoke-virtual {v1, v0, v5}, Ll8/l;->d(Ll8/b0;Z)Landroid/net/Uri;
...
.method public onActive()V
    ...
    iput-object v0, p0, Lcom/android/camera/module/FunModule;->mRenderEngine:Lcom/android/camera/ui/y0;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-interface {v0}, Lw7/p3;->isShow()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-interface {v0}, Lw7/p3;->Gb()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-interface {v0}, Lw7/p3;->Ac()V
...
.method public onPreviewSessionSuccess(Landroid/hardware/camera2/CameraCaptureSession;)V
    ...
    sget-object p1, Lcom/xiaomi/push/service/l;->o:[I
...
.method public onShineChanged(I)V
    ...
    invoke-interface {p0}, Lw7/q1;->E3()V
...
.method public onShutterButtonClick(I)Z
    ...
    invoke-virtual {v1}, Ld7/d;->b()V

    invoke-virtual {v1}, Ld7/d;->a()I
    ...
    :cond_3
    invoke-interface {v1, p0}, Lw7/o2;->Qd(Lcom/android/camera/module/u0;)V
    ...
    invoke-interface {v3}, Lcom/android/camera/module/v0;->O7()V
    ...
    invoke-interface {v1, p1}, Lu6/f;->z0(I)V
...
.method public onSurfaceTextureUpdated(Lsa/g;Lq2/b;)V
    ...
    :try_start_0
    iget-object p1, p0, Lcom/android/camera/module/FunModule;->mMediaVideoEncoder:Lw6/g;
    ...
    invoke-virtual {p1, p2}, Lw6/g;->j(Lq2/e;)V
...
.method public startPreview()V
    ...
    invoke-static {v0}, Ld1/w0;->g(Landroid/util/Size;)I
...
.method public stopVideoRecording(Z)Z
    ...
    iget-object v1, v0, Lcom/android/camera/module/FunModule;->mMuxer:Lw6/f;
    ...
    invoke-static {v1}, Lcom/android/camera/module/video/b0;->d(Ljava/lang/String;)V
    ...
    iget-object v7, v0, Lcom/android/camera/module/VideoBase;->mUserRecordSetting:Lcom/android/camera/module/video/z;

    iget-object v10, v7, Lcom/android/camera/module/video/z;->r:Ljava/lang/String;

    iget-object v7, v7, Lcom/android/camera/module/video/z;->n:Landroid/content/ContentValues;
    ...
    iget-object v7, v1, Lcom/android/camera/module/video/z;->r:Ljava/lang/String;
    ...
    :cond_6
    :goto_1
    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/module/BaseModule;->getZoomManager()Laa/a;

    move-result-object v1

    invoke-interface {v1}, Laa/a;->H2()V
    ...
    iget-object v12, v0, Lcom/android/camera/module/BaseModule;->mCameraManager:Lu6/j;

    invoke-interface {v12}, Lu6/j;->L()Lca/w;

    move-result-object v12

    iget-object v12, v12, Lca/w;->a:Lca/x;

    iget v12, v12, Lca/x;->g0:I

    iget-object v13, v0, Lcom/android/camera/module/VideoBase;->mUserRecordSetting:Lcom/android/camera/module/video/z;

    iget-object v13, v13, Lcom/android/camera/module/video/z;->u:Lcom/android/camera/fragment/beauty/r;

    div-long/2addr v3, v8

    iget-object v8, v0, Lcom/android/camera/module/BaseModule;->mAppStateMgr:Lu6/b;

    move-object v9, v8

    check-cast v9, Lu6/a;

    iget-boolean v9, v9, Lu6/a;->e:Z

    check-cast v8, Lu6/a;

    iget v8, v8, Lu6/a;->g:I
    ...
    invoke-static {v15, v14}, Lcom/android/camera/data/data/o;->Y(ILca/c;)Z
    ...
    iput-boolean v1, v15, Lsj/b;->a:Z

    iput v7, v15, Lsj/b;->b:I

    iput v10, v15, Lsj/b;->c:I

    iput-boolean v2, v15, Lsj/b;->d:Z

    const-string v1, "fun"

    iput-object v1, v15, Lsj/b;->e:Ljava/lang/String;

    iput v11, v15, Lsj/b;->f:I

    iput v12, v15, Lsj/b;->g:I

    const/16 v1, 0x1e

    iput v1, v15, Lsj/b;->h:I

    iput v2, v15, Lsj/b;->i:I

    iput-object v13, v15, Lsj/b;->j:Lcom/android/camera/fragment/beauty/r;

    iput-wide v3, v15, Lsj/b;->k:J

    iput-boolean v2, v15, Lsj/b;->l:Z

    const/4 v1, 0x0

    iput-object v1, v15, Lsj/b;->n:[Ljava/lang/String;

    iput-boolean v2, v15, Lsj/b;->o:Z

    iput-boolean v9, v15, Lsj/b;->p:Z

    iput v8, v15, Lsj/b;->q:I

    iput-boolean v14, v15, Lsj/b;->r:Z

    invoke-static {v10}, Lrj/a;->g(I)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v15, Lsj/b;->w:Ljava/lang/String;

    invoke-static {v15}, Lk8/a;->w0(Lsj/b;)V
    ...
    check-cast v1, Lw7/q1;

    const/4 v3, 0x2

    invoke-interface {v1, v3}, Lw7/q1;->Ce(I)V
    ...
    invoke-interface {v1, v2}, Laa/a;->k3(Z)V
