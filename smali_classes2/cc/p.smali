...
.method public final b(Lnb/c0;Lnb/d;)Lnb/n;
    ...
    sget-object p2, Leb/k$c;->d:Leb/k$c;
    ...
    :goto_0
    iget-boolean p2, p0, Lcc/p;->c:Z

    if-eq p1, p2, :cond_2

    new-instance p0, Lcc/p;

    invoke-direct {p0, p1}, Lcc/p;-><init>(Z)V
...
.method public final bridge synthetic h(Lfb/e;Lnb/c0;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p3, p1}, Lcc/p;->q(Ljava/net/InetAddress;Lfb/e;)V
...
.method public final i(Ljava/lang/Object;Lfb/e;Lnb/c0;Lxb/g;)V
    ...
    iput-object v0, p3, Llb/b;->b:Ljava/lang/Class;

    invoke-virtual {p4, p2, p3}, Lxb/g;->e(Lfb/e;Llb/b;)Llb/b;

    move-result-object p3

    invoke-virtual {p0, p1, p2}, Lcc/p;->q(Ljava/net/InetAddress;Lfb/e;)V

    invoke-virtual {p4, p2, p3}, Lxb/g;->f(Lfb/e;Llb/b;)Llb/b;

    return-void
.end method

.method public final q(Ljava/net/InetAddress;Lfb/e;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
