...
# direct methods
.method public constructor <init>(Lwg/t$e;Lcom/xiaomi/engine/BufferFormat;)V
    .locals 2

    invoke-direct {p0, p1, p2}, Lwg/n;-><init>(Lwg/t$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object p1, p0, Lwg/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object p1, p0, Lwg/b;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v1, p0, Lwg/n;->l:Ljava/lang/String;
    ...
    iput-object p1, p0, Lwg/b;->s:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, Lwg/n;->l:Ljava/lang/String;
...
.method public static E(Landroid/media/Image;Lwg/n$a;)V
    .locals 0
    ...
    check-cast p1, Lwg/t$e;

    invoke-virtual {p1, p0}, Lwg/t$e;->e(Landroid/media/Image;)V
...
.method public final A(JZ)V
    ...
    :try_start_0
    iget-object p0, p0, Lwg/b;->v:Lgg/j;

    if-eqz p0, :cond_0

    iget-object p0, p0, Lgg/j;->a:Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_1
    iget-object p0, p0, Lwg/b;->u:Lcom/xiaomi/engine/TaskSession;
...
.method public final B(J)V
    ...
    iget-object v2, p0, Lwg/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndDecrement()I

    invoke-virtual {p0}, Lwg/b;->G()V

    iget-object v2, p0, Lwg/n;->n:Ljava/lang/Object;
    ...
    iget-object v1, p0, Lwg/b;->B:Landroid/util/LongSparseArray;

    invoke-virtual {v1, p1, p2}, Landroid/util/LongSparseArray;->remove(J)V

    iget-object p1, p0, Lwg/n;->o:Ljava/util/LinkedList;
...
.method public abstract C(Lgg/h;)V
.end method
...
.method public final D(Lgg/b$a;)V
    ...
    iget-object v0, p1, Lgg/b$a;->d:Landroid/media/Image;

    iget-object v1, p0, Lwg/n;->j:Lwg/n$a;

    invoke-static {v0, v1}, Lwg/b;->E(Landroid/media/Image;Lwg/n$a;)V

    iget-object v0, p1, Lgg/b$a;->e:Landroid/media/Image;

    iget-object v1, p0, Lwg/n;->j:Lwg/n$a;

    invoke-static {v0, v1}, Lwg/b;->E(Landroid/media/Image;Lwg/n$a;)V

    iget-object p1, p1, Lgg/b$a;->g:Landroid/media/Image;

    iget-object p0, p0, Lwg/n;->j:Lwg/n$a;

    invoke-static {p1, p0}, Lwg/b;->E(Landroid/media/Image;Lwg/n$a;)V

    :cond_0
    return-void
.end method

.method public final F(Lgg/i;)V
    .locals 2

    if-eqz p1, :cond_1

    iget-object p1, p1, Lgg/i;->c:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lgg/h;->a:Ljava/util/List;
    ...
    invoke-virtual {p0, v1}, Lwg/b;->D(Lgg/b$a;)V
...
.method public final G()V
    ...
    iget-object v0, p0, Lwg/n;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lwg/n;->i:Lwg/n$b;

    if-eqz v1, :cond_1

    invoke-virtual {p0}, Lwg/n;->n()Z
    ...
    iget-object p0, p0, Lwg/n;->i:Lwg/n$b;
...
.method public final H()V
    ...
    iget-object p0, p0, Lwg/n;->h:Landroid/os/HandlerThread;
...
.method public final I(Lcom/xiaomi/engine/TaskSession;)V
    ...
    iput-object p1, p0, Lwg/b;->u:Lcom/xiaomi/engine/TaskSession;

    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    iget-object p1, p0, Lwg/n;->h:Landroid/os/HandlerThread;
    ...
    iget-object p1, p0, Lwg/n;->n:Ljava/lang/Object;

    monitor-enter p1

    :try_start_1
    iget-object v0, p0, Lwg/n;->o:Ljava/util/LinkedList;
...
.method public final J()V
    ...
    iget-object v1, p0, Lwg/n;->h:Landroid/os/HandlerThread;
    ...
    iget-object v1, p0, Lwg/n;->g:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    new-instance v3, Lwg/n$b;

    iget-object v4, p0, Lwg/n;->h:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v4

    invoke-direct {v3, v4, p0}, Lwg/n$b;-><init>(Landroid/os/Looper;Lwg/b;)V

    iput-object v3, p0, Lwg/n;->i:Lwg/n$b;
    ...
    iget-object v3, p0, Lwg/n;->p:Ljava/lang/Object;
    ...
    :try_start_1
    iput v1, p0, Lwg/n;->q:I

    monitor-exit v3
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    iget-object v3, p0, Lwg/b;->s:Landroid/os/HandlerThread;
    ...
    iput-object v4, p0, Lwg/b;->t:Landroid/os/Handler;
...
.method public final a(J)V
    ...
    iget-object v1, p0, Lwg/n;->n:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lwg/b;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v6, p0, Lwg/b;->B:Landroid/util/LongSparseArray;
    ...
    iget-wide v7, v6, Lgg/i;->b:J

    sub-long v7, p1, v7

    sget-boolean v9, Lxa/c;->h:Z
    ...
    iget-object v5, p0, Lwg/b;->B:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {p0, p2, v0}, Lwg/b;->z(Lgg/i;Ljava/lang/String;)V
...
.method public final c(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lwg/b;->z:Landroid/media/ImageReader;

    new-instance v1, Lwg/a;

    invoke-direct {v1, p0}, Lwg/a;-><init>(Lwg/b;)V

    iget-object v2, p0, Lwg/b;->t:Landroid/os/Handler;
    ...
    iget-object p0, p0, Lwg/b;->z:Landroid/media/ImageReader;
...
.method public final e(Lgg/h;)I
    ...
    iget-object v0, p0, Lwg/n;->n:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lwg/n;->o:Ljava/util/LinkedList;
    ...
    :try_start_1
    iget-object v0, p0, Lwg/b;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_1
    iget-boolean v0, p1, Lgg/h;->e:Z

    if-eqz v0, :cond_2

    iget-boolean p1, p1, Lgg/h;->b:Z
    ...
    invoke-static {p1, v1}, La0/t3;->e(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final f(J)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lwg/b;->A(JZ)V

    const/4 v0, 0x1

    invoke-virtual {p0, p1, p2, v0}, Lwg/b;->A(JZ)V
...
.method public final j()Lgg/j;
    ...
    iget-object v0, p0, Lwg/b;->v:Lgg/j;
...
.method public final k()Z
    ...
    iget-object v0, p0, Lwg/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->get()I

    move-result v0

    iget p0, p0, Lwg/n;->a:I
...
.method public final p()Ljava/util/ArrayList;
    ...
    :try_start_0
    iput-object v1, p0, Lwg/b;->u:Lcom/xiaomi/engine/TaskSession;

    iput-object v1, p0, Lwg/b;->v:Lgg/j;
    ...
    :try_start_1
    iget-object v3, p0, Lwg/b;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v4, p0, Lwg/b;->B:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {p0, v4}, Lwg/b;->F(Lgg/i;)V

    iget-object v5, p0, Lwg/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    iget-object v3, p0, Lwg/n;->o:Ljava/util/LinkedList;
    ...
    iget-boolean v5, v4, Lgg/h;->b:Z

    if-eqz v5, :cond_1

    iget-wide v5, v4, Lgg/h;->c:J
    ...
    :cond_1
    iget-object v5, v4, Lgg/h;->a:Ljava/util/List;
    ...
    check-cast v6, Lgg/b$a;

    invoke-virtual {p0, v6}, Lwg/b;->D(Lgg/b$a;)V
...
.method public final q(J)Z
    ...
    iget-object p2, p0, Lwg/b;->B:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {p0, p2, p1}, Lwg/b;->z(Lgg/i;Ljava/lang/String;)V
...
.method public final r(J)V
    ...
    :cond_0
    iget-object p1, p0, Lwg/n;->i:Lwg/n$b;
...
.method public final s()V
    ...
    :try_start_0
    iget-object v1, p0, Lwg/b;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    iget-object v1, v0, Lgg/h;->a:Ljava/util/List;
    ...
    invoke-virtual {p0, v4}, Lwg/b;->D(Lgg/b$a;)V
    ...
    :cond_3
    iget-object v1, v0, Lgg/b$a;->d:Landroid/media/Image;
    ...
    invoke-static {v5, v1}, Lwg/n;->t(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;)Landroid/media/Image;

    move-result-object v1

    invoke-virtual {p0, v0}, Lwg/b;->D(Lgg/b$a;)V
    ...
    invoke-direct {v0, v1, v2, v5, v6}, Lgg/c;-><init>(Landroid/media/Image;IZLv2/i;)V

    invoke-virtual {p0, v0}, Lwg/n;->d(Lgg/c;)V

    invoke-virtual {p0, v3, v4}, Lwg/b;->B(J)V
    ...
    iget-object v4, p0, Lwg/n;->n:Ljava/lang/Object;

    monitor-enter v4

    :try_start_2
    iget-wide v5, v0, Lgg/h;->c:J

    iget-boolean v7, v0, Lgg/h;->b:Z
    ...
    invoke-direct {v1, v5, v6, v9, v10}, Lgg/i;-><init>(JJ)V

    iget-object v3, v1, Lgg/i;->c:Ljava/util/ArrayList;
    ...
    :cond_5
    iget-object v7, p0, Lwg/b;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v1, v7, Lgg/i;->c:Ljava/util/ArrayList;
    ...
    iget-object v5, v7, Lgg/i;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lwg/b;->C(Lgg/h;)V
...
.method public final u(Lgg/j;)V
    ...
    iput-object p1, p0, Lwg/b;->v:Lgg/j;
...
.method public final v()V
    ...
    invoke-super {p0}, Lwg/n;->v()V

    iget-object v0, p0, Lwg/n;->k:Lwg/k;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iput-object v1, p0, Lwg/n;->k:Lwg/k;
    ...
    :try_start_0
    iget-object v3, p0, Lwg/b;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    iget-object v0, v0, Lgg/j;->a:Lcom/xiaomi/engine/TaskSession;
    ...
    iput-object v1, p0, Lwg/n;->j:Lwg/n$a;

    iget-object v0, p0, Lwg/b;->w:Landroid/media/ImageReader;

    if-eqz v0, :cond_4

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lwg/b;->w:Landroid/media/ImageReader;

    :cond_4
    iget-object v0, p0, Lwg/b;->x:Landroid/media/ImageReader;

    if-eqz v0, :cond_5

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lwg/b;->x:Landroid/media/ImageReader;

    :cond_5
    iget-object v0, p0, Lwg/b;->y:Landroid/media/ImageReader;

    if-eqz v0, :cond_6

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lwg/b;->y:Landroid/media/ImageReader;

    :cond_6
    iget-object v0, p0, Lwg/b;->z:Landroid/media/ImageReader;

    if-eqz v0, :cond_7

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Lwg/b;->z:Landroid/media/ImageReader;

    :cond_7
    iget-object v0, p0, Lwg/b;->s:Landroid/os/HandlerThread;
    ...
    :cond_8
    iget-object v0, p0, Lwg/b;->t:Landroid/os/Handler;

    if-eqz v0, :cond_9

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacksAndMessages(Ljava/lang/Object;)V

    iput-object v1, p0, Lwg/b;->t:Landroid/os/Handler;
...
.method public final x()Z
    ...
    :try_start_0
    iget-object v2, p0, Lwg/b;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    iget-object v1, p0, Lwg/n;->p:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iput v3, p0, Lwg/n;->q:I
...
.method public final z(Lgg/i;Ljava/lang/String;)V
    .locals 7
    .param p1    # Lgg/i;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Lwg/b;->F(Lgg/i;)V

    iget-object v0, p0, Lwg/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndDecrement()I

    iget-object v0, p0, Lwg/n;->j:Lwg/n$a;

    if-eqz v0, :cond_0

    check-cast v0, Lwg/t$e;

    iget-wide v4, p1, Lgg/i;->a:J

    invoke-virtual {v0, v4, v5}, Lwg/t$e;->a(J)Lwg/q;
    ...
    invoke-virtual {p0, v4, v5}, Lwg/t;->v(J)Lwg/q;
    ...
    invoke-virtual {p0, v0, p1, p2}, Lq1/b;->B(ILjava/lang/String;Ljava/lang/String;)V
