...
.method public constructor <init>(Lwg/t;)V
    ...
    iput-object p1, p0, Lwg/t$c;->a:Lwg/t;
...
.method public final a(Lgg/b;)V
    ...
    iget-wide v7, p1, Lgg/b;->d:J

    iget-object v1, p1, Lgg/b;->f:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Lwg/t$c;->a:Lwg/t;

    const/4 v5, 0x0

    iget v6, p1, Lgg/b;->a:I

    if-eq v2, v6, :cond_0

    if-ne v0, v6, :cond_5

    iget-boolean v2, v4, Lwg/t;->p:Z

    if-eqz v2, :cond_5

    :cond_0
    iget-object v2, p1, Lgg/b;->i:Lgg/b$a;

    if-eqz v2, :cond_10

    invoke-virtual {v4, v7, v8}, Lwg/t;->s(J)Lwg/q;

    move-result-object v9

    iget-object v10, v2, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v12, v7, v8, v13}, La0/v3;->e(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iput-wide v10, v9, Lwg/q;->e:J

    invoke-virtual {v4, v7, v8}, Lwg/t;->v(J)Lwg/q;

    invoke-static {v4, v10, v11, v9}, Lwg/t;->i(Lwg/t;JLwg/q;)V

    :cond_1
    if-ne v0, v6, :cond_4

    iget-boolean v0, v4, Lwg/t;->p:Z

    if-eqz v0, :cond_4

    iget-boolean v0, p1, Lgg/b;->m:Z

    if-eqz v0, :cond_3

    iget-object v0, p1, Lgg/b;->g:Ljava/util/List;
    ...
    iput-object v2, v6, Lwg/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-object v2, v6, Lwg/q;->q:Lwg/r;

    iget-boolean v2, v2, Lwg/r;->N:Z
    ...
    iget-boolean v5, p1, Lgg/b;->s:Z

    iget-object v6, v6, Lwg/q;->L:Lgg/d;

    move-object v0, p0

    move-wide v3, v7

    invoke-direct/range {v0 .. v6}, Lgg/h;-><init>(Ljava/util/ArrayList;ZJZLgg/d;)V

    iget v0, p1, Lgg/b;->x:I

    iput v0, p0, Lgg/h;->f:I

    iget-object p1, p1, Lgg/b;->r:Lwg/n;

    sget-boolean v0, Lxa/c;->x:Z

    if-nez v0, :cond_7

    iget-object v0, p1, Lwg/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {p1, p0}, Lwg/n;->e(Lgg/h;)I

    goto/16 :goto_3

    :cond_8
    iget-object p1, v4, Lwg/t;->C:Lwg/t$e;

    invoke-virtual {p1, v5, v7, v8}, Lwg/t$e;->c(IJ)V
    ...
    invoke-virtual {p1, v0, v5, v5}, Lwg/t$e;->d(Landroid/media/Image;IZ)V

    invoke-virtual {v0}, Landroid/media/Image;->close()V

    invoke-virtual {p0, v0}, Lwg/t$c;->b(Landroid/media/Image;)V
    ...
    invoke-static {p1, v7, v8}, La0/s3;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget-object v4, v1, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :cond_b
    sget-object v9, Lqa/y;->K1:Lqa/x;

    invoke-static {v6, v9}, Lqa/a0;->e(Landroid/hardware/camera2/CaptureResult;Lqa/z;)Ljava/lang/Object;
    ...
    invoke-static {v9, v6}, La0/v;->h(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
    ...
    invoke-static {v8, v6}, La0/z;->c(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iget-object v1, v1, Lgg/b$a;->d:Landroid/media/Image;

    iput-object v4, v0, Lwg/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-object v0, p1, Lgg/b;->r:Lwg/n;
    ...
    invoke-static {v2, v1, v4, v7}, Ldg/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    invoke-direct {v4, v2, v5, v6, v7}, Lgg/c;-><init>(Landroid/media/Image;IZLv2/i;)V

    invoke-virtual {v0, v4}, Lwg/n;->d(Lgg/c;)V
    ...
    :cond_d
    invoke-virtual {p0, v1}, Lwg/t$c;->b(Landroid/media/Image;)V

    goto :goto_3

    :cond_e
    invoke-virtual {p0, p1, v2}, Lwg/t$c;->c(Lgg/b;Ljava/lang/String;)V
...
.method public final c(Lgg/b;Ljava/lang/String;)V
    .locals 18
    .param p1    # Lgg/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual/range {p1 .. p1}, Lgg/b;->a()Lgg/h;
    ...
    :cond_0
    iget-object v6, v2, Lgg/h;->a:Ljava/util/List;
    ...
    iget-object v11, v0, Lwg/t$c;->a:Lwg/t;

    iget-wide v12, v1, Lgg/b;->d:J

    iget v14, v1, Lgg/b;->a:I
    ...
    iget-boolean v15, v1, Lgg/b;->s:Z

    if-nez v15, :cond_3

    iget-boolean v15, v9, Lgg/b$a;->a:Z

    if-eqz v15, :cond_5

    iget-object v7, v9, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v7}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getTimeStamp()J

    move-result-wide v4

    invoke-virtual {v11, v4, v5}, Lwg/t;->s(J)Lwg/q;
    ...
    invoke-static {v11, v1, v14}, Lwg/t;->b(Lwg/t;Lgg/b;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v4

    iput-object v4, v7, Lwg/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual/range {p1 .. p1}, Lgg/b;->b()Z
    ...
    invoke-virtual {v5, v12, v13}, Lwg/t;->s(J)Lwg/q;
    ...
    invoke-static {v5, v1, v14}, Lwg/t;->b(Lwg/t;Lgg/b;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v4

    iput-object v4, v10, Lwg/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    check-cast v2, Lgg/b$a;

    invoke-static {v5, v2, v0}, Lwg/t;->a(Lwg/t;Lgg/b$a;Lwg/d;)V
    ...
    :cond_8
    iget-object v0, v1, Lgg/b;->r:Lwg/n;

    iget-boolean v1, v1, Lgg/b;->s:Z

    if-eqz v1, :cond_9

    iget-boolean v1, v2, Lgg/h;->b:Z

    if-eqz v1, :cond_9

    iget-object v1, v0, Lwg/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_9
    iget-object v1, v5, Lwg/t;->b:Lwg/n;
    ...
    iput v4, v2, Lgg/h;->d:I

    :cond_b
    if-eqz v0, :cond_c

    invoke-virtual {v0, v2}, Lwg/n;->e(Lgg/h;)I
