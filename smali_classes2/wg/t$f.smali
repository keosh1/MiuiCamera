...
.method public constructor <init>(Lwg/t;)V
    ...
    iput-object p1, p0, Lwg/t$f;->a:Lwg/t;
...
# virtual methods
.method public final a(JLwg/q;)V
    .locals 11
    ...
    iget-object v8, p3, Lwg/q;->Z:Ljava/lang/String;

    const/4 v9, 0x0

    iget-object v2, p3, Lwg/q;->P:Ljava/lang/Object;

    move-object v10, v2

    check-cast v10, Lwg/n;

    move-object v2, v0

    move-wide v6, p1

    invoke-direct/range {v2 .. v10}, Lgg/b;-><init>(IIIJLjava/lang/String;ZLwg/n;)V

    iget p1, p3, Lwg/q;->h0:I

    iput p1, v0, Lgg/b;->x:I

    iget-object p0, p0, Lwg/t$f;->a:Lwg/t;

    iget-object p0, p0, Lwg/t;->z:Lwg/t$b;

    iput-object p0, v0, Lgg/b;->q:Lwg/p$e;

    const/4 p0, 0x1

    iput-boolean p0, v0, Lgg/b;->l:Z

    iput-boolean p0, v0, Lgg/b;->y:Z

    sget-object p1, Lwg/p$f;->a:Lwg/p;

    invoke-virtual {p1, v0}, Lwg/p;->h(Lgg/b;)V

    iget-object p2, p3, Lwg/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {p1, p2, p0}, Lwg/p;->f(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public final onEarlyMetaAvailable(Lcom/xiaomi/camera/isp/ISPResult;)V
    ...
    iget-object v0, p0, Lwg/t;->u:Ljava/lang/ref/WeakReference;
    ...
    iget-object p0, p0, Lwg/t;->u:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {p0, v0, p1}, Lwg/l;->a(ILjava/lang/Object;)V
...
.method public final onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v4, p1}, La0/x;->e(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v3, p1, Lwg/q;->K:Landroid/media/Image;

    invoke-static {p0, v3}, Lwg/t;->d(Lwg/t;Landroid/media/Image;)V

    invoke-virtual {p1}, Lwg/q;->l()V

    invoke-virtual {p0, v1, v2}, Lwg/t;->v(J)Lwg/q;
...
.method public final onJpegAvailable([BLjava/lang/String;)V
    ...
    :cond_0
    iget-object v4, p0, Lwg/t$f;->a:Lwg/t;

    invoke-virtual {v4, v1, v2}, Lwg/t;->s(J)Lwg/q;
    ...
    invoke-virtual {v4, p2, p1}, Lwg/q;->a(I[B)V

    const-string p2, "JPEG"

    invoke-virtual {v4, p2}, Lwg/q;->h(Ljava/lang/String;)Z
    ...
    :cond_1
    iget-object p2, p0, Lwg/t$f;->a:Lwg/t;

    iget-object p2, p2, Lwg/t;->l:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    iget-object v5, p0, Lwg/t$f;->a:Lwg/t;
    ...
    invoke-virtual {p2, v1, v2}, Lwg/t;->v(J)Lwg/q;

    sget-boolean p2, Lxa/c;->x:Z

    iput-boolean p2, v4, Lwg/q;->N:Z

    iget-object p2, v4, Lwg/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object p1, p0, Lwg/t$f;->a:Lwg/t;

    iget-object p1, p1, Lwg/t;->i:Ll8/l;

    const/4 v5, 0x0

    invoke-virtual {p1, v4, p2, v5, v5}, Ll8/l;->l(Lwg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V

    iget-object p1, p0, Lwg/t$f;->a:Lwg/t;

    iget-object p2, v4, Lwg/q;->K:Landroid/media/Image;

    invoke-static {p1, p2}, Lwg/t;->d(Lwg/t;Landroid/media/Image;)V

    iget-object p1, p0, Lwg/t$f;->a:Lwg/t;

    invoke-static {p1, v4}, Lwg/t;->e(Lwg/t;Lwg/q;)Z
    ...
    iget-object p1, p1, Lwg/t;->h:Lwg/t$i;

    if-eqz p1, :cond_3

    check-cast p1, Lcom/android/camera/b$a;

    invoke-virtual {p1, v4}, Lcom/android/camera/b$a;->a(Lwg/q;)V
    ...
    invoke-static {p2, v1, v2}, La0/s3;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    iget p2, p1, Lwg/t;->w:I

    add-int/2addr p2, v3

    iput p2, p1, Lwg/t;->w:I

    invoke-static {p1, v4, p2}, Lwg/t;->f(Lwg/t;Lwg/q;I)Z
    ...
    invoke-static {p1}, Lwg/t;->g(Lwg/t;)V

    iget-object p1, p0, Lwg/t$f;->a:Lwg/t;

    iput v0, p1, Lwg/t;->w:I
    ...
    iget p1, p1, Lwg/t;->x:I

    invoke-virtual {p2, p1}, Lwg/c;->i(I)V
...
.method public final onJpegImageAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v3, v5}, Lm7/k;->d(Ljava/lang/String;)J
    ...
    invoke-virtual {v3, v5}, Lm7/k;->o(Ljava/lang/String;)V

    :cond_0
    iget-object p0, p0, Lwg/t$f;->a:Lwg/t;

    invoke-virtual {p0, v0, v1}, Lwg/t;->s(J)Lwg/q;
    ...
    invoke-virtual {v3, p2, p1}, Lwg/q;->a(I[B)V

    const-string p2, "JPEG"

    invoke-virtual {v3, p2}, Lwg/q;->h(Ljava/lang/String;)Z

    move-result v5

    if-nez v5, :cond_2

    sget-boolean v5, Lxa/c;->x:Z
    ...
    iput-boolean v5, v3, Lwg/q;->N:Z

    iget-object v5, v3, Lwg/q;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object p1, p0, Lwg/t;->i:Ll8/l;

    invoke-virtual {p1, v3, v5, v7, p2}, Ll8/l;->l(Lwg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v3, v5, v7, v7}, Ll8/l;->l(Lwg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V

    :goto_1
    iget-object p1, v3, Lwg/q;->K:Landroid/media/Image;

    invoke-static {p0, p1}, Lwg/t;->d(Lwg/t;Landroid/media/Image;)V

    invoke-static {p0, v3}, Lwg/t;->e(Lwg/t;Lwg/q;)Z
    ...
    invoke-virtual {p1, v3}, Lcom/android/camera/b$a;->a(Lwg/q;)V

    :cond_4
    const-string p1, "[3] onJpegImageAvailable: parallelTaskHashMap remove "

    invoke-static {p1, v0, v1}, La0/s3;->c(Ljava/lang/String;J)Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1}, Lwg/t;->v(J)Lwg/q;
...
.method public final onTuningImageAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    iget-object v0, p0, Lwg/t$f;->a:Lwg/t;

    invoke-virtual {v0, v2, v3}, Lwg/t;->s(J)Lwg/q;
    ...
    invoke-virtual {p0, v2, v3, v6}, Lwg/t$f;->a(JLwg/q;)V

    :cond_2
    sget-object p0, Lwg/p$f;->a:Lwg/p;

    invoke-virtual {p0, p1, v0, v4, p3}, Lwg/p;->e(Landroid/media/Image;IIZ)V
    ...
    invoke-static/range {v5 .. v10}, Lwg/t;->h(Lwg/t;Lwg/q;Landroid/media/Image;Ljava/lang/String;IZ)V
...
.method public final onYuvAvailable(Landroid/media/Image;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v5, v2, v3}, Lwg/t;->s(J)Lwg/q;

    move-result-object v7

    if-eqz v7, :cond_6

    iget v5, v7, Lwg/q;->A:I

    invoke-static {v5}, Ldg/c;->e(I)Z

    move-result v6

    if-nez v6, :cond_3

    invoke-static {v5}, Ldg/c;->d(I)Z
    ...
    invoke-virtual {p0, v2, v3, v7}, Lwg/t$f;->a(JLwg/q;)V
    ...
    :cond_4
    iget-object v6, p0, Lwg/t$f;->a:Lwg/t;
    ...
    invoke-static/range {v6 .. v11}, Lwg/t;->h(Lwg/t;Lwg/q;Landroid/media/Image;Ljava/lang/String;IZ)V
