...
.method public final C(Lgg/h;)V
    ...
    :cond_1
    iget-object v1, p1, Lgg/h;->g:Lgg/d;
    ...
    iget-object v4, v1, Lgg/b$a;->d:Landroid/media/Image;

    iget-object v6, v1, Lgg/b$a;->e:Landroid/media/Image;

    invoke-static {v4}, Lwg/n;->m(Landroid/media/Image;)Z

    move-result v7

    invoke-static {v6}, Lwg/n;->m(Landroid/media/Image;)Z
    ...
    :cond_4
    iget-object v1, v1, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {p0, v1, v4, v2, v7}, Lwg/h;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget v4, p1, Lgg/h;->d:I

    invoke-virtual {p0, v1, v6, v5, v4}, Lwg/h;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-static {v1, v2, v3, v5}, La0/a0;->j(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2, v0}, La0/x;->c(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :cond_2
    new-instance p1, Lwg/h$a;

    invoke-direct {p1, p0}, Lwg/h$a;-><init>(Lwg/h;)V
    ...
    :cond_4
    new-instance p1, Lwg/h$b;

    invoke-direct {p1}, Lwg/h$b;-><init>()V
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    invoke-direct {v2, p0}, Lwg/e;-><init>(Lwg/h;)V
    ...
    invoke-direct {v2, p0}, Lwg/f;-><init>(Lwg/h;)V
    ...
    invoke-direct {v1, p0}, Lwg/g;-><init>(Lwg/h;)V
...
.method public final l()Z
    ...
    iget-object v4, p0, Lwg/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v0, p0}, Lwg/t$e;->b(Lwg/n;)Z
