...
.method public constructor <init>(Lwg/t$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, Lwg/b;-><init>(Lwg/t$e;Lcom/xiaomi/engine/BufferFormat;)V
...
# virtual methods
.method public final C(Lgg/h;)V
    .locals 11

    iget-object v0, p1, Lgg/h;->a:Ljava/util/List;
    ...
    :cond_0
    iget-boolean v1, p1, Lgg/h;->b:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Lwg/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-boolean v1, v1, Lgg/b$a;->i:Z
    ...
    iget-object v5, v4, Lgg/b$a;->d:Landroid/media/Image;

    invoke-static {v5}, Lwg/n;->m(Landroid/media/Image;)Z
    ...
    :cond_2
    iget-object v6, v4, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    if-nez v1, :cond_3

    iget v7, p1, Lgg/h;->d:I

    invoke-virtual {p0, v6, v5, v3, v7}, Lwg/b0;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget-object v8, v4, Lgg/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v8}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getRequest()Landroid/hardware/camera2/CaptureRequest;

    move-result-object v8

    sget-object v9, Lqa/w;->u:Lqa/v;

    const v10, 0xbabe

    invoke-static {v8, v9, v10}, Lqa/a0;->k(Landroid/hardware/camera2/CaptureRequest;Lqa/v;I)Ljava/lang/Object;
    ...
    :goto_2
    iget v8, p1, Lgg/h;->d:I

    invoke-virtual {p0, v6, v5, v7, v8}, Lwg/b0;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    iget-object v4, v4, Lgg/b$a;->e:Landroid/media/Image;

    iget-object v5, p0, Lwg/n;->j:Lwg/n$a;

    invoke-static {v4, v5}, Lwg/b;->E(Landroid/media/Image;Lwg/n$a;)V
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-static {v0, v1, v2, v4}, La0/a0;->j(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_0
    new-instance p1, Lwg/b0$a;

    invoke-direct {p1, p0}, Lwg/b0$a;-><init>(Lwg/b0;)V
    ...
    iget-object p1, p0, Lwg/b;->A:Ljava/lang/Object;
    ...
    :cond_2
    new-instance p1, Lwg/b0$b;

    invoke-direct {p1}, Lwg/b0$b;-><init>()V
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lwg/b;->w:Landroid/media/ImageReader;

    new-instance v2, Lwg/y;

    invoke-direct {v2, p0}, Lwg/y;-><init>(Lwg/b0;)V

    iget-object v4, p0, Lwg/b;->t:Landroid/os/Handler;
    ...
    iget-object v2, p0, Lwg/b;->w:Landroid/media/ImageReader;
    ...
    new-instance v2, Lwg/z;

    invoke-direct {v2, p0}, Lwg/z;-><init>(Lwg/b0;)V
    ...
    iget-object v2, p0, Lwg/b;->x:Landroid/media/ImageReader;
    ...
    iput-object p1, p0, Lwg/b;->y:Landroid/media/ImageReader;

    new-instance v1, Lwg/a0;

    invoke-direct {v1, p0}, Lwg/a0;-><init>(Lwg/b0;)V

    iget-object v3, p0, Lwg/b;->t:Landroid/os/Handler;
    ...
    iget-object p0, p0, Lwg/b;->y:Landroid/media/ImageReader;
...
.method public final l()Z
    ...
    iget-object v3, p0, Lwg/n;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    const/4 v4, 0x0

    iget-boolean v5, p0, Lwg/n;->m:Z
    ...
    iget-object v0, p0, Lwg/n;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lwg/n;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v5, p0}, Lwg/t$e;->b(Lwg/n;)Z
