...
.method public final F()Lda/a$b;
    ...
    invoke-direct {v0, p0}, Lda/n$a;-><init>(Lda/n;)V
...
.method public final G()Lda/a$d;
    ...
    invoke-virtual {v3, v9}, Lca/u1;->q(I)Landroid/view/Surface;
    ...
    invoke-virtual {v3, v10, v6}, Lca/u1;->j(IZ)Landroid/view/Surface;
    ...
    iput-object v10, p0, Lda/a;->G:Landroid/util/Size;
    ...
    iget-object v3, v3, Lca/x;->w:Lra/d;

    if-eqz v3, :cond_4

    iget-boolean v3, v3, Lra/d;->a:Z
    ...
    invoke-virtual {v3, v10}, Lca/u1;->q(I)Landroid/view/Surface;
    ...
    invoke-virtual {v3, v10, v6}, Lca/u1;->m(IZ)Landroid/view/Surface;
    ...
    iput-object v3, p0, Lda/n;->L:Landroid/view/Surface;

    invoke-virtual {v0, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v2}, Lca/q2;->a()Z
    ...
    iput-object v3, p0, Lda/n;->M:Landroid/view/Surface;
...
.method public final z(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v3, v0, Lca/q2;->g:Lca/q2$a;

    iget-boolean v3, v3, Lca/q2$a;->l:Z
    ...
    iget-object v3, p0, Lda/n;->L:Landroid/view/Surface;

    if-eqz v3, :cond_3

    iget-object v3, p0, Lda/n;->M:Landroid/view/Surface;
    ...
    iget-object v6, v3, Lca/q2$a;->q:[I
    ...
    iget v6, v3, Lca/q2$a;->c:I

    iget v3, v3, Lca/q2$a;->w:I
    ...
    iget-object v6, v0, Lca/q2;->g:Lca/q2$a;
    ...
    invoke-virtual {p0}, Lca/a;->U()Lca/u1;
