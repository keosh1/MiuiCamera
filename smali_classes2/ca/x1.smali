...
.field public final Q:Lca/x1$a;

.field public final R:Lca/x1$b;
...
.method public constructor <init>(Lca/m0;Lgg/a;)V
    .locals 0
    ...
    iput-boolean p1, p0, Lca/x1;->I:Z

    iput-boolean p1, p0, Lca/x1;->L:Z

    iput p1, p0, Lca/x1;->M:I

    const/16 p2, 0xa0

    iput p2, p0, Lca/x1;->N:I

    new-instance p2, Ljava/lang/Object;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lca/x1;->O:Ljava/lang/Object;

    new-instance p2, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p2, p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object p2, p0, Lca/x1;->P:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Lca/x1$a;

    invoke-direct {p1, p0}, Lca/x1$a;-><init>(Lca/x1;)V

    iput-object p1, p0, Lca/x1;->Q:Lca/x1$a;

    new-instance p1, Lca/x1$b;

    invoke-direct {p1, p0}, Lca/x1$b;-><init>(Lca/x1;)V

    iput-object p1, p0, Lca/x1;->R:Lca/x1$b;
    ...
    iput p1, p0, Lca/x1;->N:I

    return-void
.end method

.method public static y(Lca/x1;J)V
    .locals 6

    iget-object v0, p0, Lca/w0;->b:Lca/a;

    invoke-virtual {v0}, Lca/a;->D()Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    check-cast v4, Lca/x1;

    invoke-virtual {v4}, Lca/w0;->c()J
    ...
    invoke-direct {p1, v1, p2}, La0/j0;-><init>(Ljava/lang/Object;I)V
...
.method public static z(Lca/x1;[BLjava/lang/String;)V
    .locals 5
    ...
    iget-object v2, p0, Lca/x1;->C:Lwg/q;
    ...
    :cond_0
    iget-object v0, p0, Lca/x1;->C:Lwg/q;
    ...
    iget-object v3, p0, Lca/x1;->C:Lwg/q;
    ...
    invoke-virtual {v0, v1, p1}, Lwg/q;->j(I[B)V
    ...
    invoke-virtual {v0, v2, p1}, Lwg/q;->j(I[B)V
    ...
    iget-object p1, p0, Lca/x1;->C:Lwg/q;

    iget-wide v3, p1, Lwg/q;->e:J
    ...
    iget-object v0, p0, Lca/x1;->K:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lca/x1;->H(Lwg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lca/x1;->C:Lwg/q;
...
.method public final A(I)V
    ...
    iget-object v0, p0, Lca/x1;->O:Ljava/lang/Object;
...
.method public final B()V
    ...
    iget-object v0, p0, Lca/x1;->D:Landroid/media/Image;
...
.method public final C()V
    ...
    iput-object v0, p0, Lca/x1;->H:Ljava/lang/String;
...
.method public final E()V
    ...
    iget-object v0, p0, Lca/x1;->P:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v1, p0, v2}, Lca/a;->v0(Lca/w0;Z)V
    ...
    iget-boolean v1, p0, Lca/x1;->G:Z

    if-eqz v1, :cond_3

    iget-object v1, p0, Lca/x1;->F:Lwg/q;

    if-eqz v1, :cond_3

    const/4 v4, 0x0

    invoke-virtual {p0, v1, v4, v4, v4}, Lca/x1;->H(Lwg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V

    :cond_3
    invoke-virtual {p0}, Lca/x1;->D()J

    move-result-wide v4

    invoke-interface {v0, v2, v4, v5, v3}, Lca/a$k;->onPictureTakenFinished(ZJI)V
...
.method public final F()V
    ...
    iget-object v3, p0, Lca/x1;->H:Ljava/lang/String;
    ...
    iget-object v3, p0, Lca/x1;->D:Landroid/media/Image;
    ...
    new-instance v0, Lca/x1$c;

    invoke-direct {v0, p0}, Lca/x1$c;-><init>(Lca/x1;)V
    ...
    :cond_5
    invoke-virtual {v0}, Lca/x1$c;->run()V
...
.method public final G()Z
    ...
    invoke-static {v4, v1, v5, v0}, La0/b0;->h(Ljava/lang/String;ZLjava/lang/String;Z)Ljava/lang/String;
...
.method public final H(Lwg/q;Landroid/hardware/camera2/TotalCaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;)V
    .locals 3
    ...
    iget-object p4, p0, Lca/x1;->H:Ljava/lang/String;
...
.method public final I(Ljava/util/concurrent/ConcurrentLinkedDeque;J)V
    ...
    instance-of v2, v1, Lca/x1;

    if-eqz v2, :cond_0

    move-object v2, v1

    check-cast v2, Lca/x1;

    invoke-virtual {v2}, Lca/x1;->D()J
...
.method public final J(Landroid/hardware/camera2/TotalCaptureResult;Lwg/q;)V
    .locals 7
    ...
    :cond_0
    iget-object p2, p2, Lwg/q;->q:Lwg/r;

    iget-object p2, p2, Lwg/r;->H:Lgg/f;

    const/4 v2, 0x4

    new-array v3, v2, [Lqa/z;

    sget-object v4, Lqa/y;->o0:Lqa/x;

    aput-object v4, v3, v1

    sget-object v4, Lqa/y;->p0:Lqa/x;

    const/4 v5, 0x1

    aput-object v4, v3, v5

    sget-object v4, Lqa/y;->q0:Lqa/x;
    ...
    invoke-static {p1, v6}, Lqa/a0;->e(Landroid/hardware/camera2/CaptureResult;Lqa/z;)Ljava/lang/Object;
    ...
    iget-object v4, v4, Lca/q2$a;->L:Lra/l$a;
    ...
    iget-object p0, p0, Lca/q2$a;->L:Lra/l$a;

    iget-object v3, p0, Lra/l$a;->h:Ljava/lang/String;
    ...
    :cond_3
    iput-object v3, p2, Lgg/f;->E:Ljava/lang/String;
    ...
    iput-object p0, p2, Lgg/f;->A:Ljava/lang/String;
...
.method public j(Landroid/media/Image;I)V
    ...
    iget-object v6, v1, Lca/x1;->C:Lwg/q;
    ...
    iget-object v0, v1, Lca/x1;->C:Lwg/q;

    invoke-virtual {p1}, Landroid/media/Image;->getTimestamp()J

    move-result-wide v6

    iput-wide v6, v0, Lwg/q;->e:J

    iget-wide v6, v1, Lca/x1;->J:J
    ...
    iget-object v0, v1, Lca/w0;->a:Ljava/lang/String;
    ...
    iget-object v1, v1, Lca/x1;->H:Ljava/lang/String;
    ...
    iget-object v5, v1, Lca/x1;->H:Ljava/lang/String;
    ...
    invoke-static {v0, p1, v11, v10}, Ldg/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v6, v1, Lca/x1;->H:Ljava/lang/String;
    ...
    iget-object v5, v1, Lca/w0;->a:Ljava/lang/String;

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v4, v1, Lca/x1;->H:Ljava/lang/String;
    ...
    iput-object v9, v1, Lca/x1;->D:Landroid/media/Image;
    ...
    iget-object v4, v1, Lca/x1;->D:Landroid/media/Image;
    ...
    iget-object v4, v1, Lca/x1;->C:Lwg/q;
    ...
    :cond_2
    iget-object v4, v1, Lca/w0;->a:Ljava/lang/String;
    ...
    invoke-static {v4, p1, v5, v10}, Ldg/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v0, v1, Lca/x1;->H:Ljava/lang/String;
    ...
    iget-object v0, v1, Lca/x1;->Q:Lca/x1$a;

    iget-object v4, v1, Lca/x1;->H:Ljava/lang/String;

    iget-object v5, v1, Lca/x1;->C:Lwg/q;

    iget-wide v5, v5, Lwg/q;->a0:J

    const-string/jumbo v12, "{\"smallPicture\":\"true\",\"type\":\"app\",\"reason\":\"ImagePool get image failed\",\"imageName\":\"%s\"}"

    invoke-virtual {v0, v4, v5, v6, v12}, Lca/x1$a;->onCaptureFailed(Ljava/lang/String;JLjava/lang/String;)V
    ...
    invoke-static {v9, v0}, Ldg/e;->c(Landroid/media/Image;Ljava/lang/String;)V

    :cond_4
    iget-object v0, v1, Lca/w0;->b:Lca/a;
