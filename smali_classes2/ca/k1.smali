...
.method public constructor <init>(Lca/m0;Landroid/view/Surface;)V
    .locals 1
    ...
    iput-boolean p1, p0, Lca/k1;->D:Z

    sget-object p1, Lgg/d;->b:Lgg/d;

    iput-object p1, p0, Lca/k1;->E:Lgg/d;

    iput-object p2, p0, Lca/k1;->F:Landroid/view/Surface;

    return-void
.end method

.method public static y(Lca/k1;ZI)V
    .locals 5
...
.method public final m()V
    ...
    invoke-virtual {v2, v3}, Lm7/k;->d(Ljava/lang/String;)J

    :cond_0
    :try_start_0
    new-instance v2, Lca/j1;

    invoke-direct {v2, p0}, Lca/j1;-><init>(Lca/k1;)V

    invoke-virtual {p0}, Lca/k1;->z()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v3

    iget-object v5, p0, Lca/k1;->F:Landroid/view/Surface;
...
.method public final z()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-static {v0}, Lca/d;->F0(Lca/c;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {v5}, Lca/a;->q()Landroid/hardware/camera2/CameraDevice;
    ...
    invoke-virtual {v6}, Lca/u1;->o()Landroid/util/SparseArray;

    move-result-object v6

    invoke-static {v6}, Lla/c;->c(Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    :cond_6
    :goto_2
    invoke-virtual {v5}, Lca/a;->P()I

    move-result v6

    iput v6, p0, Lca/w0;->t:I
    ...
    invoke-virtual {v5}, Lca/a;->m0()Z

    move-result v10

    invoke-virtual {v6, v9, v10}, Lca/u1;->m(IZ)Landroid/view/Surface;

    move-result-object v6

    invoke-static {v6}, Lak/q;->d(Landroid/view/Surface;)Landroid/util/Size;
    ...
    invoke-virtual {v1, v4}, Lca/u1;->q(I)Landroid/view/Surface;
    ...
    invoke-static {v6, v1}, La0/t3;->e(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v9, v6, v1}, Lca/b1;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_9
    invoke-virtual {v5}, Lca/a;->K()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v5, v0, v8}, Lca/a;->c(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-boolean v7, v6, Lca/x;->x1:Z

    if-eqz v7, :cond_a

    iput-boolean v4, v6, Lca/x;->x1:Z
    ...
    invoke-static {v8, v0, v1, v6}, Lca/z;->N(ILandroid/hardware/camera2/CaptureRequest$Builder;Lca/c;Lca/x;)V
    ...
    sget-object v7, Lzj/a;->a:Ljava/util/Map;

    iget-object v8, v1, Lca/c;->e:Ljava/util/HashSet;
    ...
    invoke-static {v5}, Lca/d;->F0(Lca/c;)Z
    ...
    invoke-static {v0, v1, v4}, Lca/z;->t0(Landroid/hardware/camera2/CaptureRequest$Builder;Lca/c;Z)V
