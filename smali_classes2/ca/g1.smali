...
.method public static constructor <clinit>()V
    ...
    invoke-virtual {v0}, L섘섔섖셕섖섒셕섟섞섍섒섘섞셕섘섔섖섖섔섕셕세섔섖섖섔섕;->R0()I
...
.method public constructor <init>(Lca/m0;ILandroid/view/Surface;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lca/b1;-><init>(Lca/m0;Lgg/a;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, Lca/g1;->D:Z

    iput p2, p0, Lca/g1;->G:I

    sget-object p1, Lgg/d;->b:Lgg/d;

    iput-object p1, p0, Lca/g1;->I:Lgg/d;

    iput-object p3, p0, Lca/g1;->J:Landroid/view/Surface;

    return-void
.end method

.method public static y(Lca/g1;ZI)V
    .locals 5
    ...
    invoke-interface {p2, p1, v3, v4, v2}, Lca/a$k;->onPictureTakenFinished(ZJI)V
...
.method public final k()V
    ...
    iget-boolean v0, p0, Lca/x;->G0:Z

    const/4 v1, 0x1

    if-eq v0, v1, :cond_0

    iput-boolean v1, p0, Lca/x;->G0:Z
...
.method public final m()V
    ...
    iget v0, p0, Lca/g1;->H:I

    iget v1, p0, Lca/g1;->G:I
    ...
    invoke-static {v3}, Lca/d;->H2(Lca/c;)Z
    ...
    invoke-static {v0}, Lca/d;->H2(Lca/c;)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-virtual {v2}, Lca/a;->A0()V

    :cond_2
    :try_start_0
    new-instance v0, Lca/f1;

    invoke-direct {v0, p0}, Lca/f1;-><init>(Lca/g1;)V

    invoke-virtual {p0}, Lca/g1;->z()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, Lca/g1;->J:Landroid/view/Surface;
    ...
    invoke-virtual {v2}, Lca/a;->t()Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iget-object v11, p0, Lca/w0;->c:Landroid/os/Handler;
    ...
    iget v10, p0, Lca/g1;->H:I

    add-int/2addr v10, v6

    iput v10, p0, Lca/g1;->H:I

    iput v9, p0, Lca/g1;->E:I

    if-ne v10, v1, :cond_5

    iput v9, p0, Lca/g1;->F:I
    ...
    invoke-virtual {v2, p0}, Lca/a;->q0(I)V
...
.method public final z()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :cond_1
    invoke-virtual {v3}, Lca/a;->U()Lca/u1;

    move-result-object v4

    invoke-virtual {v4}, Lca/u1;->o()Landroid/util/SparseArray;

    move-result-object v4

    invoke-static {v4}, Lla/c;->c(Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v10}, Lca/u1;->t()Landroid/view/Surface;
    ...
    invoke-virtual {v10}, Lca/u1;->u()Landroid/view/Surface;
    ...
    invoke-virtual {v10}, Lca/u1;->p()Landroid/view/Surface;
    ...
    invoke-virtual {v10}, Lca/u1;->w()Landroid/view/Surface;
    ...
    invoke-static {v9}, Lak/q;->d(Landroid/view/Surface;)Landroid/util/Size;
    ...
    iput-object v1, p0, Lca/b1;->v:Landroid/util/Size;
    ...
    invoke-virtual {v3}, Lca/a;->m0()Z

    move-result v10

    invoke-virtual {v4, v9, v10}, Lca/u1;->m(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v1, v8}, Lca/u1;->q(I)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v9, v4, v1}, Lca/b1;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v1

    iput-object v1, p0, Lca/b1;->B:Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-static {v1}, Lca/d;->H2(Lca/c;)Z
    ...
    invoke-virtual {v1}, Lca/u1;->w()Landroid/view/Surface;
    ...
    :cond_8
    invoke-virtual {v3}, Lca/a;->K()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v3, v0, v6}, Lca/a;->c(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-static {v6, v0, v1, v4}, Lca/z;->N(ILandroid/hardware/camera2/CaptureRequest$Builder;Lca/c;Lca/x;)V
    ...
    iget-object v6, v1, Lca/c;->e:Ljava/util/HashSet;
    ...
    invoke-static {v0, v1, v8}, Lca/z;->A0(Landroid/hardware/camera2/CaptureRequest$Builder;Lca/c;Z)V

    invoke-static {v0, v1, v8}, Lca/z;->t0(Landroid/hardware/camera2/CaptureRequest$Builder;Lca/c;Z)V
    ...
    invoke-static {v1}, Lca/d;->N1(Lca/c;)Z
    ...
    sget-object p0, Lqa/w;->q3:Lqa/v;

    invoke-static {v2}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v1

    invoke-static {v0, p0, v1}, Lqa/a0;->h(Landroid/hardware/camera2/CaptureRequest$Builder;Lqa/z;Ljava/lang/Object;)V
