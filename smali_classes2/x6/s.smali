...
.method public constructor <init>(Lcom/android/camera/module/Camera2Module;)V
    ...
    iput v0, p0, Lx6/s;->a:I

    const/4 v1, 0x0

    iput v1, p0, Lx6/s;->b:I

    iput-boolean v1, p0, Lx6/s;->d:Z

    iput-boolean v1, p0, Lx6/s;->f:Z
    ...
    iput-object v0, p0, Lx6/s;->j:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static a(Lx6/s;Ljava/lang/String;)Ljava/lang/String;
    .locals 3
    ...
    :try_start_0
    sget-object v1, La0/n5;->a:La0/n5$a;
    ...
    iget-object p0, v1, La0/n5$a;->b:Ljava/text/SimpleDateFormat;
...
# virtual methods
.method public final b()Lx6/s$c;
    .locals 2

    iget-object v0, p0, Lx6/s;->k:Lx6/s$c;
    ...
    new-instance v0, Lx6/s$c;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lx6/s$c;-><init>(Lx6/s;Landroid/os/Looper;)V

    iput-object v0, p0, Lx6/s;->k:Lx6/s$c;

    :cond_0
    iget-object p0, p0, Lx6/s;->k:Lx6/s$c;
...
.method public final c()V
    ...
    iput-boolean v0, p0, Lx6/s;->c:Z

    invoke-virtual {p0}, Lx6/s;->d()V

    :cond_0
    iget-boolean v0, p0, Lx6/s;->d:Z

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lx6/s;->b()Lx6/s$c;
    ...
    :cond_1
    iget-object v0, p0, Lx6/s;->e:Ljava/lang/Boolean;
...
.method public final d()V
    ...
    invoke-interface {p0, v0}, Laa/a;->k3(Z)V
...
.method public final e()V
    ...
    iget-object v1, p0, Lx6/s;->j:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v2}, Lcom/android/camera/data/data/y;->l0(I)Z
    ...
    :cond_0
    iget-object v2, p0, Lx6/s;->i:Lio/reactivex/ObservableEmitter;
    ...
    :cond_1
    iget-object v2, p0, Lx6/s;->l:Lio/reactivex/disposables/Disposable;
    ...
    iput-object v3, p0, Lx6/s;->l:Lio/reactivex/disposables/Disposable;

    :cond_2
    iget-boolean v2, p0, Lx6/s;->d:Z
    ...
    invoke-virtual {v2}, Lca/a;->G0()I

    iput-boolean v0, p0, Lx6/s;->d:Z

    :cond_4
    iput-object v3, p0, Lx6/s;->e:Ljava/lang/Boolean;
