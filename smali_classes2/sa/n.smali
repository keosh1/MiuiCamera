...
.field public static final l:Lsa/n$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lsa/n;->k:Ljava/util/HashMap;

    new-instance v0, Lsa/n$a;

    invoke-direct {v0}, Lsa/n$a;-><init>()V

    sput-object v0, Lsa/n;->l:Lsa/n$a;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lsa/b;-><init>(I)V

    const/4 v1, 0x1

    iput-boolean v1, p0, Lsa/n;->g:Z

    iput-boolean v1, p0, Lsa/n;->h:Z

    iput-boolean v0, p0, Lsa/n;->i:Z
...
.method public static l(ZLandroid/graphics/Bitmap$Config;I)Landroid/graphics/Bitmap;
    ...
    sget-object v0, Lsa/n;->l:Lsa/n$a;

    iput-boolean p0, v0, Lsa/n$a;->a:Z

    iput-object p1, v0, Lsa/n$a;->b:Landroid/graphics/Bitmap$Config;

    iput p2, v0, Lsa/n$a;->c:I

    sget-object v1, Lsa/n;->k:Ljava/util/HashMap;
    ...
    invoke-virtual {v0}, Lsa/n$a;->c()Lsa/n$a;
...
.method public final a()I
    ...
    invoke-virtual {p0}, Lsa/n;->j()Landroid/graphics/Bitmap;
...
.method public final f(Lsa/g;)Z
    .locals 23

    move-object/from16 v1, p0

    invoke-virtual/range {p0 .. p0}, Lsa/b;->e()Z
    ...
    invoke-virtual/range {p0 .. p0}, Lsa/n;->j()Landroid/graphics/Bitmap;
    ...
    invoke-virtual/range {p0 .. p0}, Lsa/n;->d()I

    move-result v11

    invoke-virtual/range {p0 .. p0}, Lsa/n;->a()I
    ...
    invoke-static {v3, v15, v14}, Lsa/n;->l(ZLandroid/graphics/Bitmap$Config;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v5, v2}, Lsa/n;->l(ZLandroid/graphics/Bitmap$Config;I)Landroid/graphics/Bitmap;
    ...
    :goto_2
    invoke-virtual/range {p0 .. p0}, Lsa/n;->i()V

    move-object/from16 v0, p1

    iput-object v0, v1, Lsa/b;->e:Lsa/g;

    iput v7, v1, Lsa/b;->a:I

    iput v3, v1, Lsa/b;->b:I

    iput-boolean v3, v1, Lsa/n;->g:Z
...
.method public final g()V
    ...
    invoke-super {p0}, Lsa/b;->g()V

    iget-object v0, p0, Lsa/n;->j:Landroid/graphics/Bitmap;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lsa/n;->i()V
...
.method public final i()V
    ...
    :goto_0
    sget-object v2, Lsa/o;->a:[J

    if-eqz v1, :cond_1

    invoke-virtual {p0, v0}, Lsa/n;->m(Landroid/graphics/Bitmap;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lsa/n;->j:Landroid/graphics/Bitmap;
...
.method public final j()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0}, Lsa/n;->n()Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, Lsa/n;->j:Landroid/graphics/Bitmap;
    ...
    iput v1, p0, Lsa/b;->d:I

    :cond_0
    iget-object p0, p0, Lsa/n;->j:Landroid/graphics/Bitmap;
